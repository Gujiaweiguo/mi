		...
		run: func(ctx context.Context, tx *sql.Tx) error {
			if _, err := tx.ExecContext(ctx, `
					...
					VALUES
					  ...
					  (104, 'invoice-batch-area', 'Invoice Batch Area', 'invoice', 'invoice_batch', 'active', 'Lease Invoice Batch Print (Area)', 'Area-oriented invoice batch layout', JSON_ARRAY('Sunshine Commercial MI', 'Finance Department'), JSON_ARRAY('Area invoice batch output', 'Generated by MI'), 101, 101),
					  (105, 'invoice-batch-ad-board', 'Invoice Batch Ad Board', 'invoice', 'invoice_batch', 'active', 'Lease Invoice Batch Print (Ad Board)', 'Ad-board invoice batch layout', JSON_ARRAY('Sunshine Commercial MI', 'Finance Department'), JSON_ARRAY('Ad-board invoice batch output', 'Generated by MI'), 101, 101),
					  (106, 'invoice-batch-jv', 'Invoice Batch JV', 'invoice', 'invoice_batch', 'active', 'JV / Unit Invoice Batch Print', 'JV invoice batch layout', JSON_ARRAY('Sunshine Commercial MI', 'Finance Department'), JSON_ARRAY('JV invoice batch output', 'Generated by MI'), 101, 101),
					  (107, 'invoice-reprint-default', 'Invoice Reprint Default', 'invoice', 'invoice_detail', 'active', 'Lease Invoice Reprint', 'Reprint invoice detail layout', JSON_ARRAY('Sunshine Commercial MI'), JSON_ARRAY('Invoice reprint output'), 101, 101),
					  (108, 'invoice-reprint-jv', 'Invoice Reprint JV', 'invoice', 'invoice_detail', 'active', 'JV / Unit Invoice Reprint', 'JV invoice reprint layout', JSON_ARRAY('Sunshine Commercial MI'), JSON_ARRAY('JV invoice reprint output'), 101, 101),
					  (109, 'interest-invoice-default', 'Interest Invoice Default', 'invoice', 'invoice_detail', 'active', 'Interest Invoice Print', 'Printable interest invoice detail', JSON_ARRAY('Sunshine Commercial MI'), JSON_ARRAY('Interest invoice output'), 101, 101),
			...
			if _, err := tx.ExecContext(ctx, `
				INSERT INTO interest_rate_configs (id, charge_type_filter, daily_rate, grace_days, is_default, status, created_by, updated_by)
				VALUES (101, NULL, 0.001000, 7, TRUE, 'active', 101, 101)
				ON DUPLICATE KEY UPDATE
