...
{
    public class floorsAuth : BasePO
    {
        ...
        {
            return "FloorID,FloorCode,FloorName,BuildingID,FloorStatus,StoreID";
        }
        ...
        {
            return "select floors.FloorID,FloorCode,FloorName,floors.BuildingID,FloorStatus,floors.StoreID from floors left join conshop on conshop.floorid=floors.floorid";
        }
