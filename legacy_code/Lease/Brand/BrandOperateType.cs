...
namespace Lease.Brand
{
    ...
    public class BrandOperateType:BasePO
    {
        ...
        {
            return "OperateName,Status,Note,ModifyUserId,ModifyTime,OprRoleID,OprDeptID";
        }
        public override string GetInsertColumnNames()
        {
            return "OperateTypeId,OperateName,Status,Note,CreateUserId,CreateTime,OprRoleID,OprDeptID";
        }
