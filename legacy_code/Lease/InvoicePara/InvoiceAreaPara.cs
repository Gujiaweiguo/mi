...
{
    public class InvoiceAreaPara : BasePO
    {
        private int invoiceAreaParaID = 0;
        ...
        {
            return "InvoiceAreaPara";
        }

        public override string GetColumnNames()
        {
            return "InvoiceAreaParaID,CreateUserID,CreateTime,ModifyUserID,ModifyTime,OprRoleID,OprDeptID,InvoiceParaDesc,ParaStatus,ParaStatusName,InvHeader,InvSubhead,InvH1,InvH2,InvH3,InvH4,InvH5,InvF1,InvF2,InvF3,InvF4,InvF5,InvF6,InvF7,IsDefault";
        }
        ...
        {
            return "InvoiceAreaParaID,CreateUserID,CreateTime,ModifyUserID,ModifyTime,OprRoleID,OprDeptID,InvoiceParaDesc,ParaStatus,InvHeader,InvSubhead,InvH1,InvH2,InvH3,InvH4,InvH5,InvF1,InvF2,InvF3,InvF4,InvF5,InvF6,InvF7,IsDefault";
        }

        public override string GetQuerySql()
        {
            return "Select InvoiceAreaParaID,CreateUserID,CreateTime,ModifyUserID,ModifyTime,OprRoleID,OprDeptID,InvoiceParaDesc,ParaStatus,'' as ParaStatusName,InvHeader,InvSubhead,InvH1,InvH2,InvH3,InvH4,InvH5,InvF1,InvF2,InvF3,InvF4,InvF5,InvF6,InvF7,IsDefault From InvoiceAreaPara";
        }

        public int InvoiceAreaParaID
        {
            get { return invoiceAreaParaID; }
            set { invoiceAreaParaID = value; }
        }
