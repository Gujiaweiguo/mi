...
{
    /// <summary>
    /// 潜在商户经营品牌 add by lcp at 2009-3-19
    /// </summary>
    public class PotCustBrand:BasePO
    {
        ...
        private string tradeName = "";//经营业态名称
        ...
        {
            return "CustBrandId,CustId,TradeId,BrandId,OperateTypeId,ConsumerSex,ConsumerAge,AvgAmt,Note,CreateUserId,CreateTime,ModifyUserId,ModifyTime,OprRoleID,OprDeptID";
        }
        public override string GetUpdateColumnNames()
        {
            return "CustId,TradeId,BrandId,OperateTypeId,ConsumerSex,ConsumerAge,AvgAmt,Note,CreateUserId,CreateTime,ModifyUserId,ModifyTime,OprRoleID,OprDeptID";
        }
        public override string GetQuerySql()
        {
            return "select CustBrandId,(select tradename from traderelation where tradeid=PotCustBrand.tradeid) as TradeName,(select brandname from ConShopBrand where brandid=PotCustBrand.brandid) as BrandName from PotCustBrand";
        }
