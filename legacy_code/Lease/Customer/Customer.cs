...
namespace Lease.Customer
{
    ...
    {
        public static int POTCUSTOMER_DRAFT = 1;//草稿
        ...
        public static int POTCUSTOMER_REFUSE_UPDATE_LEASE_STATUS = 5;//审批拒绝
        public static int POTCUSTOMER_CANCEL_EFUSE_UPDATE_LEASE_STATUS = 6;//取消立项
        ...
        {
            return "CustID,CustCode,CustName,CustShortName,CustTypeID,LegalRep,LegalRepTitle,RegCap,RegAddr,RegCode,TaxCode,BankName,BankAcct,OfficeAddr,OfficeAddr2,OfficeAddr3,PostAddr,PostAddr2,PostAddr3,PostCode,WebUrl,CustomerStatus,CommOper,CurTypeID,SourceTypeId,CreditLevelId," + GetCommonColumnNames();
        }

        public override string GetUpdateColumnNames()
        {
            return "CustCode,CustName,CustShortName,CustTypeID,LegalRep,LegalRepTitle,RegCap,RegAddr,RegCode,TaxCode,BankName,BankAcct,OfficeAddr,OfficeAddr2,OfficeAddr3,PostAddr,PostAddr2,PostAddr3,PostCode,WebUrl,CustomerStatus,CommOper,CurTypeID,SourceTypeId,CreditLevelId";
        }
    }
}
