...
{
    public class CustContact:BasePO
    {
        ...
        {
            return "CustContactID,ContactMan,Title,OfficeTel,MobileTel,EMail,CustID";
        }

        public override string GetUpdateColumnNames()
        {
            return "ContactMan,Title,OfficeTel,MobileTel,EMail";
        }
