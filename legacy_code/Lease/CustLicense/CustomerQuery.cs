...
{
    public class CustomerQuery:BasePO
    {
        ...
        public override string GetColumnNames()
        {
            ...
            return "CustID,CustCode,CustName,CustShortName,CustTypeID,LegalRep,LegalRepTitle,RegCap,RegAddr,RegCode,TaxCode,BankName,BankAcct,OfficeAddr,OfficeAddr2,OfficeAddr3,PostAddr,PostAddr2,PostAddr3," +
                "PostCode,CreateUserID,ContactMan,Title,OfficeTel,MobileTel,EMail,CustLicenseID,CustLicenseName,CustLicenseType,CustLicenseStartDate," +
                "CustLicenseEndDate,WebURL,CommOper,UserName,CurTypeID,SourceTypeId,CreditLevelId";
        }
        ...
        public override string GetQuerySql()
        {
            return "select a.CustID,CustCode,CustName,CustShortName,CustTypeID,LegalRep,LegalRepTitle,RegCap,RegAddr,RegCode,TaxCode,BankName,BankAcct," +
                    "a.OfficeAddr,OfficeAddr2,OfficeAddr3,PostAddr,PostAddr2,PostAddr3,PostCode,a.CreateUserID,ContactMan,Title,b.OfficeTel,b.MobileTel,b.EMail,CustLicenseID,CustLicenseName,CustLicenseType," +
                    "CustLicenseStartDate,CustLicenseEndDate,WebURL,CommOper,UserName,CurTypeID,SourceTypeId,CreditLevelId from Customer a left join CustContact b on a.CustID=b.CustID left " +
                    "join CustLicense c on a.CustID=c.CustID left join Users d on a.CommOper=d.UserID";
        }
        public int CustID
        {
            get { return custID; }
