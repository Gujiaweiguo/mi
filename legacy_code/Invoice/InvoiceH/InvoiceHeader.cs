...
namespace Invoice.InvoiceH
{
    public class InvoiceHeader:BasePO
    {
        ...
        public static int INVOICEHEADER_AVAILABILITY = 1;//有效
        public static int INVOICEHEADER_CANCEL = 4;      //取消
        public static int INVOICEHEADER_PART_BACKING_OUT = 2;//部分返还
        public static int INVOICEHEADER_FULL_BACKING_OUT = 3;//全部返还
        ...
        {
            return "InvID,CustID,CustCode,ContractID,ContractCode,CurTypeID,CreateUserID,CreateTime,ModifyUserID,ModifyTime,OprRoleID,OprDeptID,InvCode,CustName,CustShortName,InvDate,InvPeriod,InvStatus," +
                    "InvType,IsFirst,InvCurTypeID,InvExRate,InvPayAmt,InvPayAmtL,InvAdjAmt,InvAdjAmtL,InvDiscAmt,InvDiscAmtL,InvChngAmt,InvChngAmtL,InvActPayAmt," +
                    "InvActPayAmtL,InvPaidAmt,InvPaidAmtL,PrintFlag,Note";
        }
        ...
        {
            return "InvPaidAmt,InvPaidAmtL,InvStatus";
        }

        public override string GetQuerySql()
        {
            return "select InvID,a.CustID,CustCode,a.ContractID,ContractCode,a.CurTypeID,a.CreateUserID,a.CreateTime,a.ModifyUserID,a.ModifyTime,a.OprRoleID,a.OprDeptID,InvCode,b.CustName,b.CustShortName,InvDate,InvPeriod,InvStatus," +
                    "InvType,IsFirst,InvCurTypeID,InvExRate,InvPayAmt,InvPayAmtL,InvAdjAmt,InvAdjAmtL,InvDiscAmt,InvDiscAmtL,InvChngAmt,InvChngAmtL,InvPayAmt+InvAdjAmt+InvDiscAmt+InvChngAmt as InvActPayAmt," +
                    "InvPayAmtL+InvAdjAmtL+InvDiscAmtL+InvChngAmtL as InvActPayAmtL,InvPaidAmt,InvPaidAmtL,PrintFlag,a.Note,InvChngAmtL,InvPayAmt+InvAdjAmt+InvDiscAmt+InvChngAmt - InvPaidAmt as ThisPaid from InvoiceHeader a left join Customer b on a.CustID=b.CustID left join Contract c " +
                    "on a.ContractID=c.ContractID left join CurrencyType d on a.InvCurTypeID=d.CurTypeID";
        }
