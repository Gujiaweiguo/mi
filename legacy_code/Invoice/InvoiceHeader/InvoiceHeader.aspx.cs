...
public partial class Lease_InvoiceHeader_InvoiceHeader : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            btnAdd.Attributes.Add("onclick", "return InputValidator(form1)");
    ...
    protected void BindInvoiceHeader()
    {
       ...
       /* if (ViewState["InvID"] != null)
        ...
        str_sql += " WHERE " + baseBO.WhereClause + " AND a.InvType = " + Invoice.InvoiceHeader.INVTYPE_LEASE;
    ...
    protected void BindInvoiceDetail()
    {
        ...
        PagedDataSource pds = new PagedDataSource();
        int spareRow = 0;
        baseBO.WhereClause = "InvID= '" + Convert.ToInt32(ViewState["DetailInvID"]) + "' and InvDetStatus in ( " + InvoiceDetail.INVOICEDETAIL_AVAILABILITY + "," + InvoiceDetail.INVOICEDETAIL_PART_BACKING_OUT + "," + InvoiceDetail.INVOICEDETAIL_FULL_BACKING_OUT + ") and InvActPayAmt > 0";
