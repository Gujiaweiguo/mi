...
<head id="Head1" runat="server">
	...
	function txtSurAmtSum()
	{
	    ...
	    document.getElementById("txtInvPaidAmt").value = document.getElementById("txtInvPaidAmt").value - document.getElementById("txtInvPaidAmtSum").value; 
	}
    function Load()
    {
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" style="height: 45px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 91px; height: 17px">
                                                        <asp:TextBox ID="txtCustCode" runat="server" CssClass="ipt160px" Width="104px"></asp:TextBox></td>
                                                    ...
                                                    <td style="width: 61px; text-align: right;">
                                                        <asp:TextBox ID="txtContractCode" runat="server" CssClass="ipt160px" Width="126px"></asp:TextBox></td>
                                                        <td style="width: 55px">
                                                    ...
                                                    <td style="height: 35px; width: 178px;">
                                                        <asp:TextBox ID="txtInvCode" runat="server" CssClass="ipt160px" Width="103px"></asp:TextBox>
                                                        </td>
                                                            <td>
                                                    ...
                                                    <td valign="top" style="width: 21%;">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" style="width: 97%; height: 275px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 35px; width: 164px;">
                                                                    <asp:TextBox ID="txtSurAmt" runat="server" CssClass="Enabledipt160px" Width="111px"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="baseLable" style="text-align: center; width: 105px; height: 35px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 35px; width: 164px;">
                                                                    <asp:TextBox ID="txtnote" runat="server" CssClass="ipt160px" MaxLength="128" Width="110px"></asp:TextBox></td>
                                                            </tr>
                                                        </table>
                                                                <asp:Button ID="btnAdd" runat="server" CssClass="buttonSave" Height="32px"
                                                                        OnClick="btnAdd_Click" Text="<%$ Resources:BaseInfo,PotCustomer_butSave %>" Width="70px" />
                                                                    <asp:Button ID="btnQuit" runat="server" CssClass="buttonCancel" Height="30px" OnClick="btnQuit_Click"
                                                                        Text="<%$ Resources:BaseInfo,User_btnCancel %>" Width="74px" /></td>
                                                    <!--  *********right
                    -->
                                                            ...
                                                            <tr>
                                                                <td class="baseInput" colspan="2" rowspan="3" style="vertical-align: top; text-align: center; height: 135px;">
                                                                    <asp:GridView ID="GrdVewInvoiceHeader" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                                        BorderStyle="Inset" BorderWidth="1px" Height="120px" Width="437px" PageSize="5" OnRowDataBound="GrdVewInvoiceHeader_RowDataBound" OnSelectedIndexChanged="GrdVewInvoiceHeader_SelectedIndexChanged" ShowFooter="True">
                                                ...
                                                <HeaderStyle BackColor="#E1E0B2" Height="10px" Font-Bold="False"  /><FooterStyle BackColor="Red" ForeColor="#000066"/>
                                                            ...
                                                            <tr style="height: 8px">
                                                                <td colspan="2" style="height: 9px" align="right">
                                                                    <asp:Label ID="lblCurrent" runat="server" ForeColor="Red" Height="1px" Visible="False"
                                                                        Width="1px">1</asp:Label>
                                                                    <asp:Button ID="btnBackType" runat="server" CssClass="buttonBack" Height="31px" OnClick="btnBackType_Click"
                                                                        Text="<%$ Resources:BaseInfo,Button_back %>" Width="71px" /><asp:Button ID="btnNextType"
                                                                            runat="server" CssClass="buttonNext" Height="30px" OnClick="btnNextType_Click"
                                                                            Text="<%$ Resources:BaseInfo,Button_next %>" Width="73px" /></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr style="height: 20px">
                                                                <td colspan="2" style="height: 20px; vertical-align: top; text-align: center;"><asp:GridView ID="GrdVewInvoiceDetail" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                                        BorderStyle="Inset" BorderWidth="1px" Height="120px" Width="438px" PageSize="5" OnRowDataBound="GrdVewInvoiceDetail_RowDataBound" ShowFooter="True">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,InvoiceHeader_lblBalance %>">
                                                                         ...
                                                                         <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,InvoiceHeader_lblShouldPayment %>">
                                                                                <ItemTemplate>
                                                                                    &nbsp;<asp:TextBox ID="txtPayment" runat="server" CssClass="ipt35px" Text='<%# DataBinder.Eval(Container, "DataItem.ThisPaid")%>' Font-Size="9pt" Width="75px"></asp:TextBox>
                                                                                </ItemTemplate>
                                                            ...
                                                            <tr style="height: 5px">
                                                                <td colspan="2" style="height: 15px" align="right">
                                                                    <asp:Label ID="lblDetailCurrent" runat="server" ForeColor="Red" Height="1px" Visible="False"
                                                                        Width="1px">1</asp:Label>
                                                                    <asp:Button ID="btnLast" runat="server" CssClass="buttonBack" Height="31px" OnClick="btnLast_Click"
                                                                        Text="<%$ Resources:BaseInfo,Button_back %>" Width="71px" /><asp:Button ID="btnNext"
                                                                            runat="server" CssClass="buttonNext" Height="30px" OnClick="BtnNext_Click" Text="<%$ Resources:BaseInfo,Button_next %>"
                                                                            Width="73px" /></td>
                                                            </tr>
                                                            <tr>
                                                            </tr>
