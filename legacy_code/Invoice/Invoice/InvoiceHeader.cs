...
using Base.DB;
namespace Invoice.InvoiceHeader
{
    public class InvoiceHeader:BasePO
    {
        ...
        {
            return "InvID,CustID,ContractID,CurTypeID,CreateUserID,CreateTime,ModifyUserID,ModifyTime,OprRoleID,OprDeptID,InvCode,CustName,InvDate,InvPeriod,InvStatus," +
