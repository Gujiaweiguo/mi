...
namespace Invoice
{
    public class BudgetChargePalaver : IConfirmVoucher
    {
        /**
    * 确认单据后对数据生效的处理
    */
        public void ValidVoucher(int voucherID, int operType, BaseTrans trans)
        {
            ...
            {
                String sql = "Update BudgetDetail set BudgetStatus = " + BudgetDetail.BDGSTATUS_TYPE_ATTREM + " where BatchID =" + voucherID;
