...
namespace Base.XML
{
    ...
    public class ShopXMLInfo4 : BasePO
    {
       ...
       return   "select " +
                ...
                "shopxml.NameX,shopxml.NameY,shopxml.Remark, traderelation.rb,traderelation.gb,traderelation.bb from shopxml left join conshop " +
                "on(shopxml.shopid=conshop.shopid) left join conshopunit on (conshop.shopid=conshopunit.unitid)" +
                "left join unit on (unit.unitid=conshopunit.unitid)" +
                "left join traderelation on " +
                "(unit.trade2id=traderelation.tradeid))as a";
        }
