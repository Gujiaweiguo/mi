...
namespace Generalize.Medium
{
    ...
    public class MTV:BasePO
    {
        ...
        {
            return "MTVID,TVID,AnPID,TVNm,Airtime,ContentsID,EstCosts,Costs,StartDate,EndDate,Freq,FreqDays,FreqMon,FreqTue,FreqWed,FreqThu,FreqFri,FreqSat,FreqSun," +
        ...
        {
            return "TVID,TVNm,Airtime,ContentsID,EstCosts,Costs,StartDate,EndDate,Freq,FreqDays,FreqMon,FreqTue,FreqWed,FreqThu,FreqFri,FreqSat,FreqSun," +
                    "BetweenFr,BetweenTo,ModifyUserID,ModifyTime";
        }

        public override string GetQuerySql()
        {
            return "Select MTVID,TVID,AnPID,TVNm,Airtime,a.ContentsID,EstCosts,Costs,StartDate,EndDate,Freq,FreqDays,FreqMon,FreqTue,FreqWed,FreqThu,FreqFri," +
                    "FreqSat,FreqSun,BetweenFr,BetweenTo,ContentsNm From MTV a Left Join " +
