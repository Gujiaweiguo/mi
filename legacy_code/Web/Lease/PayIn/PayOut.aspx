...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
      ...
      <!--
        ...
        function getPayOutAmt()
	    {
	        document.getElementById("txtPayOutAmt").value = document.getElementById("txtPayInAmt").value;	        
	    }
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" rowspan="4" valign="top" style="text-align: right; padding-right:15px">
                                        <asp:GridView ID="gdvwPayIn" runat="server" AutoGenerateColumns="False" BackColor="White"
                                            BorderColor="#E1E0B2" Width="310px" PageSize="3" OnSelectedIndexChanged="gdvwPayIn_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="gvShopBrand_OnPageIndexChanging">
                                            <Columns>
