...
public partial class Lease_LeaseContractStop_LeaseContractStop : BasePage
{
    ...
    protected void GetContractInfo(string sqlStr)
    {
        ...
        if (contractDs.Tables[0].Rows.Count > 0)
        {
            ...
            //change by wjm at 09-4-14 16:38
            if ((contractDs.Tables[0].Rows[0]["ContractTypeID"].ToString()) != "")
            {
                string str1 = "select * from ContractType where ContractTypeID=" + contractDs.Tables[0].Rows[0]["ContractTypeID"];
                DataSet ds1 = baseBO.QueryDataSet(str1);
            ...
            //int a = Convert.ToInt32(contractDs.Tables[0].Rows[0]["SubsID"]);
            if ((contractDs.Tables[0].Rows[0]["SubsID"].ToString())!= "")
            {
                string str2 = "select * from Subsidiary where SubsID="+contractDs.Tables[0].Rows[0]["SubsID"];
                DataSet ds2 = baseBO1.QueryDataSet(str2);
