<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaseContractStopAuditing.aspx.cs" Inherits="Lease_LeaseContractStop_LeaseContractStopAuditing" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Menu_LeaseContractStopAuditing")%></title>
    ...
    function Load()
    {
        addTabTool("<%=titleName%>,Lease/LeaseContractStop/LeaseContractStopAuditing.aspx~<%=leaseItem %>,Lease/LeaseItemPalaver.aspx~<%=shopInfo %>,Lease/ShopBaseInfoPalaver.aspx~<%=espression %>,Lease/ExpressionPalaver.aspx");
	    loadTitle();
    }
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 452px">
                                    <tr>
                                        <td align="left" class="tdTopRightBackColor" style="width: 167px; height: 22px; text-align: left">
                                            ...
                                            <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,Menu_LeaseContractStopAuditing %>"></asp:Label></td>
                    ...
                    -->
                                                    <td valign="top" width="50%" style="width: 100%">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" width="100%">
                                                            ...
                                                            <tr style="height: 20px">
                                                                <td style="text-align: right">
                                                                    <asp:Label ID="Label60" runat="server" Text="<%$ Resources:BaseInfo,Contract_ManageCompany %>" CssClass="labelStyle"></asp:Label>
                                                                    &nbsp;&nbsp;
                                                                </td>
                                                                <td style="width: 164px">
                                                            ...
                                                            <tr>
                                                                <td class="baseLable" style="height: 28px">
                                                                    <asp:Label ID="Label61" runat="server" Text="<%$ Resources:BaseInfo,Contract_ContractType %>" CssClass="labelStyle"></asp:Label>
                                                                </td>
                                                                <td style="height: 28px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 30px">
                                                                    <asp:TextBox ID="txtBargain" runat="server" CssClass="Enabledipt160px"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="baseLable">
                    ...
                    -->
                                                    <td style="vertical-align: top; width: 100%;" width="50%">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" style="width: 316px">
                                                            ...
                                                            <tr>
                                                                <td class="baseLable" style="position: relative; top: 8px" valign="top">
                                                                ...
                                                                <td style="height: 45px; width: 206px;" valign="top">
                                                            ...
                                                            <tr style="height: 15px">
                                                                ...
                                                                <tr style="height: 5px">
                                                                    <td align="right" colspan="2" valign="top">
                                                                        <asp:Button ID="butConsent" runat="server" CssClass="buttonSave" 
                                                                            OnClick="butConsent_Click" 
                                                                            Text="<%$ Resources:BaseInfo,CustPalaver_butConsent %>" />
                                                                        &nbsp;
                                                                        <asp:Button ID="butOverrule" runat="server" CssClass="buttonClear" 
