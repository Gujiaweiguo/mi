<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaseContractStop.aspx.cs" Inherits="Lease_LeaseContractStop_LeaseContractStop" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Menu_LeaseContractStopAdd")%></title>
    ...
    function Load()
    {
        addTabTool("<%=titleName%>,Lease/LeaseContractStop/LeaseContractStop.aspx~<%=leaseItem %>,Lease/LeaseItemPalaver.aspx~<%=shopInfo %>,Lease/ShopBaseInfoPalaver.aspx~<%=espression %>,Lease/ExpressionPalaver.aspx");
	    loadTitle();
    }
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 452px;">
                                    <tr>
                                        <td align="left" class="tdTopRightBackColor" style="width: 167px; height: 22px; text-align: left">
                                            ...
                                            <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,Menu_LeaseContractStopAdd %>"></asp:Label></td>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 10px">
                                                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 83%">
                                                                        <tr class="bodyLine">
                                                                            <td style="height: 1px; background-color: #738495">
                                                                            </td>
                                                                        </tr>
                                                            ...
                                                            <tr style="height: 20px">
                                                                ...
                                                                <td style="width: 164px">
                                                                    <asp:DropDownList ID="cmbTradeID" runat="server" Width="165px" Enabled="False">
                                                                    </asp:DropDownList></td>
                                                            </tr>
                                                            <tr style="height: 5px">
                                                                <td style="text-align: right">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td rowspan="2">
                                                                    <asp:TextBox ID="listBoxAddItem" runat="server" CssClass="ipt160px" Height="46px"
                                                    ...
                                                    <td style="vertical-align: top; width: 100%; text-align:left" width="50%">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" style="width: 316px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 45px; width: 206px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="baseInput" rowspan="2" style="width: 206px">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" rowspan="2" valign="middle" align="right">
                                                                <asp:Button ID="btnSave" runat="server" CssClass="buttonSave" Enabled="False" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                                                                         OnClick="btnTempSave_Click" Text="<%$ Resources:BaseInfo,Lease_NewLineBtnTemp %>"
                                                                         />
                                                                    <asp:Button ID="btnPutIn" runat="server" CssClass="buttonPutIn" Enabled="False" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                                                                         OnClick="btnOverTime_Click" Text="<%$ Resources:BaseInfo,Lease_NewLineBtnPutIn %>"
                                                                         />
                                                            ...
                                                            <tr>
                                                                <td colspan="2" rowspan="1" style="height: 28px" valign="top" align="right">
                                                                    &nbsp; &nbsp; &nbsp;
                                                                </td>
                                                            </tr>
                                                        </table>
