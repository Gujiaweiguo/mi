<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PotCustOprInfo.aspx.cs" Inherits="Lease_PotCustomer_PotCustOprInfo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "PotCustomer_ManageSurvey")%></title>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 255px; height: 231px">
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 28px">
                                <font color=red>
                                    <asp:TextBox ID="txtOperateAreas" runat="server" CssClass="ipt160px" MaxLength="32"></asp:TextBox></font></td>
                            <td class="tdBackColor" style="width: 5px; height: 28px">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtAreaSalesRate" runat="server" CssClass="ipt160px" MaxLength="8"></asp:TextBox><font color=red></font></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 10px; text-align: center">
                                <asp:TextBox ID="txtBaseDiscount" runat="server" CssClass="ipt160px" MaxLength="3"></asp:TextBox><font color=red></font></td>
                            <td class="tdBackColor" style="width: 5px; height: 2px">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtPromoteArea" runat="server" CssClass="ipt160px" MaxLength="8"></asp:TextBox>&nbsp;</td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtPromoteCost" runat="server" CssClass="ipt160px" MaxLength="16"></asp:TextBox><font color=red></font></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        <tr>
