...
<head runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        ...
	        addTabTool("<%=PotCustomer_Basic %>,Lease/PotCustomer/PotCustomerBaseInfoUpdate.aspx~<%=PotCustomer_ClientCard %>,Lease/PotCustomer/PotCustLicenseUpdate.aspx~<%=PotCustomer_TitlePalaver %>,Lease/PotCustomer/PotCustBrandBaseInfo.aspx?look=no~<%=PotCustomer_OprInfo %>,Lease/PotCustomer/PotCustOprBaseInfo.aspx?look=no");
	        loadTitle();
	    }
	    function BtnUp( p )
{
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 30px; height: 22px">
                                ...
                                <tr>
                                    <td class="tdBackColor" style="height: 22px; text-align: right">
                                        <asp:Label ID="Label7" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_CustSource %>"
                                            Width="86px"></asp:Label></td>
                                    <td class="tdBackColor" style="width: 84px; height: 22px">
                                    </td>
                                    <td class="tdBackColor" style="width: 160px; height: 22px">
                                ...
                                <tr>
                                    <td class="tdBackColor" style="height: 14px; text-align: right">
                                        </td>
                                    <td class="tdBackColor" style="width: 84px; height: 14px">
                                    </td>
                                ...
                                <tr>
                                    <td colspan="4" style="height: 44px; text-align: left" align="center">
                                        <table>
                                            <tr>
                                                <td style="height: 17px; width: 245px; text-align: center;">
