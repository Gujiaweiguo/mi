...
public partial class Lease_PotCustomer_PotCustomerList : BasePage
{
    Resultset rs = null;
    Resultset rs2 = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //{
            //    string tempCustID = Request.Cookies["Info1"].Values["custid"].ToString();
            //    page("a.CustID= " + tempCustID);
            //}
            //else
            //{
            ...
            page("a.CustID= 0");
            baseInfo = (String)GetGlobalResourceObject("BaseInfo", "PotCustomer_labCustomerQuery");
    ...
    {
        Response.Redirect("PotCustomerBaseInfo.aspx?custID=" + GrdCust.SelectedRow.Cells[0].Text);
    }
    ...
    {
        //if (HidJumpPage.Value.Trim() != "")
        //{
        //    int GotoPageCount = 0;
        //    try
        //    {
        //        GotoPageCount = Convert.ToInt32(HidJumpPage.Value) - 1;
        //    }
        //    finally
        //    {
        //        if (GotoPageCount < 0)
        //            GotoPageCount = 0;
        //    }
        //    if (GotoPageCount > this.GrdCust.PageCount - 1)
        //        GotoPageCount = GrdCust.PageCount - 1;
        //    GrdCust.CurrentPageIndex = GotoPageCount;
        //    Session["PageCount"] = GotoPageCount.ToString();
        //}
        //else
        //{
        //    GrdCust.CurrentPageIndex = 0;
        //    Session["PageCount"] = 0.ToString();
        //}
    }
