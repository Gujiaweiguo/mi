<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PotCustomerBaseInfo.aspx.cs" Inherits="Lease_PotCustomer_PotCustomerBaseInfo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
     <title><%=PotCustomer_OprInfo %></title>
	...
	<script type="text/javascript">
	    function Load()
	    {
	        //addTabTool("<%=PotCustomer_Basic %>,Lease/PotCustomer/PotCustomerBaseInfo.aspx~<%=PotCustomer_ClientCard %>,Lease/PotCustomer/PotCustLicense.aspx~<%=PotCustomer_TitlePalaver %>,Lease/PotCustomer/PalaverQuery.aspx");
	        addTabTool("<%=PotCustomer_Basic %>,Lease/PotCustomer/PotCustomerBaseInfo.aspx~<%=PotCustomer_ClientCard %>,Lease/PotCustomer/PotCustLicense.aspx~<%=PotCustomer_TitlePalaver %>,Lease/PotCustomer/PotCustBrandBaseInfo.aspx?look=yes~<%=PotCustomer_OprInfo %>,Lease/PotCustomer/PotCustOprBaseInfo.aspx?look=yes");
	        loadTitle();
	    }   
...
<body style="margin:0px" onload='Load()'>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
             <div id="PotCustomer">
             <table border="0" cellpadding="0" cellspacing="0" style="height: 405px; width: 100%;" id="TABLE1" >
                        <tr>
                            <td class="tdTopBackColor" style="width: 7364px; height: 25px; vertical-align: middle; text-align: left;" valign="top">
                                <img alt="" class="imageLeftBack" />
                                <asp:Label ID="Label4" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,PotCustomer_labCustomerQuery %>" Width="228px"></asp:Label></td>
                        ...
                        <tr>
                            <td class="tdBackColor" colspan="2" style="width: 50%; height: 320px; text-align: left"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="height: 310px" width="100%">
                                    ...
                                    <tr>
                                        <td class="tdBackColor" colspan="4" style="height: 1px; padding-left:85px">
                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 200px">
                                                <tr>
                                                    <td style="width: 166px; height: 1px; background-color: #738495;  top: 3px;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 166px; height: 1px; background-color: #ffffff;  top: 3px;">
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="tdBackColor" style="height: 1px; text-align: center;" colspan="4">
                                                                         ...
                                                                         <tr>
                                       <td style="width:255px; height:5px; text-align:right;" class="tdBackColor" colspan="4">
                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 166px; ">
                                                <tr>
                                                    <td style="width: 166px; height: 1px; background-color: #738495; left: 10px; position: relative;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 166px; height: 1px; background-color: #ffffff; left: 10px; position: relative;">
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdBackColor" style="width: 160px; height: 22px">
                                            <asp:TextBox ID="txtRegCap" runat="server" CssClass="Enabledipt160px" ReadOnly="True" Width="77px"></asp:TextBox>
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                       <td style="width:255px; height:5px; text-align:right;" class="tdBackColor" colspan="4">
                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 160px; left: 90px;">
                                                <tr>
                                                    <td style="width: 166px; height: 1px; background-color: #738495;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 166px; height: 1px; background-color: #ffffff; ">
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="tdBackColor" style="height: 22px;text-align: right">
                                            <asp:Label ID="lblRegCode" runat="server" Height="18px" Text="<%$ Resources:BaseInfo,PotCustomer_lblRegCode %>"
                            ...
                            <td class="tdBackColor" style="width: 50%; height: 320px" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" style="height: 100%" width="280">
                                    <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 30px; height: 22px">
                                    ...
                                    <tr>
                                        <td class="tdBackColor" style="height: 13px; text-align: right">
                                            </td>
                                        <td class="tdBackColor" style="width: 5px; height: 13px">
                                        </td>
                                        <td class="tdBackColor" style="width: 160px; height: 13px">
                                            </td>
                                        <td class="tdBackColor" style="width: 30px; height: 13px">
                                        </td>
                                    </tr>
                                    				    <tr>
                                        <td class="tdBackColor" style="height: 1px">
