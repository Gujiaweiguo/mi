...
using Lease.PotCust;
using Base.Page;
public partial class Lease_PotCustomer_Default : BasePage
{
    Resultset rs = null;
    Resultset rs2 = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                cmbLicenseType.Items.Add(new ListItem(PotCustLicenseInfo.GetPotCustLicenseTypeDesc(status2[i]), status2[i].ToString()));
            }
            page("a.CustID= 0");
    ...
    public void BindGridView1()
    {
        ...
        DataSet ds = basebo.QueryDataSet(new PotCustLicenseInfo());
