<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PotCustomerList.aspx.cs" Inherits="Lease_PotCustomer_PotCustomerList" %>
...
//            document.getElementById("lblCurrent").style.display="none";
	        addTabTool("<%= strFresh %>,Lease/PotCustomer/PotCustomerList.aspx");
	    ...
	    function JumpPage(v)
		{
			...
			{
				var re	= new RegExp("^\\d+$");
				if(document.all(v).value.search(re)==-1)
					{
						alert("please inout number!");
						return;
					}
				document.all("HidJumpPage").value = document.all(v).value;
				__doPostBack("btnJumpPage", "");
			}
		}
		function BtnUp( p )
{
                ...
                <tbody>
                    <tr>
                        <td style=" height: 25px; vertical-align: middle; text-align: left;" class="tdTopBackColor" valign="top">
                            ...
                            <asp:Label ID="labCustomer" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,PotCustomer_labCustomerQuery %>" Width="272px"></asp:Label></td>
                            ...
                            <table style="width: 100%; height: 380px" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style=" height: 22px; text-align: left; width: 45px;" class="tdBackColor">
                                        ...
                                        <td style=" height: 22px; text-align: right" class="tdBackColor">
                                            ...
                                            <asp:DropDownList ID="dropCustType" runat="server" Visible="False" Width="124px">
                                            </asp:DropDownList></td>
                                        <td style=" height: 22px" class="tdBackColor">
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 100%; height: 12px; text-align: center" class="tdBackColor" colspan="8">
                                            <table style="left: 0px; width: 98%; position: relative; padding-left:20px; padding-right:20px" cellspacing="0" cellpadding="0"
                                                border="0">
                                                <tbody>
                                                    <tr>
...
<PagerSettings Mode="NextPreviousFirstLast"  />
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="7" style="vertical-align: top; width: 100%; height: 44px; left: 0px; text-align: center;" class="tdBackColor" >
                                            &nbsp;
                                        ...
                                        <asp:Button ID="btnBack" runat="server" CssClass="buttonBack" Enabled="False" OnClick="btnBack_Click"
                                                Text="<%$ Resources:BaseInfo,Button_back %>" Visible="False" /><asp:Button ID="btnNext" runat="server"
                                                    CssClass="buttonNext" Enabled="False" OnClick="btnNext_Click" Text="<%$ Resources:BaseInfo,Button_next %>" Visible="False" /><input type="hidden" id="HidJumpPage"  runat="server" NAME="HidJumpPage">
                                            <asp:LinkButton ID="btnJumpPage" runat="server" Visible="False" OnClick="btnJumpPage_Click"></asp:LinkButton></td>
                                    </tr>
                </tbody>
            </table>
                        </td>
