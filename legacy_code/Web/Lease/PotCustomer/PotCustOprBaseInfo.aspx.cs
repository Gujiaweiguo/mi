...
public partial class Lease_PotCustomer_PotCustOprBaseInfo : BasePage
{
    ...
    private void BindData()
    {
        ...
        try
        {
            if (Request.Cookies["Info1"].Values["custid"] != "")
            {
                ...
                rs = baseBO.Query(new PotCustomer());
                if (rs.Count == 1)
                {
                    PotCustomer potCustomerInfo = rs.Dequeue() as PotCustomer;
    ...
    private void AddPotCustOprInfo()
    {
        ...
        try
        {
            ...
            objPotCustOpr.CustID = Convert.ToInt32(Request.Cookies["Info1"].Values["custid"]);
    ...
    {
        this.Response.Redirect("~/Lease/PotCustomer/PotCustOprBaseInfo.aspx?look=no");
    }
}
