<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PotCustBrand.aspx.cs" Inherits="Lease_PotCustomer_CustBrand" %>
    ...
    <div>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 405px">
            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="height: 221px; width: 305px;">
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="height: 22px" align="left" colspan="2">
                                <asp:TextBox ID="txtTrade" runat="server" CssClass="ipt160px"></asp:TextBox>&nbsp;<img id="ImgTrade" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" runat="server" />
                                 </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:DropDownList ID="ddlOperateTypeId" runat="server" CssClass="ipt160px">
                                </asp:DropDownList></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:DropDownList ID="ddlSex" runat="server" CssClass="ipt160px">
                                </asp:DropDownList></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="tdBackColor" style="width: 84px; height: 22px; text-align: right">
                               <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_CustomerLayer %>"></asp:Label></td>
                            <td class="tdBackColor" style="width: 4px; height: 22px">
                            </td>
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:DropDownList ID="ddlClientLevel" runat="server" CssClass="ipt160px">
                                </asp:DropDownList></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="tdBackColor" colspan="4" style="width: 322px; height: 27px; text-align: center; vertical-align:bottom;">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 267px">
                                    <tr>
                                        <td style="width: 160px; height: 1px; background-color: #738495" >
                                        </td>
                ...
                <td style="width:5%;" class="tdBackColor"></td>
                <td class="tdBackColor" style="width: 280px; height: 330px" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 286px; height: 311px">
                        ...
                        <tr>
                            <td class="tdBackColor" style="width: 302px; height: 273px;
                                text-align: center" valign="top">
                                <asp:GridView ID="GrdCustBrand" runat="server" AutoGenerateColumns="False" BackColor="White"
                                    BorderStyle="Inset" BorderWidth="1px" CellPadding="3" Height="95%"
                                    OnSelectedIndexChanged="GrdCustBrand_SelectedIndexChanged" Width="271px" OnRowDataBound="GrdCustBrand_RowDataBound" OnPageIndexChanging="GrdCustBrand_OnPageIndexChanging" AllowPaging="True">
                                    <Columns>
...
<PagerSettings Mode="NextPreviousFirstLast"  />
                        ...
                        <tr>
                            <td class="tdBackColor" rowspan="3" style="vertical-align: top; width: 302px; height: 68px;
                                text-align: center">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; position:relative;top:10px;">
                                    <tr>
                                        <td style="width: 160px; height: 1px; background-color: #738495">
                                        </td>
                                    </tr>
