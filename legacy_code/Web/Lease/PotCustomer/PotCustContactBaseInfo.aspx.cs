...
public partial class Lease_PotCustomer_PotCustContact : BasePage
{
    ...
    private void BindData()
    {
        ...
        try
        {
            if (Request["custID"] != "")
            {
                strWhereClause = "where CustID=" + Convert.ToInt32(Request["custID"]);
            }
            else
            {
    ...
    private bool SaveAdd()
    {
        ...
        int strCustContactID = Base.BaseApp.GetID("PotCustContact", "CustContactID");
        string strCustID = Request["custID"];
