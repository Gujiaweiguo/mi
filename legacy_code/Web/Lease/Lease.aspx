<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lease.aspx.cs" Inherits="Lease_Lease" ResponseEncoding="gb2312" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "LeaseBargain_lblWrite")%></title>
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/Lease.aspx~<%=leaseItem %>,Lease/LeaseItem.aspx~<%=shopInfo %>,Lease/ShopBaseInfo.aspx~<%=espression %>,Lease/Expression.aspx");
	        loadTitle();
	    }
...
<body onload="Load()" style="margin:0px" >
    ...
    <tr>
        ...
        <tr>
            ...
            <td style="width: 139px">
            <asp:TextBox ID="txtTradeID" runat="server" CssClass="ipt160px"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="baseLable">
    ...
    <tr>
        ...
        <tr>
            <td class="baseLable">
                <asp:Label ID="Label12" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Contract_ContractType %>"></asp:Label></td>
            <td style="width: 139px">
    ...
    <tr>
        ...
        <td valign="top">
            <asp:TextBox ID="listBoxAddItem" runat="server" Height="72px" CssClass="ipt160px" TextMode="MultiLine"></asp:TextBox></td>
                    ...
                    <tr>
                        <td class="baseLable">
                            <asp:Label ID="Label60" runat="server" CssClass="labelStyle" Text="排他条款"></asp:Label>
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="listBoxExclusive" runat="server" CssClass="ipt160px" 
                                Height="72px" TextMode="MultiLine" MaxLength="512"></asp:TextBox>
                        </td>
                    </tr>
        <tr style="height:5px" >
            <td class="baseLable">
                ...
                <td style="width:164px;">
                    ...
                    <tr>
                        ...
                        <td rowspan="1" valign="top" align="left">
                            &nbsp;<asp:DropDownList ID="cmbCommOper" runat="server" Width="161px" Enabled="False">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2" rowspan="1" valign="top" style="padding-right:20px">
                        &nbsp;<asp:Button ID="bttSave" runat="server" CssClass="buttonSave"
                                        Text="<%$ Resources:BaseInfo,Lease_NewLineBtnTemp %>" OnClick="btnTempSave_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"/>
                            <asp:Button ID="btnPutIn" runat="server" CssClass="buttonPutIn" OnClick="btnPutIn_Click"
                                Text="<%$ Resources:BaseInfo,Lease_NewLineBtnPutIn %>" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"/>
                            <asp:Button ID="btnBlankOut" runat="server" CssClass="buttonClear"
                                OnClick="btnBalnkOut_Click" Text="<%$ Resources:BaseInfo,ConLease_butDel %>" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"/>
                            <asp:Button ID="btnSave" runat="server" CssClass="buttonSave" Text="<%$ Resources:BaseInfo,PotCustomer_butSave %>" OnClick="btnSave_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"/>
