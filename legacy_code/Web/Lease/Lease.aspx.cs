...
public partial class Lease_Lease : BasePage
{
    #region 定义
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            bttSave.Attributes.Add("onclick", "return InputValidator(form1)");
            ...
            shopInfo = (String)GetGlobalResourceObject("BaseInfo", "Tab_lblShopInfo");//商铺基本信息
    ...
    protected void GetContractInfo(int contractID)
    {
        ...
        if (contractDs.Tables[0].Rows.Count > 0)
        {
            ...
            listBoxExclusive.Text = contractDs.Tables[0].Rows[0]["Exclusive"].ToString();
    ...
    protected void SaveBaseBargain()
    {
        try
        {
            ...
            dsContract = baseBo.QueryDataSet("Select AutoContractCode From SMSPara");
            if (Convert.ToInt32(dsContract.Tables[0].Rows[0]["AutoContractCode"]) == SMSPara.AUTO_YES)
            {
            ...
            contact.CommOper = int.Parse(cmbCommOper.SelectedValue);
            ...
            contact.Exclusive = listBoxExclusive.Text;
