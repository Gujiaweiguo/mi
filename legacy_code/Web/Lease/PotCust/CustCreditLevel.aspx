<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustCreditLevel.aspx.cs" Inherits="Lease_PotCust_CreditLevel" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "PotCustomer_CreditLevel")%></title>    
    ...
    <script type="text/javascript">
     function Load()
    {
        addTabTool("<%=strBaseInfo %>,Lease/PotCust/CustCreditLevel.aspx");
        loadTitle();
    }
        //text控件文本验证
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 370px">
                                        <tr>
                                            <td class="tdTopBackColor" style="vertical-align: middle; height: 25px;
                                                ...
                                                <asp:Label ID="labCustomer" runat="server" Text="<%$ Resources:BaseInfo,PotCustomer_CreditLevel %>" Width="376px"></asp:Label></td>
                                                ...
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        <td class="tdBackColor" style="width: 293px; height: 30px; text-align: right" align="center">
                                                            <asp:Label ID="lblCustTypeName" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_LevelName %>"
                                                    ...
                                                    <tr>
                                                        <td colspan="8" style="height: 192px;padding-left:10px; padding-right:10px" valign="top">
                                                            &nbsp;<asp:GridView ID="GrdVewCreditLevel" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField DataField="CreditLevelId">
                                                                        <ItemStyle CssClass="hidden" />
                                                                        <HeaderStyle CssClass="hidden" />
                                                                        <FooterStyle CssClass="hidden" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="CreditLevelName" HeaderText="<%$ Resources:BaseInfo,PotCustomer_LevelName %>" >
