<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientLevel.aspx.cs" Inherits="Lease_PotCust_ClientLevel" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "PotShop_CustomerLayerVindicate")%></title>    
    ...
    <script type="text/javascript">
     function Load()
    {
        addTabTool("<%=strBaseInfo %>,Lease/PotCust/ClientLevel.aspx");
        loadTitle();
    }
        //text控件文本验证
    function allTextBoxValidator()
    {
        if(isEmpty(document.all.txtLevelName.value))  
        {
            parent.document.all.txtWroMessage.value=document.getElementById("hidMessage").value;
            document.all.txtLevelName.focus();
            return false;					
        }
    }
    </script>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 370px">
                                        <tr>
                                            <td class="tdTopBackColor" style="vertical-align: middle; height: 25px;
                                                ...
                                                <asp:Label ID="labCustomer" runat="server" Text="<%$ Resources:BaseInfo,PotShop_CustomerLayerVindicate %>" Width="376px"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td class="tdBackColor" colspan="3" style="width: 100%; height: 330px; text-align: center; vertical-align: top;"
                                                ...
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        <td class="tdBackColor" style="width: 293px; height: 30px; text-align: right" align="center">
                                                            <asp:Label ID="lblCustTypeName" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotShop_CustomerLayerName %>"
                                                        ...
                                                        <td class="tdBackColor" style="width: 232px; height: 30px; text-align: left">
                                                            <asp:TextBox ID="txtLevelName" runat="server" CssClass="ipt160px" MaxLength="16"></asp:TextBox></td>
                                                        <td class="tdBackColor" style="height: 30px">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="8" style="height: 192px;padding-left:10px; padding-right:10px" valign="top">
                                                            &nbsp;<asp:GridView ID="GrdVewCreditLevel" runat="server" AutoGenerateColumns="False"
                                                                BackColor="White" BorderColor="#E1E0B2" OnSelectedIndexChanged="GrdVewCustType_SelectedIndexChanged" Width="100%" OnRowDataBound="GrdVewCustType_RowDataBound" AllowPaging="True" OnPageIndexChanging="GrdVewCreditLevel_PageIndexChanging" PageSize="9">
                                                                <Columns>
                                                                    <asp:BoundField DataField="ClientLevelId">
                                                                        <ItemStyle CssClass="hidden" />
                                                                        <HeaderStyle CssClass="hidden" />
                                                                        <FooterStyle CssClass="hidden" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="ClientLevelName" HeaderText="<%$ Resources:BaseInfo,PotShop_CustomerLayerName %>" >
                                                    ...
                                                    <tr>
                                                        <td class="tdBackColor" colspan="8" style=" vertical-align: middle; width: 100%;
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 98%">
                                                                ...
                                                                OnClick="btnSave_Click" Text="<%$ Resources:BaseInfo,Dept_TitleAdd %>"/>
