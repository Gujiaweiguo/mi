<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChargeAccountArea.aspx.cs" Inherits="Lease_ChargeAccount_ChargeAccountArea" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Lease_lblAreaAccount")%></title>
    ...
    <script type="text/javascript">
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/ChargeAccount/ChargeAccountArea.aspx");
	        loadTitle();
	    }
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Lease_lblAreaAccount %>" Width="560px"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
