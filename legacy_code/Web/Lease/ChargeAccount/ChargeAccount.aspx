<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChargeAccount.aspx.cs" Inherits="Lease_ChargeAccount_ChargeAccount" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Lease_lblLeaseAccount")%></title>
    ...
    <script type="text/javascript">
        ...
        function Load()
	    {
	        ...
	        addTabTool("<%=strFresh %>,Lease/ChargeAccount/ChargeAccount.aspx");
	        loadTitle();
	    }
                                        ...
                                        <td valign="top">
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Lease_lblLeaseAccount %>" Width="560px"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 43px">
                                                        <asp:Button ID="btnQuery" runat="server" CssClass="buttonQuery" Text="<%$ Resources:BaseInfo,User_lblQuery %>" Width="64px" OnClick="btnQuery_Click" /></td>
                                                    <td>
                                                    </td>
                                                </tr>
                                                <tr style="height:10px">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width:20px" class="lable" align="right">
                                                        <asp:Label ID="Label7" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Lease_ContractAccountIng %>" Width="160px"></asp:Label></td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td class="lable" colspan="4" style="text-align: left; height: 28px;">
                                                ...
                                                <tr style="height:40px">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:Button ID="btnOK" runat="server" CssClass="buttonSave" Text="<%$ Resources:BaseInfo,User_btnOk %> " OnClick="btnOK_Click" Width="65px"/>
                                                        <asp:Button ID="BtnCel" runat="server" CssClass="buttonCancel" Text="<%$ Resources:BaseInfo,User_btnCancel %> " OnClick="BtnCel_Click" Width="64px"/></td>
                                                    <td style="width: 43px">
                                                    </td>
                                                    <td>
                                                    </td>
