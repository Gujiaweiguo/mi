<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceJVBancthPrint.aspx.cs" Inherits="Lease_ChargeAccount_InvoiceJVBancthPrint" ResponseEncoding="gb2312" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Invoice_JVBacthPrint")%></title>
    ...
    <style type="text/css">
      ...
      <!--	    
	     function Load()
        {
            addTabTool("<%=baseInfo %>,Lease/ChargeAccount/InvoiceJVBancthPrint.aspx");
            loadTitle();
...
<body style="margin:0px" onload="Load()">
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 27px; width: 100%;">
                            <tr>
                                ...
                                <td class="tdTopRightBackColor" style=" height: 27px; text-align:left;">
                                    <asp:Label
                                        ID="Label1" runat="server" Text='<%$ Resources:BaseInfo,Invoice_JVBacthPrint %>' Height="12pt" Width="218px"></asp:Label></td>
                             ...
                             <tr style="height: 1px">
                                 <td colspan="3" class="tdBackColor">
                                     <table style="width: 100%" >
                                         ...
                                         <tr>
                                             <td colspan="5" style="text-align: center">
                                                 <asp:GridView ID="gvChargeType" runat="server" AutoGenerateColumns="False"  BorderStyle="Inset" BorderWidth="1px" CellPadding="3"
                                                     Width="100%" BackColor="White" OnSelectedIndexChanged="gvChargeType_SelectedIndexChanged" OnRowDataBound="gvChargeType_RowDataBound" AllowPaging="True" OnPageIndexChanging="gvChargeType_PageIndexChanging" PageSize="8">
                                                     <Columns>
                                         ...
                                         <tr>
                                             <td>
                                                 <asp:Label ID="lblTotalNum" runat="server" Height="1px" Width="32px"></asp:Label></td>
                                             <td>
                                                 &nbsp;</td>
                                             <td style="text-align: right" colspan="2">
                                                 <asp:Button ID="btnBack" runat="server" CssClass="buttonBack" Enabled="False"
                                                     OnClick="btnBack_Click" Text="<%$ Resources:BaseInfo,Button_back %>" Visible="False" />
                                                 <asp:Button ID="btnNext" runat="server" CssClass="buttonNext" Enabled="False"
                                                     OnClick="btnNext_Click" Text="<%$ Resources:BaseInfo,Button_next %>" Visible="False" /></td>
    ...
    <asp:Label
                                                     ID="lblCurrent" runat="server" ForeColor="Red" Height="1px" Width="1px">1</asp:Label>
    </form>
</body>
</html>
