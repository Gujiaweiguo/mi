<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceBancthPrintAdBoard.aspx.cs" Inherits="Lease_ChargeAccount_InvoiceBancthPrintAdBoard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Invoice_BacthPrintAdBoard")%></title>
    ...
    <style type="text/css">
      ...
      <!--	    
	     function Load()
        {
            addTabTool("刷新,Lease/ChargeAccount/InvoiceBancthPrintAdBoard.aspx");
            loadTitle();
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 27px; width: 100%;">
                            <tr>
                                ...
                                <td class="tdTopRightBackColor" style=" height: 27px; text-align:left;">
                                    <asp:Label
                                        ID="Label1" runat="server" Text='<%$ Resources:BaseInfo,Invoice_BacthPrintAdBoard %>' Height="12pt" Width="218px"></asp:Label></td>
                                         ...
                                         <tr>
                                             <td colspan="5" style="text-align: center">
                                                 <asp:GridView ID="gvChargeType" runat="server" AutoGenerateColumns="False"  BorderStyle="Inset" BorderWidth="1px" CellPadding="3"
                                                     Width="100%" BackColor="White" OnSelectedIndexChanged="gvChargeType_SelectedIndexChanged" OnRowDataBound="gvChargeType_RowDataBound" OnPageIndexChanging="GrdCust_OnPageIndexChanging" AllowPaging="True" >
                                                     <Columns>
