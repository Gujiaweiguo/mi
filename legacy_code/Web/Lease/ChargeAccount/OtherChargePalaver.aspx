<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherChargePalaver.aspx.cs" Inherits="Lease_ChargeAccount_OtherChargePalaver" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Account_lblOtherChargePalaver")%></title>
    ...
    <script type="text/javascript">
        <!--
            ...
            function Load()
	        {
	            addTabTool("<%=baseInfo %>,Lease/ChargeAccount/OtherChargePalaver.aspx");
	            loadTitle();
	        }
                            ...
                            <td colspan="11" style="height: 22px; background-color: #e1e0b2" valign="top">
                                 <table border="0" cellpadding="0" cellspacing="0" style="height: 22px; width:100%; ">
                                    <tr>
                                        ...
                                        <asp:Label
                                            ID="labUserDefine" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,Account_lblOtherChargePalaver %>"></asp:Label></td>
                        ...
                        <tr>
                            <td colspan="11" style="vertical-align: top; width: 100%; background-color: #e1e0b2;
                                ...
                                <asp:GridView ID="gvCharge" runat="server" AutoGenerateColumns="False"
                                    BackColor="White" BorderColor="#E1E0B2" Height="246px" Width="98%" AllowPaging="True" PageSize="15" OnPageIndexChanging="gvCharge_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,Account_lblChargeType %>">
                                            <ItemTemplate>
                                                &nbsp;<asp:Label ID="txtChgName" runat="server" CssClass="" Text='<%# DataBinder.Eval(Container, "DataItem.ChgName")%>' Font-Size="9pt" Width="80px" ReadOnly="true"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle BorderColor="#E1E0B2" />
                                            <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" HorizontalAlign="Left" />
                                         <FooterStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,Account_lblChargeMoney %>">
                                            <ItemTemplate>
                                                &nbsp;<asp:Label ID="txtChgAmt" runat="server" CssClass="" Text='<%# DataBinder.Eval(Container, "DataItem.ChgAmt")%>' Font-Size="9pt" Width="80px" ReadOnly="true"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle BorderColor="#E1E0B2" />
                                            <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" HorizontalAlign="Left" />
                                         <FooterStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,PotShop_lblShopStartDate %>">
                                            <ItemTemplate>
                                                &nbsp;<asp:Label ID="txtStartDate" runat="server" CssClass="" Text='<%# DataBinder.Eval(Container, "DataItem.StartDate")%>' Font-Size="9pt" Width="80px" ReadOnly="true"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle BorderColor="#E1E0B2" />
                                            <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" HorizontalAlign="Left" />
                                         <FooterStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,Rpt_EDate %>">
                                            <ItemTemplate>
                                                &nbsp;<asp:Label ID="txtEndDate" runat="server" CssClass="" Text='<%# DataBinder.Eval(Container, "DataItem.EndDate")%>' Font-Size="9pt" Width="80px" ReadOnly="true"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle BorderColor="#E1E0B2" />
                                            <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" HorizontalAlign="Left" />
                                         <FooterStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,LeaseholdContract_labRefID %>">
                                            <ItemTemplate>
                                                &nbsp;<asp:Label ID="txtRefID" runat="server" CssClass="" Text='<%# DataBinder.Eval(Container, "DataItem.RefID")%>' Font-Size="9pt" Width="80px" ReadOnly="true"></asp:Label>
                                            </ItemTemplate>
