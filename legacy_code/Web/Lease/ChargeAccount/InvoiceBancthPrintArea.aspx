<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceBancthPrintArea.aspx.cs" Inherits="Lease_ChargeAccount_InvoiceBancthPrintArea" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Invoice_BacthPrintArea")%></title>
    ...
    <style type="text/css">
      ...
      <!--	    
	     function Load()
        {
            addTabTool("刷新,Lease/ChargeAccount/InvoiceBancthPrintArea.aspx");
            loadTitle();
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 27px; width: 100%;">
                            <tr>
                                ...
                                <td class="tdTopRightBackColor" style=" height: 27px; text-align:left;">
                                    <asp:Label
                                        ID="Label1" runat="server" Text='<%$ Resources:BaseInfo,Invoice_BacthPrintArea %>' Height="12pt" Width="218px"></asp:Label></td>
