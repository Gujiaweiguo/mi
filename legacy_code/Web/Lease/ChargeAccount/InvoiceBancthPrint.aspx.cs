...
public partial class Lease_ChargeAccount_InvoiceBancthPrint : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            BindDrop();
            BindNullGV();
            baseInfo = (String)GetGlobalResourceObject("BaseInfo", "Invoice_BacthPrint");
    ...
    {
        this.Response.Redirect("../../ReportM/RptLeaseInv.aspx?paraID=" + Convert.ToInt32(dropRptType.SelectedValue) + "&flag=" + 1 + " &bacthID=" + gvChargeType.SelectedRow.Cells[1].Text);
    }
