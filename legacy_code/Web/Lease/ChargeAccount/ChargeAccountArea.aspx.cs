...
public partial class Lease_ChargeAccount_ChargeAccountArea : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            baseInfo = (String)GetGlobalResourceObject("BaseInfo", "Lease_lblAreaAccount");
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            basebo.WhereClause = " BizMode = " + Contract.BIZ_MODE_Area + " and (ContractStatus = " + Contract.CONTRACTSTATUS_TYPE_INGEAR + " or ContractStatus = " + Contract.CONTRACTSTATUS_TYPE_END + " and StopDate > '" + Convert.ToDateTime(txtChargeDate.Text) + "')";
            if (RBtnOneContract.Checked == true)
            {
