<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BrandOperateType.aspx.cs" Inherits="Lease_Brand_BrandOperateType" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "PotCustomer_BrandOperateType")%></title>    
    ...
    <script type="text/javascript">
     function Load()
    {
        addTabTool("<%=strBaseInfo %>,Lease/Brand/BrandOperateType.aspx");
        loadTitle();
    }
       //text控件文本验证
    function allTextBoxValidator()
    {
        if(isEmpty(document.all.txtOperateName.value))  
        {
            parent.document.all.txtWroMessage.value=document.getElementById("hidMessage").value;
            document.all.txtOperateName.focus();
            return false;					
        }
    }
    </script>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 370px">
                                        <tr>
                                            <td class="tdTopBackColor" style="vertical-align: middle; height: 25px;
                                                ...
                                                <asp:Label ID="labCustomer" runat="server" Text="<%$ Resources:BaseInfo,PotCustomer_BrandOperateType %>" Width="376px"></asp:Label></td>
                                                ...
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tdBackColor" style="width: 232px; height: 30px; text-align: left">
                                                            <asp:TextBox ID="txtOperateName" runat="server" CssClass="ipt160px" MaxLength="16"></asp:TextBox></td>
                                                        ...
                                                        <td class="tdBackColor" style="width: 127px; height: 30px; text-align: left">
                                                            <asp:DropDownList ID="cmbTypeStatus" runat="server" BackColor="White" CssClass="cmb160px" Width="165px">
                                                            </asp:DropDownList></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="8" style="height: 192px;padding-left:10px; padding-right:10px" valign="top">
                                                            &nbsp;<asp:GridView ID="GrdBrandOperateType" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                PageSize="9" Width="100%" OnRowDataBound="GrdVewCustType_RowDataBound" AllowPaging="True" OnPageIndexChanging="GrdBrandOperateType_PageIndexChanging">
                                                                <Columns>
                                                                    <asp:BoundField DataField="OperateTypeId">
                                                                        <ItemStyle CssClass="hidden" />
                                                                        <HeaderStyle CssClass="hidden" />
                                                                        <FooterStyle CssClass="hidden" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="OperateName" HeaderText="<%$ Resources:BaseInfo,CustType_lblCustTypeName %>" >
