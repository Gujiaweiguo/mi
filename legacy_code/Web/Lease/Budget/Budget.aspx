<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Budget.aspx.cs" Inherits="Lease_Budget_Budget" %>
...
<head id="Head1" runat="server">
	...
	function Load()
    {
        addTabTool("<%=strFresh %>,Lease/Budget/Budget.aspx");
        loadTitle();
    }
    function BtnUp( p )
    {
              ...
              <table border="0" cellpadding="0" cellspacing="0" style="width: 98%; height: 4px">
                <tr>
                    <td align="left" class="tdTopRightBackColor" style="vertical-align: top; width: 356px;
                        ...
                        <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,Menu_BudgetInsert %>"
                      ...
                      <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,PotShop_lblShopType %>">
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,Budget_UnitTypeName %>">
                         ...
                         <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,Budget_RentType %>">
                                            <ItemTemplate>
                                                &nbsp;<asp:TextBox ID="txtRentType" runat="server" CssClass="ipt35px" Text='<%# DataBinder.Eval(Container, "DataItem.RentType")%>' Font-Size="9pt" Width="80px" ReadOnly="true"></asp:TextBox>
                                            </ItemTemplate>  
                                            <ItemStyle BorderColor="#E1E0B2" />
                                            <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" HorizontalAlign="Left" />
                                         <FooterStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:BaseInfo,Budget_RentAmt %>">
                                            <ItemTemplate>
                                                &nbsp;<asp:TextBox ID="txtRentAmt" runat="server" CssClass="ipt35px" Text='<%# DataBinder.Eval(Container, "DataItem.RentAmt")%>' Font-Size="9pt" Width="80px" ReadOnly="true"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle BorderColor="#E1E0B2" />
                                            <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" HorizontalAlign="Left" />
                                         <FooterStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                           ...
                           <asp:TemplateField>
                                ...
                                <tr>
                                    <td style="width: 10%; height: 36px;" align="right">
                                        ...
                                        <asp:Button ID="btnQuery" runat="server" CssClass="buttonQuery" Enabled="False" 
                                             onmouseout="BtnUp(this.id);" 
                                            onmouseover="BtnOver(this.id);" onmouseup="BtnUp(this.id);" 
                                            Text="<%$ Resources:BaseInfo,User_lblQuery %>" onclick="btnAdd_Click" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                        ...
                        <asp:Button ID="btnSave" runat="server" CssClass="buttonSave" 
                                Text="<%$ Resources:BaseInfo,Budget_Insert %>" OnClick="btnSave_Click" 
                                ...
                                Text="<%$ Resources:BaseInfo,User_btnCancel %>"  onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);" OnClick="btnCancel_Click"/>
                                        &nbsp;
                                    </td>
                                </tr>
                            </table>
