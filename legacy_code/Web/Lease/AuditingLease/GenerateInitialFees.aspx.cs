...
public partial class Lease_AuditingLease_GenerateInitialFees : BasePage
{
    ...
    private void QueryData(int invCode)
    {
        ...
        string sql = "select A.ChargeTypeID,convert(char(10),A.InvStartDate,120) as InvStartDate, convert(char(10),A.InvEndDate,120) as InvEndDate,A.InvActPayAmtL,'' as ChargeTypeName " +
                       " from invoicedetail A , ChargeType B " +
                       " where A.InvID = " + invCode + " and A.ChargeTypeID = B.ChargeTypeID and InvPayAmt > " + 0;
        BaseBO baseBo = new BaseBO();
