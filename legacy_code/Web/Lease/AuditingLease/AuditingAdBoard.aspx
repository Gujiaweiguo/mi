<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditingAdBoard.aspx.cs" Inherits="Lease_AuditingLease_AuditingAdBoard" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AuditingLease/AuditingAdBoard.aspx~<%=leaseItem %>,Lease/AuditingLease/AuditingLeaseItemPalaver.aspx~<%=shopInfo %>,Lease/AdContract/AdBoardListPalaver.aspx~<%=espression %>,Lease/AdContract/AdBoardExpressionPalaver.aspx~<%=firstFess%>,Lease/AuditingLease/GenerateInitialFeesAd.aspx");
