<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GenerateInitialFeesAd.aspx.cs" Inherits="Lease_AuditingLease_GenerateInitialFeesAd" %>
    ...
    <div>
        ...
        <ContentTemplate>
            ...
            <tr>
                ...
                <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Lease_lblAdBoardAccount %>" Height="12pt" Width="218px"></asp:Label>
                </td>
