<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstChargeUnion.aspx.cs" Inherits="Lease_AuditingLease_FirstChargeUnion" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AuditingLease/FirstChargeUnion.aspx~<%=leaseItem %>,Lease/LeaseConUnion/ConUnionItemAuditing.aspx~<%=shopInfo %>,Lease/ShopBaseInfoPalaver.aspx~<%=espression %>,Lease/ExpressionPalaver.aspx~<%=firstFess %>,Lease/ChargeAccount/UnionChargeFirst.aspx");//~<%=firstFess %>,Lease/ChargeAccount/UnionChargeFirst.aspx
	        loadTitle();
	    }
    </script>
</head>
<body onload="Load()" style="margin:0px" >
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
        <tr>
            <td style="width: 669px; text-align: left; height: 28px;" class="tdTopRightBackColor" align="left">
                ...
                <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,Lease_lblBasic %>" Width="251px"></asp:Label></td>
    ...
    <tr>
        ...
        <td style="height:18px;">
            <asp:DropDownList ID="ddlSubs" runat="server" Width="165px" BackColor="#F5F5F4" 
                Enabled="False">
            </asp:DropDownList>
        </td>
    </tr>
        ...
        <tr style="height:8px">
            ...
            <td class="baseInput">
                <table width="165px" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="baseLable" style="width: 105px">
            <asp:Label ID="Label54" runat="server" CssClass="labelStyle" 
                Text="<%$ Resources:BaseInfo,LeaseholdContract_labAdditionalItem %>"></asp:Label>
                        </td>
                        <td >
            <asp:TextBox ID="listBoxAddItem" runat="server" Height="72px" 
                CssClass="ipt160px" TextMode="MultiLine" ReadOnly="True"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="baseLable" style="width: 105px">
                            &nbsp;</td>
    ...
    <td colspan="2"></td>
        ...
        <tr style="height:5px">
            ...
            <td class="baseInput" style="height: 5px">
              ...
              <tr style="height: 8px">
                        <td class="baseLable" style="width: 105px;" valign="top">
            ...
            <asp:TextBox ID="listBoxRemark" runat="server" Height="50px" CssClass="ipt160px" 
                                ReadOnly="True"></asp:TextBox></td>
                    </tr>       
    <tr style="height:10px">
    <td colspan="2"></td>
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <asp:TextBox ID="txtStopDate" runat="server" CssClass="Enabledipt160px" ReadOnly="True" 
