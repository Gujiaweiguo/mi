<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditingUnion.aspx.cs" Inherits="Lease_AuditingLease_AuditingUnion" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AuditingLease/AuditingUnion.aspx~<%=leaseItem %>,Lease/LeaseConUnion/ConUnionItemAuditing.aspx~<%=shopInfo %>,Lease/ShopBaseInfoPalaver.aspx~<%=espression %>,Lease/ExpressionPalaver.aspx");
	        loadTitle();
	    }
    </script>
</head>
