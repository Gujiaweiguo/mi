<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditingLeasePalaver.aspx.cs" Inherits="Lease_AuditingLease_AuditingLeasePalaver" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AuditingLease/AuditingLeasePalaver.aspx~<%=leaseItem %>,Lease/AuditingLease/AuditingLeaseItemPalaver.aspx~<%=shopInfo %>,Lease/ShopBaseInfoPalaver.aspx~<%=espression %>,Lease/ExpressionPalaver.aspx");
	        loadTitle();
	    }
    </script>
</head>
<body onload="Load()" style="margin:0px" >
    ...
    <tr>
        ...
        <td style="height:18px;">
            <asp:DropDownList ID="ddlSubs" runat="server" Width="165px" BackColor="#F5F5F4" Enabled="False">
            </asp:DropDownList></td>
    </tr>
        <tr>
            <td class="baseLable" style="width: 202px">
                <asp:Label ID="Label5" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LeaseholdContract_labTradeID %>"></asp:Label></td>
            <td><asp:DropDownList ID="cmbTradeID" runat="server" Width="165px" BackColor="#F5F5F4" Enabled="False">
            </asp:DropDownList></td>
        </tr>
        <tr>
    ...
    <tr>
        ...
        <tr>
            ...
            <td><asp:DropDownList ID="ddlContractType" runat="server" Width="165px" BackColor="#F5F5F4" Enabled="False">
            </asp:DropDownList></td>
        </tr>
                <tr>
            <td class="baseLable" style="width: 202px">
            ...
            <td>
                <asp:TextBox ID="txtConStartDate" runat="server" BackColor="#F5F5F4" CssClass="ipt160px"
    ...
    <tr>
        ...
        <td rowspan="2" valign="top">
            <asp:TextBox ID="listBoxExclusive" runat="server" Height="50px" 
