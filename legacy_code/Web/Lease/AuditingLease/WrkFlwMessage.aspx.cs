...
public partial class Lease_AuditingLease_WrkFlwMessage : BasePage
{
    ...
    {
        DataSet ds = this.GetCheckApproveMessage(wrkFlwID, voucherID);
    ...
    /// <returns></returns>
    public DataSet GetCheckApproveMessage(string wrkFlwID, string voucherID)
    {
        string str_sql = "select users.userid,users.username,wrkflwentity.VoucherMemo," +
                        " wrkflwentity.completedtime,wrkflwentity.NodeStatus,'' as NodeStatusName" +
                        " from wrkflwentity,users" +
                        " where wrkflwid = " + wrkFlwID +
                        " and voucherid = " + voucherID +
                        " and users.userid = wrkflwentity.userid And NodeStatus Not In (" + WrkFlwEntity.NODE_STATUS_NORMAL_PENDING + "," + WrkFlwEntity.NODE_STATUS_REJECT_PENDING + ")" +
