...
public partial class Lease_AuditingLease_SelectAdBoard : BasePage
{
    ...
    protected void page()
    {
        ...
        string str_sql = "select A.ContractID,A.CustID,A.ContractCode,A.RefID,A.BizMode,A.ConStartDate,A.ConEndDate,A.PenaltyItem,A.ChargeStartDate," +
                          " A.TradeID,A.ContractStatus,A.Penalty,A.Notice,A.AdditionalItem,A.EConURL,A.Note,A.CommOper,A.NorentDays,A.ContractTypeID from Contract A " +
                             " where A.ContractStatus = " + Contract.CONTRACTSTATUS_TYPE_INGEAR + " and A.BizMode = " + Contract.BIZ_MODE_AdBoard + " and A.ContractID not in (select ContractID from InvoiceHeader where IsFirst = " + InvoiceHeader.ISFIRST_YES + ") order by A.ContractCode";
    ...
    protected void GrdCust_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("AuditingAdBoard.aspx");
    }
