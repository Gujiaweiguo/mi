<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditingArea.aspx.cs" Inherits="Lease_AuditingLease_AuditingArea" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AuditingLease/AuditingArea.aspx~<%=leaseItem %>,Lease/AuditingLease/AuditingLeaseItemPalaver.aspx~<%=shopInfo %>,Lease/AdContract/AreaListPalaver.aspx~<%=espression %>,Lease/AdContract/AdBoardExpressionPalaver.aspx~<%=firstFess%>,Lease/AuditingLease/GenerateInitialFeesArea.aspx");
	        loadTitle();
	    }
    </script>
</head>
