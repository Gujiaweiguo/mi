<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectAdBoard.aspx.cs" Inherits="Lease_AuditingLease_SelectAdBoard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
         <title><%= (String)GetGlobalResourceObject("BaseInfo", "Menu_ADContractSelect")%></title>
	...
	<script type="text/javascript" src="../../JavaScript/TabTools.js"></script>
	    ...
	    function Load()
	    {
	        addTabTool(document.getElementById("hidcon").value + ",Lease/AuditingLease/SelectAdBoard.aspx");
	        loadTitle();
                        ...
                        <table id="TABLE0" border="0" cellpadding="0" cellspacing="0" style="height: 24px;
                            ...
                            <tr>
                                ...
                                <td class="tdTopBackColor">
                                    <%= (String)GetGlobalResourceObject("BaseInfo", "Menu_ADContractSelect")%>
                                </td>
                            </tr>
                        </table>
                    </td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width: 100%; height: 12px; text-align: center" class="tdBackColor" colspan="8">
                                            <table style="left: 0px; width: 95%; position: relative; top: 0px;" 
                                                    ...
                                                    <tr>
                                                        <td style="left: 7px; vertical-align: top; width: 100%; position: relative; text-align: center">
                                                            <asp:GridView ID="GrdCust" runat="server" BorderWidth="1px" BorderStyle="Inset" 
                                                                CellPadding="3" BackColor="White" Width="100%" Height="258px"
                                                                AutoGenerateColumns="False" 
                                                                OnSelectedIndexChanged="GrdCust_SelectedIndexChanged" OnPageIndexChanging="GrdCust_OnPageIndexChanging" 
...
<PagerSettings Mode="NextPreviousFirstLast"  />
        ...
        <asp:HiddenField ID="hidcon" runat="server" Value="<%$ Resources:BaseInfo,Menu_ADContractSelect %>" />
    </form>
</body>
</html>
