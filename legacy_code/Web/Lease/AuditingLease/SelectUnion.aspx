<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectUnion.aspx.cs" Inherits="Lease_AuditingLease_SelectUnion" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript" src="../../JavaScript/TabTools.js"></script>
	    ...
	    function Load()
	    {
	        addTabTool(document.getElementById("hidcon").value + ",Lease/AuditingLease/SelectUnion.aspx");
	        loadTitle();
...
<%--                    <tr>
                        ...
                        <table id="TABLE0" border="0" cellpadding="0" cellspacing="0" style="height: 24px;
                            ...
                            <tr>
                                ...
                                <td class="tdTopBackColor">
                                    <%= (String)GetGlobalResourceObject("BaseInfo", "Menu_FirstUnion")%>
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <tr>
                        <td style=" height: 329px; text-align: center" class="tdBackColor" valign="top"
                            colspan="3">
                            <table style="width: 98%; height: 350px" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    <tr>
                                        <td style="width: 1px; height: 15px" class="tdBackColor" colspan="8">
                                        </td>
                                    </tr>
                                    
                                    <tr>
                                        <td style=" height: 12px; text-align: center" class="tdBackColor" colspan="8">
                                            <table style="left: 0px; width: 98%; position: relative" cellspacing="0" cellpadding="0"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                    ...
                                    <tr>
                                        <td style=" height: 260px; text-align: center; vertical-align: top;" class="tdBackColor" colspan="8">
                                            <table style="width:100%; height: 260px;">
                                                <tbody>
                                                    <tr>
                                                        <td style="left: 0px; vertical-align: top; width: 90%; position: relative; text-align: center">
...
<PagerSettings Mode="NextPreviousFirstLast"  />
                                    ...
                                    <tr>
                                        <td style=" height: 12px" class="tdBackColor">
                                        </td>
                                        <td style="height: 12px" class="tdBackColor">
                                        </td>
                                        <td style=" height: 12px" class="tdBackColor">
                                        ...
                                        <td style="vertical-align: top; width: 98%; height: 44px; left: 0px; text-align:center;" class="tdBackColor"
                                            ...
                                            <table style="width: 98%" cellspacing="0" cellpadding="0" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 160px; height: 1px; background-color: #738495;top:-5px; left: 0px; position: relative;">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 160px; height: 1px; background-color: #ffffff;top:-5px; left: 0px; position: relative;">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
        ...
        <asp:HiddenField ID="hidcon" runat="server" Value="<%$ Resources:BaseInfo,Menu_FirstUnion %>" />
    </form>
</body>
</html>
