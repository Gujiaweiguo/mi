<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditingLease.aspx.cs" Inherits="Lease_AuditingLease_AuditingLease" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript">
	   function Load()
	   {
	        addTabTool("<%=baseInfo %>,Lease/AuditingLease/AuditingLease.aspx~<%=leaseItem %>,Lease/AuditingLease/AuditingLeaseItemPalaver.aspx~<%=shopInfo %>,Lease/ShopBaseInfoPalaver.aspx~<%=espression %>,Lease/ExpressionPalaver.aspx~<%=firstFess%>,Lease/AuditingLease/GenerateInitialFees.aspx");
	        loadTitle();
	   }
	</script>
    ...
    <tr>
        <td class="baseLable" style="width: 202px">
            <asp:Label ID="Label14" runat="server" CssClass="labelStyle" 
                Text="<%$ Resources:BaseInfo,Contract_ManageCompany %>"></asp:Label></td>
        ...
        <tr>
            <td class="baseLable" style="height: 28px; width: 202px;">
                <asp:Label ID="Label12" runat="server" CssClass="labelStyle" 
                    Text="<%$ Resources:BaseInfo,Contract_ContractType %>"></asp:Label></td>
            <td style="height: 28px">
    ...
    <td colspan="2"></td>
        ...
        <tr style="height:5px">
            ...
            <td class="baseInput" style="height: 5px">
              ...
              <tr style="height: 8px">
                        <td class="baseLable" style="width: 105px; vertical-align: top;">
