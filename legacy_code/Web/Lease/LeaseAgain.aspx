<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaseAgain.aspx.cs" Inherits="Lease_LeaseAgain" ResponseEncoding="gb2312" %>
...
<head runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/LeaseAgain.aspx~<%=leaseItem %>,Lease/LeaseItem.aspx~<%=shopInfo %>,Lease/ShopBaseInfo.aspx~<%=espression %>,Lease/Expression.aspx");
	        loadTitle();
	    }
...
<body style="margin:0px" onload="Load()">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ContentTemplate>
         <div id="BaseBargain" style="width:100%; text-align:center">
    <table border="0" cellpadding="0" cellspacing="0" style="height: 386px; width: 100%; text-align:center">
        <tr>
