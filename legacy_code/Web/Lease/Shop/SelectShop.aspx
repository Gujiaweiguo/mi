<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectShop.aspx.cs" Inherits="Lease_Shop_SelectShop" %>
...
<base target="_self"/>
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "TpUsr_ShopList")%></title>
...
//        txtObjId.value = value;
        ...
        {
            window.returnValue=tradeLevel.slice(6);
            window.close();
            return true;
        }
    } 
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="height: 32px; width: 230px;">
            <tr>
                ...
                <td class="tdTopRightBackColor" style="height: 27px; text-align: left">
                    <asp:Label ID="Label1" runat="server" Height="12pt" Text="<%$ Resources:BaseInfo,TpUsr_ShopList %>"></asp:Label></td>
            ...
            <tr>
                <td style="height: 290px; text-align: left;">
                    <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderStyle="Inset" BorderWidth="1px"
                        Height="290px" ScrollBars="Auto" Width="230px">
                        <table>
                            <tr>
