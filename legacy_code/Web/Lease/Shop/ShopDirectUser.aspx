<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopDirectUser.aspx.cs" Inherits="Lease_Shop_ShopDirectUser" %>
...
function treearray()
{
    ...
    for(var i=0;i<num.length-1;i++)
    {
        ...
        addTabTool("<%=strFresh %>,Lease/Shop/ShopDirectUser.aspx");
	    loadTitle();
}
                        ...
                        <tr>
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 22px; width: 100%;   ">
                            <tr>
                                ...
                                <asp:Label
                                    ID="labUserInfo" runat="server" Text='<%$ Resources:BaseInfo,Rpt_TpUsrTitle %>' Width="158px" CssClass="lblTitle"></asp:Label></td>
