<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaseUnionModify.aspx.cs" Inherits="Lease_LeaseUnionItemModify_LeaseUnionModify" %>
...
<head id="Head1" runat="server">
    ...
    function Load()
    {
        addTabTool("<%=baseInfo %>,Lease/LeaseUnionItemModify/LeaseUnionModify.aspx~<%=leaseItem %>,Lease/LeaseUnionItemModify/LeaseUnionItemModify.aspx~<%=shopInfo %>,Lease/LeaseItemModify/LeaseConShopModify.aspx");
	    loadTitle();
    }
