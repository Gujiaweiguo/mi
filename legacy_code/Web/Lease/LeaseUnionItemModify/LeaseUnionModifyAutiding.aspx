<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaseUnionModifyAutiding.aspx.cs" Inherits="Lease_LeaseUnionItemModify_LeaseUnionModifyAutiding" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "LeaseModify_TitleAutiding")%></title>
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/LeaseUnionItemModify/LeaseUnionModifyAutiding.aspx~<%=leaseItem %>,Lease/LeaseUnionItemModify/LeaseUnionItemModifyAutiding.aspx~<%=shopInfo %>,Lease/LeaseItemModify/LeaseConShopModifyAutiding.aspx");
	        loadTitle();
	    }
    </script>
</head>
<body onload="Load()" style="margin:0px" >
    ...
    <tr>
        ...
        <td rowspan="2" valign="top">
            <asp:TextBox ID="listBoxAddItem" runat="server" Height="52px" CssClass="ipt160px" BackColor="#F5F5F4" ReadOnly="True"></asp:TextBox></td>
    </tr>
        <tr>
    ...
    <td colspan="2"></td>
        ...
        <td rowspan="2" valign="top">
            <asp:TextBox ID="txtNode" runat="server" Height="52px" CssClass="ipt160px" BackColor="#F5F5F4" ReadOnly="True"></asp:TextBox></td>
    </tr>
        <tr>
    ...
    <tr>
        ...
        <tr>
            <td style="width: 112px">
                    ...
                    <tr>
                        <td style="width: 112px; text-align: right; height: 30px;">
                            &nbsp;</td>
                        <td rowspan="1" valign="top" style="height: 30px">
                            &nbsp;<asp:Button
                                    ...
                                    Text="<%$ Resources:BaseInfo,CustPalaver_butConsent %>" Width="69px" />
                            <asp:Button
                                        ID="btnPutIn" runat="server" CssClass="buttonSave" Height="33px" OnClick="btnPutIn_Click"
                                        Text="<%$ Resources:BaseInfo,Lease_NewLineBtnPutIn %>" Visible="False" Width="32px" />
                            <asp:Button ID="btnDispose" runat="server" CssClass="buttonClear" Height="32px" OnClick="btnDispose_Click"
                                Text="<%$ Resources:BaseInfo,CustPalaver_butOverrule %>" Width="70px" /></td>
                    </tr>
                </table>
