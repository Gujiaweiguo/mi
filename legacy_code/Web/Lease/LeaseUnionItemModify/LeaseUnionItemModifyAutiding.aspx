<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaseUnionItemModifyAutiding.aspx.cs" Inherits="Lease_LeaseUnionItemModify_LeaseUnionItemModifyAutiding" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="tblUnionLease" style="width: 709px;
                    ...
                    <tr>
                        ...
                        <td class="tdBackColor" style="width: 516px; height: 28px;">
                            <asp:TextBox ID="txtRentInc" runat="server" CssClass="ipt160px" Style="ime-mode: disabled" ReadOnly="True"></asp:TextBox></td>
                    </tr>
                    <tr class="colLine">
                    ...
                    <tr>
                        <td align="right" class="tdBackColor" style="padding-right: 5px" width="20%">
                            <asp:Label ID="Label26" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ConLease_lblTaxFrank %>"
                                Width="70px"></asp:Label></td>
                        <td class="tdBackColor" style="width: 516px">
                            <asp:TextBox ID="txtTaxRate" runat="server" CssClass="ipt160px" Style="ime-mode: disabled" ReadOnly="True"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td align="right" class="tdBackColor" style="padding-right: 5px" width="20%">
                            <asp:Label ID="Label27" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ConLease_InvoiceType %>"
                                Width="70px"></asp:Label></td>
                        <td class="tdBackColor" style="width: 516px">
                            <asp:DropDownList ID="DDownListTaxType" runat="server" Width="165px" Enabled="False">
                            </asp:DropDownList></td>
                    </tr>
                    <tr class="colLine">
                        <td class="tdBackColor" style="width: 1px; height: 20px;">
                    ...
                    <tr>
                        <td align="right" class="tdBackColor" style="padding-right: 5px" width="20%">
                            <asp:Label ID="Label1" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LeaseConUnion_InTaxRate %>"
                                Width="70px"></asp:Label></td>
                        <td class="tdBackColor" style="width: 516px">
                            <asp:TextBox ID="txtInTaxRate" runat="server" CssClass="ipt160px" Style="ime-mode: disabled" ReadOnly="True"></asp:TextBox></td>
                    </tr>
                    <tr>
                        ...
                        <td class="tdBackColor" style="width: 516px; height: 16px;">
                            <asp:TextBox ID="txtOutTaxRate" runat="server" CssClass="ipt160px" Style="ime-mode: disabled" ReadOnly="True"></asp:TextBox></td>
                    </tr>
                    <tr>
