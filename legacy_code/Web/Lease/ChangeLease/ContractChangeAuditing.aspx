<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractChangeAuditing.aspx.cs" Inherits="Lease_ChangeLease_ContractChangeAuditing" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title><%= (String)GetGlobalResourceObject("BaseInfo", "Lease_Approverentalformulachanges")%></title>
    ...
    function Load()
    {
        addTabTool("<%=titleName%>,Lease/ChangeLease/ContractChangeAuditing.aspx~<%=changeLease%>,Lease/ExpressionPalaver.aspx~<%=changeLeaseNow%>,Lease/ChangeLease/ChangeExpressionAuditing.aspx");
	    loadTitle();
    }
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 452px">
                                    <tr>
                                        <td align="left" class="tdTopRightBackColor" style="width: 557px; height: 22px; text-align: left">
                                            ...
                                            <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,Lease_Approverentalformulachanges %>" Width="291px"></asp:Label></td>
                    ...
                    -->
                                                    <td valign="top" width="50%" style="width: 100%">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 28px">
                                                                    <asp:TextBox ID="txtTradeID" runat="server" Enabled="False" 
                                                                        CssClass="Enabledipt160px" ReadOnly="True"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="baseLable">
                                                                    <asp:Label ID="Label52" runat="server" CssClass="labelStyle" 
                                                                        Text="<%$ Resources:BaseInfo,LeaseholdContract_labPenalty %>" Width="99px"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:DropDownList ID="DDownListPenalty" runat="server" Enabled="False" 
                                                                        Width="165px">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="baseLable">
                                                                    <asp:Label ID="Label11" runat="server" CssClass="labelStyle" 
                                                                        Text="<%$ Resources:BaseInfo,LeaseholdContract_labNotice %>"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:DropDownList ID="DDownListTerm" runat="server" Enabled="False" 
                                                                        Width="165px">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                    ...
                    -->
                                                    <td style="vertical-align: top; width: 100%;" width="50%">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" style="width: 316px">
                                                            ...
                                                            <tr>
                                                                <td class="baseLable">
                                                                    <asp:Label ID="Label55" runat="server" Text="<%$ Resources:BaseInfo,LeaseholdContract_labEConURL %>" CssClass="labelStyle"></asp:Label>
                                                                </td>
                                                                <td style="height: 30px; width: 206px;">
                                                                    <asp:TextBox ID="txtBargain" runat="server" CssClass="Enabledipt160px" ReadOnly="True"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="baseLable">
                                                                    <asp:Label ID="Label56" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LeaseholdContract_labAdditionalItem %>"></asp:Label>
                                                                </td>
                                                                <td style="height: 30px; width: 206px;">
                                                            ...
                                                            <tr>
                                                                <td class="baseLable">
                                                                    <asp:Label ID="lblModReason" runat="server" CssClass="labelStyle" 
                                                                        Text="<%$ Resources:BaseInfo,ConFormulaMod_ModReason %>"></asp:Label>
                                                                </td>
                                                                <td style="height: 30px; width: 206px;">
                                                                    <asp:TextBox ID="txtModReason" runat="server" CssClass="Enabledipt160px" 
                                                                        Height="72px" ReadOnly="True" TextMode="MultiLine"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="baseLable">
                                                                    <asp:Label ID="Label1" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PublicMes_OverruleMessage %>"></asp:Label></td>
                                                                <td style="height: 30px; width: 206px;">
                                                                    <asp:TextBox ID="txtOverrule" runat="server" CssClass="ipt160px" Height="72px"
