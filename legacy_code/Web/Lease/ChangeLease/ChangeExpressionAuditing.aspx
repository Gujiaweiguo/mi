<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeExpressionAuditing.aspx.cs" Inherits="Lease_ChangeLease_ChangeExpressionAuditing" %>
...
<body onload="Load()" style="margin:0px">
    ...
    <tr>
        ...
        <td align="left" style="height: 15px" colspan="3">
            <asp:DropDownList ID="cmbChargeTypeID" runat="server" CssClass="textBoxStyle" Width="200px">
            </asp:DropDownList></td> 
    </tr>
    <tr>
        ...
        <td align="left" colspan="3" style="height: 14px">
            <asp:DropDownList ID="cmbFormulaType" runat="server" CssClass="textBoxStyle" Width="200px">
            </asp:DropDownList></td>
    </tr>
    <tr>
        <td class="leftLable">
    ...
    <tr class="gridView" style="padding-left:0px; width:100%">
        <td style="width:100%; text-align: center;" colspan="7" class="tdBackColor" valign="top">
            <asp:GridView ID="GVType" runat="server" AutoGenerateColumns="False" Height="150px"
                Width="98%" OnRowDataBound="GVType_RowDataBound" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" PageSize="8" AllowPaging="True" OnPageIndexChanging="GVType_PageIndexChanging">
                <Columns>
    ...
    <tr height="20px" style="width:100%">
        <td colspan="4" valign="middle" style="text-align: center; width:100%">
            <table border="0" cellpadding="0" cellspacing="0" width="98%">
                <tr class="bodyLine">
                    <td style="width: 280px;background-color: #738495;" class="tdBackColor">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style=" padding-left:5px;">
                                                    ...
                                                    <tr height="125px" style="overflow-x:hidden;overflow-y:scroll">
                                                        <td class="tdBackColor" colspan="4" style="text-align: center; height: 125px;"
                                                            valign="top">
                                                            <asp:GridView ID="GVDeductMoney" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" OnRowDataBound="GVDeductMoney_RowDataBound" Width="177px" OnPageIndexChanging="GVType_PageIndexChanging" PageSize="5" AllowPaging="True">
                                                                <Columns>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 95%">
                                                    ...
                                                    <tr height="125px" style="overflow-x:hidden;overflow-y:scroll">
                                                        <td class="tdBackColor" colspan="3" style=" text-align: center"
                                                            valign="top">
                                                            <asp:GridView ID="GVKeepMin" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" OnRowDataBound="GVKeepMin_RowDataBound" Width="173px" OnPageIndexChanging="GVType_PageIndexChanging" PageSize="5" AllowPaging="True">
                                                                <Columns>
                                                    ...
                                                    <tr height="36px">
                                                        <td style="width:50%; height: 36px; text-align: right;" colspan=2 align="center" >       </td>
