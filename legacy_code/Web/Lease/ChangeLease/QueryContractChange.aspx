...
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Lease_Addrentalformula")%></title>
                                                    ...
                                                    <td valign="top" width="50%" style="width: 100%">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 28px">
                                                                    <asp:TextBox ID="txtTradeID" runat="server" CssClass="Enabledipt160px"
                    ...
                    -->
                                                    <td style="vertical-align: top; width: 100%;" width="50%">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" style="width: 316px">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="text-align: center; position:relative; left:28px;">
                                                                    <asp:Button ID="btnSave" runat="server" CssClass="buttonSave" 
                                                                        OnClick="btnAdd_Click" 
                                                                        Text="<%$ Resources:BaseInfo,Lease_NewLineBtnTemp %>" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"/>
                                                                    <asp:Button ID="btnPutIn" runat="server" CssClass="buttonPutIn" 
                                                                        Enabled="False" OnClick="butAuditing_Click" 
