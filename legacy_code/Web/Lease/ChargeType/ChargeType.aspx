<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChargeType.aspx.cs" Inherits="Lease_ChargeType_ChargeType" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "ChargeType_lblChargeTypeDefine")%></title>
    ...
    <style type="text/css">
      ...
      <!--	    
	     function Load()
        {
            addTabTool("<%=baseInfo %>,Lease/ChargeType/ChargeType.aspx");
            loadTitle();
...
//            document.getElementById("lblCurrent").style.display="none";
        ...
        {
            if(isEmpty(document.all.txtChargeTypeCode.value))  
            {
                parent.document.all.txtWroMessage.value='<%= emptyStr %>';
                document.all.txtChargeTypeCode.focus();
                return false;					
            }
            if(isEmpty(document.all.txtChargeTypeName.value))  
            {
                parent.document.all.txtWroMessage.value='<%= emptyStr %>';
                document.all.txtChargeTypeName.focus();
                return false;					
            }
        }
	    -->  
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 27px; width: 100%;">
                            <tr>
                                ...
                                <td class="tdTopRightBackColor" style=" height: 27px; text-align:left;">
                                    <asp:Label
                                        ID="Label1" runat="server" Text='<%$ Resources:BaseInfo,ChargeType_lblChargeTypeDefine %>' Height="12pt" Width="218px"></asp:Label></td>
                             ...
                             <tr style="height: 1px">
                                 <td colspan="3" class="tdBackColor">
                                     <table style="width: 100%;" align="center" >
                                         ...
                                         <tr>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label2" runat="server" Text="<%$ Resources:BaseInfo,ChargeType_lblChargeTypeCode %>" CssClass="labelStyle" Width="92px"></asp:Label></td>
                                             <td>
                                                 <asp:TextBox ID="txtChargeTypeCode" runat="server" CssClass="ipt160px" MaxLength="32"></asp:TextBox></td>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label3" runat="server" Text="<%$ Resources:BaseInfo,ChargeType_lblChargeTypeName %>" CssClass="labelStyle" Width="87px"></asp:Label></td>
                                             <td class="baseInput" style="width: 497px">
                                                 <asp:TextBox ID="txtChargeTypeName" runat="server" CssClass="ipt160px" MaxLength="16"></asp:TextBox></td>
                                         </tr>
                                         <tr>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label5" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ChargeType_lblChargeClass %>"></asp:Label></td>
                                             <td>
                                                 <asp:DropDownList ID="DownListChargeClass" runat="server" Width="163px">
                                                 </asp:DropDownList></td>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label4" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ChargeType_lblIsChargeCross %>"></asp:Label></td>
                                             <td class="baseInput" style="width: 497px">
                                                 <asp:DropDownList ID="DownListIsChargeCross" runat="server" Width="165px">
                                                 </asp:DropDownList></td>
                                         </tr>
                                         <tr>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label7" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,lblChargeType_AccountNumber %>"></asp:Label></td>
                                             <td class="baseLable">
                                                 <asp:TextBox ID="txtFinal" runat="server" CssClass="ipt160px" Width="160px" MaxLength="32"></asp:TextBox></td>
                                             <td class="baseLable">
                                             ...
                                             <td colspan="4" style="text-align: center; width:100%;">
                                                 <asp:GridView ID="gvChargeType" runat="server" AutoGenerateColumns="False"  BorderStyle="Inset" BorderWidth="1px" CellPadding="3"
                                                     ...
                                                     <Columns>
                                                         ...
                                                         <asp:BoundField DataField="ChargeTypeCode" HeaderText="<%$ Resources:BaseInfo,ChargeType_lblChargeTypeCode %>" >
                                                         ...
                                                         <asp:BoundField DataField="ChargeClassName" HeaderText="<%$ Resources:BaseInfo,ChargeType_lblChargeClass %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="IsChargeCrossName" HeaderText="<%$ Resources:BaseInfo,ChargeType_lblIsChargeCross %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="AccountNumber" HeaderText="<%$ Resources:BaseInfo,lblChargeType_AccountNumber %>">
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
