...
public partial class Lease_ConUnionAgain_UnionAgain : BasePage
{
    #region 定义
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["Type"] == "New")
            {
                ...
                cookies.Values.Add("conStatus", cmbContractStatus.Text);
    ...
    protected void SaveBaseBargain()
    {
        ...
        try
        {
            ...
            baseTrans.WhereClause = "TradeID = '" + Convert.ToInt32(hidTradeID.Text) + "'";
            ...
            contact.BizMode = Contract.BIZ_MODE_UNIT;
