<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnionAgain.aspx.cs" Inherits="Lease_ConUnionAgain_UnionAgain" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
     <title><%= (String)GetGlobalResourceObject("BaseInfo", "Lease_Renewjointventurelease")%></title>
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/ConUnionAgain/UnionAgain.aspx~<%=leaseItem %>,Lease/LeaseConUnion/ConUnionItem.aspx~<%=shopInfo %>,Lease/ShopBaseInfo.aspx~<%=espression %>,Lease/Expression.aspx");
	        loadTitle();
	    }
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="height: 386px; width: 710px;">
        <tr>
            <td style="width: 430px; height: 24px; text-align: left;" class="tdTopRightBackColor" align="left">
                ...
                <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,Union_lblWrite %>" Width="314px"></asp:Label></td>
            ...
            <td colspan="2"></td>
                    ...
                    <tr>
                        <td align="right" colspan="2" rowspan="1" valign="top" style="margin-right:30px; height: 28px;">
                            ...
                            <asp:Button ID="btnBalnkOut" runat="server" CssClass="buttonClear" Enabled="False" OnClick="btnBalnkOut_Click" Text="<%$ Resources:BaseInfo,ConLease_butDel %>" /></td>
                    </tr>
                    <!--  *********
                    -->   
