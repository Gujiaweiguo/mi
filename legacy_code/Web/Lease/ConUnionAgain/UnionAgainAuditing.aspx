<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnionAgainAuditing.aspx.cs" Inherits="Lease_ConUnionAgain_UnionAgainAuditing" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Lease_RenewjointventureUnion")%></title>
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/ConUnionAgain/UnionAgainAuditing.aspx~<%=leaseItem %>,Lease/LeaseConUnion/ConUnionItemAuditing.aspx~<%=shopInfo %>,Lease/ShopBaseInfoPalaver.aspx~<%=espression %>,Lease/ExpressionPalaver.aspx");
	        loadTitle();
	    }
    </script>
</head>
                    ...
                    <tr>
                        ...
                        <td rowspan="1" valign="top">
                            <asp:Button ID="btnDispose" runat="server" CssClass="buttonClear" Height="32px" OnClick="btnDispose_Click"
                                Text="<%$ Resources:BaseInfo,CustPalaver_butOverrule %>" Width="70px" /><asp:Button
                                    ...
                                    Text="<%$ Resources:BaseInfo,CustPalaver_butConsent %>" Width="69px" /><asp:Button
                                        ...
                                        Text="<%$ Resources:BaseInfo,Lease_NewLineBtnPutIn %>" Visible="False" Width="93px" /></td>
                    </tr>
                </table>
