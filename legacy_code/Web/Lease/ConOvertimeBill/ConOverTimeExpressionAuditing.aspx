<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConOverTimeExpressionAuditing.aspx.cs" Inherits="Lease_ConOvertimeBill_ConOverTimeExpressionAuditing" %>
...
<body onload="Load()" style="margin:0px">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
            <!--********************left**********************-->
                <td class="tdBackColor" colspan="2" style="text-align:left;width:53%; height: 370px;" valign="top">
    ...
    <tr class="colLine" style="width:100%">
        <td colspan="4" valign="middle" style="height: 10px; width:100%; text-align: center;">
    ...
    <tr class="gridView" style="padding-left:10px; width:100%">
        <td style="width:296px; text-align: center; width:100%" colspan="7" class="tdBackColor" valign="top">
            <asp:GridView ID="GVType" runat="server" AutoGenerateColumns="False" Height="150px"
                Width="98%" OnRowDataBound="GVType_RowDataBound" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" OnSelectedIndexChanged="GVType_SelectedIndexChanged" PageSize="11" AllowPaging="True" OnPageIndexChanging="GVType_PageIndexChanging">
                <Columns>
                ...
                <asp:linkbutton id="btnGo" runat="server" causesvalidation="False" commandargument="-1" commandname="Page" text="GO" /> 
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="True" Visible="False" Width="11px" Height="1px"></asp:TextBox><input id="Hidden1" runat="server" type="hidden" style="width: 16px; height: 14px;" /><asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" Height="1px" Width="1px"></asp:LinkButton></td> 
    </tr>
    <tr height="20px">
        <td colspan="4" valign="middle" style="text-align: center">
            <table border="0" cellpadding="0" cellspacing="0" width="98%">
    ...
    <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="tdBackColor" style="width: 90%">
             <tr class="topLine">
                ...
                <td class="tdTopRightBackColor" style="text-align: right; width: 11px;">
            ...
            <tr height="95">
                <td colspan="2" style="text-align: left; padding-left: 10px;" >
                                <fieldset style="border-right: #c0c0c0 1px solid; border-top: #c0c0c0 1px solid;
                                    border-left: #c0c0c0 1px solid; border-bottom: #c0c0c0 1px solid; width: 365px; height: 80px; text-align: left;">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style=" padding-left:5px;">
                                                    ...
                                                    <tr height="125px" style="overflow-x:hidden;overflow-y:scroll">
                                                        <td class="tdBackColor" colspan="4" style="text-align: center;"
                                                            valign="top">
                                                            <asp:GridView ID="GVDeductMoney" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" OnRowDataBound="GVDeductMoney_RowDataBound" Width="177px" OnPageIndexChanging="GVType_PageIndexChanging" AllowPaging="True">
                                                                <Columns>
                                                    ...
                                                    <tr >
                                                        <td colspan="4">
                                                            <input id="HiddenDeduct1" runat="server" style="width: 3px; height: 4px" type="hidden" /></td>
                                                    </tr>
                                                    <tr class="colLine" style="width:100%">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 95%">
                                                    ...
                                                    <tr height="125px" style="overflow-x:hidden;overflow-y:scroll">
                                                        <td class="tdBackColor" colspan="3" style=" text-align: center"
                                                            valign="top">
                                                            <asp:GridView ID="GVKeepMin" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" OnRowDataBound="GVKeepMin_RowDataBound" Width="173px" OnPageIndexChanging="GVType_PageIndexChanging" AllowPaging="True">
                                                                <Columns>
                                                    ...
                                                    <tr>
                                                        <td style="height: 15px;" colspan="5" class="tdBackColor">
                                                            <input id="HiddenKeepMin1" style="width: 2px; height: 4px" type="hidden" runat="server" /></td>
                                                    </tr>
                                                    <tr class="colLine" style="width:100%">
