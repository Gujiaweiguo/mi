<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConOverTimeExpressionNow.aspx.cs" Inherits="Lease_ConOvertimeBill_ConOverTimeExpressionNow" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title><%= (String)GetGlobalResourceObject("BaseInfo", "ChangeLease_Update")%></title>
...
<body onload="Load()" style="margin:0px">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
            <!--********************left**********************-->
                <td class="tdBackColor" colspan="2" style="text-align:left;width:55%; height: 370px;" valign="top">
    ...
    <tr class="headLine" >
        <td style="background-color:White; height: 1px;" colspan="4"></td> 
    </tr>
    <tr class="colLine" style="text-align:center">
        <td colspan="4" valign="middle">
            <table border="0" cellpadding="0" cellspacing="0" width="95%" style="text-align:center;">
                <tr class="bodyLine">
    ...
    <tr>
        ...
        <td class="leftLable" style="width: 20px" align="right">
    ...
    <tr class="gridView" style="width:100%">
        <td style="width:100%; text-align: center; height: 200px;" colspan="7" class="tdBackColor" valign="top">
            <asp:GridView ID="GVType" runat="server" AutoGenerateColumns="False" Height="100%"
                Width="95%" OnRowDataBound="GVType_RowDataBound" BackColor="White" 
                BorderColor="#E1E0B2" BorderWidth="1px" 
                OnSelectedIndexChanged="GVType_SelectedIndexChanged" PageSize="8" 
                AllowPaging="True" OnPageIndexChanging="GVType_PageIndexChanging" 
                BorderStyle="Outset">
                <Columns>
    ...
    <tr>
        <td style="text-align:center; height: 15px;" colspan="4">
            <asp:Button ID="btnSave" runat="server" CssClass="buttonSave" OnClick="IBtnSave_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                Text="<%$ Resources:BaseInfo,PotCustomer_butSave %>" Enabled="False" />&nbsp;
            <asp:Button ID="btnAdd" runat="server" CssClass="buttonAdd" OnClick="IBtnAdd_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                Text="<%$ Resources:BaseInfo,PotCustomer_butAdd %>" />
            &nbsp;<asp:Button ID="btnBlankOut" runat="server" CssClass="buttonClear" OnClick="IBtnDel_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                Text="<%$ Resources:BaseInfo,Btn_Del %>" />
            &nbsp;<asp:Button ID="btnEdit" runat="server" CssClass="buttonEdit" OnClick="IBtnModify_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                Text="<%$ Resources:BaseInfo,Btn_Edit %>" Visible="False" /></td> 
    </tr>
</table>
                ...
                <!--************************right********************-->
                <td style="text-align: center; width:46%; height: 370px;" valign="top" class="tdBackColor">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style=" padding-left:5px;">
                                                    ...
                                                    <tr height="125px" style="overflow-x:hidden;overflow-y:scroll">
                                                        <td class="tdBackColor" colspan="4" style="text-align: center; height: 125px;"
                                                            valign="top">
                                                            <asp:GridView ID="GVDeductMoney" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" OnRowDataBound="GVDeductMoney_RowDataBound" Width="177px" OnPageIndexChanging="GVType_PageIndexChanging" PageSize="6" AllowPaging="True">
                                                                <Columns>
                                                                    <asp:BoundField DataField="ConFormulaPOvtmID">
                                                    ...
                                                    <tr height="36px">
                                                        ...
                                                        <asp:Button ID="bt1Add" runat="server" CssClass="buttonAdd" OnClick="BtnDeductAdd_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                                                                            Text="<%$ Resources:BaseInfo,Dept_TitleAdd %>" />&nbsp;
                                                         <asp:Button ID="bt1BlankOut" runat="server" CssClass="buttonClear" OnClick="BtnDeductDel_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                                                                            Text="<%$ Resources:BaseInfo,Btn_Del %>" />
                                                            &nbsp;
                                                        </td>
                                                    </tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 95%">
                                                    ...
                                                    <tr height="125px" style="overflow-x:hidden;overflow-y:scroll">
                                                        <td class="tdBackColor" colspan="3" style=" text-align: center"
                                                            valign="top">
                                                            <asp:GridView ID="GVKeepMin" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" OnRowDataBound="GVKeepMin_RowDataBound" Width="173px" OnPageIndexChanging="GVType_PageIndexChanging" PageSize="6" AllowPaging="True">
                                                                <Columns>
                                                                    <asp:BoundField DataField="ConFormulaMOvtmID">
                                                                        <ItemStyle CssClass="hidden" />
                                                                        <HeaderStyle CssClass="hidden" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="FormulaID" >
                                                    ...
                                                    <tr height="36px">
                                                        <td style="height: 36px;" colspan=3 align="center" >       
                                                            <asp:Button ID="bt2Add" runat="server" CssClass="buttonAdd" OnClick="BtnKeepAdd_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                                                                Text="<%$ Resources:BaseInfo,Dept_TitleAdd %>" />&nbsp;
                                                           <asp:Button ID="bt2BlankOut" runat="server" CssClass="buttonClear" OnClick="BtnKeepDel_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                                                                            Text="<%$ Resources:BaseInfo,Btn_Del %>" /></td>
