<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConOvertimeBill.aspx.cs" Inherits="Lease_ConOvertimeBill_ConOvertimeBill" %>
...
<head id="Head1" runat="server">
    ...
    function Load()
    {
        addTabTool("<%=titleName%>,Lease/ConOvertimeBill/ConOvertimeBill.aspx~<%=changeLease%>,Lease/ExpressionPalaver.aspx~<%=changeLeaseNow%>,Lease/ConOvertimeBill/ConOverTimeExpressionNow.aspx");
	    loadTitle();
    }
    
    function InputValidator(sForm)
    {
        if(document.getElementById("txtNewConEndDate").value < document.getElementById("txtNewConStartDate").value)
        {
        ...
        if((document.getElementById("txtConEndDate").value > document.getElementById("txtNewConStartDate").value))
        {
         ...
         if((document.getElementById("txtConEndDate").value > document.getElementById("txtNewConEndDate").value))
        {
            parent.document.all.txtWroMessage.value =('<%= dateError %>');
            return false;
        }       
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" style="width: 316px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 30px; width: 206px;">
                                                                    <asp:TextBox ID="txtNewConStartDate" runat="server" CssClass="ipt160px" onclick="calendar()"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="baseLable">
                                                                ...
                                                                <td class="baseInput" style="height: 30px; width: 206px;">
                                                                    <asp:TextBox ID="txtNewConEndDate" runat="server" CssClass="ipt160px" onclick="calendar()"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="baseLable">
                                                            ...
                                                            <tr style="height: 5px">
                                                                ...
                                                                <td rowspan="1" valign="top" style="width: 206px; height: 5px;">
                                                                </td>
                                                            </tr>
                                                            <tr>
