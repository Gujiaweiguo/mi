<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectAdAndGroundContract.aspx.cs" Inherits="Lease_AuditingAdAndGround_SelectAdAndGroundContract" %>
...
<head id="Head1" runat="server">
         <title><%= (String)GetGlobalResourceObject("BaseInfo", "Menu_AdContractQuery")%></title>
	...
	<script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
	    ...
	    function Load()
	    {
	        addTabTool(document.getElementById("hidcon").value + ",Lease/AuditingAdAndGround/SelectAdAndGroundContract.aspx");
	        loadTitle();
	    }
    </script>
</head>
                        ...
                        <table id="TABLE0" border="0" cellpadding="0" cellspacing="0" style="height: 24px;
                            ...
                            <tr>
                                ...
                                <td class="tdTopBackColor">
                                    <%= (String)GetGlobalResourceObject("BaseInfo", "Menu_AdContractQuery")%>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <table style="width: 100%; height: 380px" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!--广告位-->
                                            <asp:RadioButton ID="rdbUnion" runat="server" Text="<%$ Resources:BaseInfo,Rpt_AdUnit %>" GroupName="Con" /></td>
                                        <td style="width: 15%; height: 22px">
                                        <!--场地-->
                                            <asp:RadioButton ID="rdbLease" runat="server" Text="<%$ Resources:BaseInfo,Rpt_Area %>" Checked="True" GroupName="Con"/></td>
                                    ...
                                    <tr>
                                        <td style="width: 100%; height: 260px; text-align: center; vertical-align: top;" class="tdBackColor" colspan="8">
                                            <table style="width: 80%; height: 260px;">
                                                <tbody>
                                                    <tr>
                                                        <td style="left: 7px; vertical-align: top; width: 100%; position: relative; text-align: center">
                                                            <asp:GridView ID="GrdCust" runat="server" BorderWidth="1px" BorderStyle="Inset" CellPadding="3" BackColor="White" Width="100%" Height="258px"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="ContractStatusName" HeaderText="<%$ Resources:BaseInfo,LeaseholdContract_labContractStatus %>">
                                                                    <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
...
<asp:linkbutton id="btnGo" runat="server" causesvalidation="False" commandargument="-1" commandname="Page" text="GO" /> 
                                    ...
                                    <tr>
                                        <td style="height: 12px" class="tdBackColor" colspan="8">
                                        <table>
                                        <tr>
        ...
        <asp:HiddenField ID="hidcon" runat="server" Value="<%$ Resources:BaseInfo,Menu_AdContractQuery %>" />
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
</body>
