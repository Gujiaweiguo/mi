...
public partial class Lease_AuditingAdAndGround_AuditingGroundContract : BasePage
{
    #region 定义
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
           ...
           存入cookies*/
            ...
            //if (Request.QueryString["menustatus"] != null)
            //{
            //    string floorid = Request.QueryString["FloorID"].ToString();
            //    string floorname = Request.QueryString["FloorName"].ToString();
            //    backhome = (String)GetGlobalResourceObject("BaseInfo", "Menu_BackHome");
            //    HidMenu.Value = baseInfo + ",Lease/AuditingLease/AuditingLeasePalaver.aspx?menustatus=1&FloorID=" + floorid + "&FloorName=" + floorname + "~" + leaseItem + ",Lease/AuditingLease/AuditingLeaseItemPalaver.aspx~" + shopInfo + " ,Lease/ShopBaseInfoPalaver.aspx~" + espression + ",Lease/ExpressionPalaver.aspx~" + backhome + ",Disktop.aspx?FloorID=" + floorid + "&FloorName=" + floorname;
            //}
            //else
            //{
                HidMenu.Value = baseInfo + ",Lease/AuditingAdAndGround/AuditingGroundContract.aspx~" + leaseItem + ",Lease/AuditingAdAndGround/AuditingGroundItemContract.aspx~" + shopInfo + " ,Lease/AuditingAdAndGround/GroundContractList.aspx~" + espression + ",Lease/AuditingAdAndGround/GroundContractExpression.aspx";
            //}
        }
    }
