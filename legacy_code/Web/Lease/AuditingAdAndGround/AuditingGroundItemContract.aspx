<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditingGroundItemContract.aspx.cs" Inherits="Lease_AuditingAdAndGround_AuditingGroundItemContract" %>
     ...
     <table border="0" cellpadding="0" cellspacing="0" style="height: 25px" width="100%">
            <tr>
                <td class="tdTopBackColor" style="width: 445px; height: 25px" valign="top">
                    ...
                    <asp:Label ID="Label49" runat="server" Text="<%$ Resources:BaseInfo,Tab_lblLeaseBalanceItem %>" Width="367px"></asp:Label></td>
            ...
            <table class="tblLease" style="width:100%; height:359px" border="0" cellpadding="0" cellspacing="0">
             ...
             <tr >
                 ...
                 <td class="tdBackColor" style="width: 182px; height: 24px;">
                     <asp:TextBox ID="txtBalanceMonth" runat="server" CssClass="ipt160px" BackColor="#F5F5F4" ReadOnly="True"></asp:TextBox></td>
