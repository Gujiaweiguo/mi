...
public partial class Lease_AuditingAdAndGround_AuditingAdContract : BasePage
{
    #region 定义
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
           ...
           存入cookies*/
            ...
            //else
            //{
                HidMenu.Value = baseInfo + ",Lease/AuditingAdAndGround/AuditingAdContract.aspx~" + leaseItem + ",Lease/AuditingAdAndGround/AuditingAdItemContract.aspx~" + shopInfo + " ,Lease/AuditingAdAndGround/AdContractList.aspx~" + espression + ",Lease/AuditingAdAndGround/AdContractExpression.aspx";
            //}
        }
    }
