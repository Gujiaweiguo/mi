<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConUnionAgain.aspx.cs" Inherits="Lease_ConUnionAgain" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../App_Themes/CSS/ToolStyle.css" rel="stylesheet" type="text/css" />
     <style type="text/css">
        ...
        div#chooseDiv { position: absolute; top: 394px; left: 26px; height: 55px;
        ...
        <--
            ...
            div#btn{ position: absolute; top: 395px; left: 466px; height: overflow: auto;}
        -->
       </style>
	...
	<!--
	    function chooseCard(id)
	    {
	        ...
	        if(id==1){	
		        ...
		        {
		            document.getElementById("txtStartDate").value = document.getElementById("txtChargeStart").value;
		        }
		        
		        //取合同结束日期
		        if((document.getElementById("txtConEndDate").value != "undefined")&&(document.getElementById("txtConEndDate").value != ""))
		        {
		            document.getElementById("txtEndDate").value = document.getElementById("txtConEndDate").value;
		        }
	        }
	        if(id==2){
		        document.getElementById("PotCustomerList").style.display ="none";
	      ...
	      function selectCust()
		{
		    var ss = document.getElementById("txtCustShortName").value;
			strreturnval=window.showModalDialog('../Lease/AdContract/Customer.aspx?shortName='+encodeURI(ss),'window','dialogWidth=310px;dialogHeight=160px');
			...
			if ((window.document.all("allvalue").value != "undefined") && (window.document.all("allvalue").value != ""))
					__doPostBack("ImaBtnOK","");//调用后台程序代码
				else
					return;	
		}
        ...
        {
             if(!isDigit(document.all.cmbTradeID.value))
            {
                alert('<%= emptyStr %>');
                document.all.cmbTradeID.focus();
                return false;
            }
            ...
            {
                alert('<%= emptyStr %>');
                document.all.txtConEndDate.focus();
                return false;
            }
            
             if(!isInteger(document.all.txtRefID.value))
            {
                alert('<%= IsInt %>');
                document.all.txtRefID.focus();
                return false;
            }
            ...
            {
                alert('<%= IsInt %>');
                document.all.DDownListBillCycle.focus();
                return false;
            }
        }	
        ...
        {
            if(!isInteger(document.all.cmbChargeTypeID.value))
            {
                alert('<%= emptyStr %>');
             ...
             if(isEmpty(document.all.txtMinSumSell.value))
            {
                alert('<%= emptyStr %>');
                document.all.txtMinSumSell.focus();
                return false;
            }
            
             if(isEmpty(document.all.txtBalanceDeduct.value))
            {
                alert('<%= emptyStr %>');
                document.all.txtBalanceDeduct.focus();
                return false;
            }
            
            if(!isDigit(document.all.txtMinSumSell.value))
            {
                alert('<%= IsFloat %>');
                document.all.txtMinSumSell.focus();
                return false;
             ...
             if(!isDigit(document.all.txtBalanceDeduct.value))
            {
                alert('<%= IsFloat %>');
                document.all.txtBalanceDeduct.focus();
                return false;
...
<body onload='chooseCard(0);' style="margin:0px">
    <form id="form1" runat="server">
        ...
        <table id="showmain" border="0" cellpadding="0" cellspacing="0" class="tableBoderStyle"
            style="height: 445px">
            <tr>
                <td style="width: 25px; height: 399px; text-align: center" valign="top">
                    <img height="401" src="../images/shuxian.jpg" />
                </td>
                <td colspan="5" style="vertical-align: top; width: 566px; height: 399px">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                         <div id="PotCustomerList">
        <table class="tblBase" border="0" cellpadding="0" cellspacing="0" style="height: 377px; width: 709px;">
            <tr>
                ...
                <td style="width: 635px; height: 25px; text-align: left;" class="tdTopRightBackColor">
                    <asp:Label ID="Label28" runat="server" Text="<%$ Resources:BaseInfo,Union_lblWrite %>" Width="265px"></asp:Label></td>
                <td style="height: 4px; text-align: right" class="tdTopRightBackColor" valign="top">
                    <img src="" class="imageRightBack" /></td>
                
            </tr>
            <tr>
            <td width="50%" class="tdBackColor" colspan="2"  valign="top" style="height: 29px">
             <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style=" width: 362px;">
                                ...
                                <asp:Button ID="imgCustCodeQ" runat="server" CssClass="buttonSmallHelp" OnClick="imgCustCodeQ_Click"
                                    Width="27px" /></td>
                        </tr>
                        <tr>
                            <td class="baseLable" style="text-align: right; width: 498px;">
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 362px;">
                                <asp:TextBox ID="txtCustShortName" runat="server" CssClass="ipt160px"></asp:TextBox>
                                <asp:Button ID="imgCustNameQ" runat="server" CssClass="buttonSmallHelp" OnClick="imgCustNameQ_Click"
                                    Width="29px" /></td>
                        </tr>
                        <tr class="nullLine">
                            <td colspan="2" style="width: 635px; height: 9px;">
                            </td>
                        </tr>
                        <tr class="nullLine">
            ...
            <td width="50%" class="tdBackColor" colspan="3" valign="top" style="height: 29px">
                        ...
                        <tr>
                            <td class="baseLable" style="text-align: right; width: 152px;">
                                <asp:Label ID="Label32" runat="server" Text="<%$ Resources:BaseInfo,Lease_lblNorentDays %>" CssClass="labelStyle"></asp:Label></td>
                            <td class="tdBackColor" style="width: 237px;">
                                <asp:TextBox ID="txtNorentDays" runat="server" CssClass="ipt160px" BackColor="#F5F5F4"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="baseLable" style="text-align: right; width: 152px;">
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" rowspan="3" style="width: 237px">
                        ...
                        <tr>
                            <td class="tdBackColor" style="text-align: right; width: 152px; height: 29px;">
                            </td>
                        </tr>
                        <tr>
                            <td class="baseLable" style="text-align: right; width: 152px; height: 29px;" >
                                ...
                                <tr class="bodyLine">
                                  ...
                                  <tr>
                                      <td class="baseLable" style="width: 152px; text-align: right">
                                          <asp:Label ID="Label35" runat="server" Text="<%$ Resources:BaseInfo,Lease_lblCommOper %>" CssClass="labelStyle"></asp:Label></td>
                                      <td class="tdBackColor" rowspan="1" style="width: 237px" valign="top">
                                          <asp:TextBox ID="txtCommOper" runat="server" CssClass="ipt160px" BackColor="#F5F5F4"></asp:TextBox></td>
                                  </tr>
                    </table>
            </td>
            </tr>
        ...
        <div id="PotCustomer" >
        <table border="0" cellpadding="0" cellspacing="0" style="width: 709px; height: 370px">
        <tr>
            <td style="width: 370px;height:350px" class="tdBackColor" valign="top">
                <table class="tblFormulaH" border="0" cellpadding="0" cellspacing="0" style="width: 350px" >
                    <tr>
                        <td class="tdTopBackColor" style="width: 310px;" colspan="3" height="29">
                            <img alt="" class="imageLeftBack" /><asp:Label ID="Label10" runat="server"
                                Text="<%$ Resources:BaseInfo,Formula_lblContent %>" Width="177px"></asp:Label></td>
                    ...
                    <td style="height: 1px; background-color: white" colspan="4" width="317"></td>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width:54px">
                                <asp:DropDownList ID="cmbChargeTypeID" runat="server" CssClass="textBoxStyle" Width="76px">
                                </asp:DropDownList></td>
                            <td class="tdBackColor" style="width: 68px; text-align: right">
                                <asp:Label ID="labFormulaType" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ConLease_labFormulaType %>"
                                    Width="70px"></asp:Label></td>
                            <td class="tdBackColor" style=" width: 90px; padding-right:15px">
                                <asp:DropDownList ID="cmbFormulaType" runat="server" CssClass="textBoxStyle" Width="76px">
                                </asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td class="tdBackColor" style=" text-align: right; width: 86px;" align="right">
                                <asp:Label ID="Label15" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotShop_lblShopStartDate %>"></asp:Label></td>
                            <td class="tdBackColor" style="width: 54px">
                                <asp:TextBox ID="txtStartDate" onclick="calendar()" runat="server" CssClass="textBoxStyle" Width="69px"></asp:TextBox></td>
                            <td class="tdBackColor" style=" width: 68px;text-align: right">
                                <asp:Label ID="labEndDate" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LblDate_EndDate %>"></asp:Label></td>
                            <td class="tdBackColor" style=" width: 77px; padding-right:15px">
                        ...
                        <tr class="gridView">
                            <td class="tdBackColor" colspan="8" style="text-align: center"
                                valign="top">
                                <asp:GridView ID="GVConFormulaH" runat="server" AutoGenerateColumns="False" Height="175px"
                                    Width="280px" OnRowDataBound="GVConFormulaH_RowDataBound" OnRowCommand="GVConFormulaH_RowCommand" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" BorderStyle="None">
                                    <Columns>
                        ...
                        <tr>
                            <td class="tdBackColor" style=" text-align: center; width: 86px;">
                                <asp:Button ID="IBtnSave" runat="server" CssClass="buttonCancel" Height="30px" OnClick="IBtnSave_Click"
                                    Text="<%$ Resources:BaseInfo,PotCustomer_butSave %>" Width="73px" /></td>
                            <td class="tdBackColor" style=" text-align: center; width: 54px;">
                                <asp:Button ID="IBtnAdd" runat="server" CssClass="buttonSave" Height="30px" OnClick="IBtnAdd_Click"
                                    Text="<%$ Resources:BaseInfo,PotCustomer_butAdd %>" Width="65px" /></td>
                            <td class="tdBackColor" style="text-align: center; width: 68px;">
                                <asp:Button ID="IBtnModify" runat="server" CssClass="buttonEdit" Height="29px" OnClick="IBtnModify_Click"
                                    Text="<%$ Resources:BaseInfo,Btn_Edit %>" Width="64px" /></td>
                            <td class="tdBackColor" style="text-align: center; width: 77px;">
                                <asp:Button ID="IBtnDel" runat="server" CssClass="buttonClear" Height="31px" OnClick="IBtnDel_Click"
                                    Text="<%$ Resources:BaseInfo,Btn_Del %>" Width="69px" /></td>
                        </tr>
                         <tr class="colLine">
                    <td class="tdBackColor" style="text-align: left; width: 115px; height: 10px;"
                        valign="top" colspan="4">
                       
                        <input id="Hidden_txtNorentDays" runat="server" style="width: 5px; height: 6px;" type="hidden" />
            ...
            <td>
                <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="width: 350px;height:370px" class="tdBackColor">
                     <tr>
                        <td class="tdTopBackColor" style="width: 310px; height: 28px;" colspan="3" valign="top">
                            <img alt="" class="imageLeftBack" /><asp:Label ID="Label12" runat="server"
                                Text="<%$ Resources:BaseInfo,Formula_lblContent %>" Width="66px"></asp:Label></td>
                        <td class="tdTopBackColor" valign="top" style="height: 28px">
                            <img  align="right" class="imageRightBack"/>
                        </td> 
                    </tr>
                    ...
                    <td style="height: 1px; background-color: white" colspan="4" width="317"></td>
                     ...
                     <tr height="10"><td ></td></tr>
                        <tr>
                            <td  colspan="2" style="width: 317px; padding-left:25px" valign="top">
                                            <fieldset style="border-right: #c0c0c0 1px solid; border-top: #c0c0c0 1px solid;
                                                ...
                                                <legend style="text-align:left">
                                                    <asp:Label ID="Label14" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Lease_KeepMinSet %>"></asp:Label>
                                                </legend>
                        ...
                        <tr>
                            <td class="tdBackColor" colspan="2" style="width: 299px; text-align: center; height:198px; padding-left:25px; padding-bottom:10px"  valign="top">
                                            <fieldset style="border-right: #c0c0c0 1px solid; border-top: #c0c0c0 1px solid;
                                                border-left: #c0c0c0 1px solid; border-bottom: #c0c0c0 1px solid; width:300px; height:180px;">
                                                <legend style="text-align: left">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" class="tdBackColor" style="width: 295px; height:151px;">
                                                    ...
                                                    <tr class="gridView">
                                                        <td class="tdBackColor" colspan="8" style="width: 295px; text-align: center">
                                                            <asp:GridView ID="GVDeductMoney" runat="server" AutoGenerateColumns="False" Height="132px"
                                                                Width="290px" BackColor="White" BorderColor="#E1E0B2" OnRowDataBound="GVDeductMoney_RowDataBound" BorderStyle="None">
                                                                <Columns>
                                                                    <asp:BoundField DataField="FormulaID">
                                                                        <ItemStyle CssClass="hidden" />
                                                                        <HeaderStyle CssClass="hidden" />
                                                                    ...
                                                                    <asp:BoundField DataField="SalesTo" HeaderText="<%$ Resources:BaseInfo,ConLease_labFormulaType %>">
                                                                        <HeaderStyle CssClass="gridviewtitle" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Pcent" HeaderText="<%$ Resources:BaseInfo,ConLease_labFormulaType %>">
                                                                        <HeaderStyle CssClass="gridviewtitle" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                </Columns>
                                                    ...
                                                    <tr>
                                                        <td class="tdBackColor" colspan="8" style="width: 295px; height: 10px">
                                                            <input id="Hidden3" runat="server" style="width: 3px; height: 1px" type="hidden" />
                                                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" Height="1px"></asp:LinkButton></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="tdBackColor" style="width: 75px; height: 22px">
                                                            <asp:Label ID="labSellCount" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ConLease_labSellCount %>"
                                                                Width="70px"></asp:Label></td>
                                                        <td class="tdBackColor" style="width: 5px; height: 22px">
                                                        </td>
                                                        <td class="tdBackColor" style="width: 50px; height: 22px">
                                                            <asp:TextBox ID="txtSellCount" runat="server" CssClass="textBoxStyle" Width="50px"></asp:TextBox></td>
                                                        <td class="tdBackColor" style="width: 5px; height: 22px">
                                                        </td>
                                                        <td class="tdBackColor" style="width: 75px; height: 22px">
                                                            <asp:Label ID="labDistill" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ConLease_labDistill %>"
                                                                Width="50px"></asp:Label>%</td>
                                                        <td class="tdBackColor" style="width: 5px; height: 22px">
                                                        </td>
                                                        <td class="tdBackColor" style="width: 40px; height: 22px">
                                                            <asp:TextBox ID="txtDistill" runat="server" CssClass="textBoxStyle" Width="40px"></asp:TextBox></td>
                                                        <td class="tdBackColor" style="width: 40px; height: 22px">
                                                        </td>
                                                    </tr>
                                                    <tr style="height:10px">
                                                        <td class="tdBackColor" colspan="8"></td>
                                                    </tr>
                                                    <tr style="height:3px">
                                                        <td class="tdBackColor" colspan="8" style="width: 295px; text-align:center;">
                                                    ...
                                                    <tr style="height:35px">
                                                        <td class="tdBackColor" colspan="4" style="width: 158px; height: 10px;" align="center">
                                                            <asp:Button ID="BtnDeductAdd" runat="server" CssClass="buttonSave" Height="32px"
                                                                OnClick="BtnDeductAdd_Click" Text="<%$ Resources:BaseInfo,Dept_TitleAdd %>" Width="67px" /></td>
                                                        <td class="tdBackColor" colspan="4" style="width: 158px; height: 10px;" align="left">
                                                            <asp:Button ID="BtnDeductDel" runat="server" CssClass="buttonClear" Height="32px"
                                                                OnClick="BtnDeductDel_Click" Text="<%$ Resources:BaseInfo,Btn_Del %>" Width="83px" /></td>
                                                   </tr>
                                                </table>
                                            </fieldset>
                            </td>
        ...
        <table class="tdBackColor" border="0" cellpadding="0" cellspacing="0" style="width: 709px;">
            <tr style="height:29">
                ...
                <td style="width: 635px; height: 29px; text-align: left;" class="tdTopRightBackColor">
                    <asp:Label ID="Label29" runat="server" Text="<%$ Resources:BaseInfo,Union_lblWrite %>" Width="341px"></asp:Label></td>
        ...
        <table class="tblUnionLease" border="0" cellpadding="0" cellspacing="0"  style="height: 345px; width: 709px;">
            <tr class="colLine">
                <td class="tdBackColor">
                </td>
                <td class="tdBackColor" valign="bottom" style="width: 516px">
                     <table border="0" cellpadding="0" cellspacing="0" width="165">
                        <tr class="bodyLine">
                            <td style="height: 1px; background-color: #738495;">
                            </td>
            ...
            <tr>
                ...
                <td class="tdBackColor" style="width: 516px; height: 25px">
                </td>
            </tr>
            <tr>
          ...
          <table class="baseShop" border="0" cellpadding="0" cellspacing="0" style="height: 25px" width="709">
            <tr>
                <td class="tdTopBackColor" style="width: 375px; height: 25px" valign="top">
                    <img alt="" class="imageLeftBack" />
                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:BaseInfo,Union_lblWrite %>" Width="288px"></asp:Label></td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width:710px; height:347px" >
            <tr >
                        ...
                        <td colspan="3" style="text-align: center">
                            <asp:GridView ID="gvShop" runat="server" AutoGenerateColumns="False" BackColor="White"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ShopType" HeaderText="类型">
                                        <ItemStyle BorderColor="#E1E0B2" />
                                        <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                    </asp:BoundField>
              ...
              <table class="tdBackColor">
                  ...
                  <tr>
                      ...
                      <td class="tdBackColor">
                       ...
                       <tr>
                           <td style=" text-align:right;" class="tdBackColor">
                               <asp:Label ID="Label30" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblLocationName %>"></asp:Label></td>
                           <td class="tdBackColor">
                       ...
                       <tr><td style="TEXT-ALIGN: right" class="tdBackColor"></td><td class="tdBackColor">
                               <asp:Button ID="IBtnUnitsDel" runat="server" CssClass="buttonClear" Height="31px"
                                   OnClick="IBtnUnitsDel_Click" Text="<%$ Resources:BaseInfo,Btn_Del %>" Width="69px" />
                       ...
                       <tr>
                           <td style=" text-align: right;" class="tdBackColor">
                               <asp:Label ID="Label33" runat="server" Text="<%$ Resources:BaseInfo,Lease_lblComm %>"></asp:Label></td>
                       </tr>
                       <tr>
                ...
                <tr style="height:45px" valign="top">
                    ...
                    <td class="tdBackColor" style="width: 40%; text-align: right; padding-right:20px;" valign="top">
                               <asp:Button ID="btnShopSave" runat="server" CssClass="buttonCancel" OnClick="btnShopSave_Click"
               ...
               <table style="width:270px; height:40px" border="0" cellpadding="0" cellspacing="0" >
                    <tr>
                        ...
                        <td style="width:725px; background-color: #e1e0b2;">
                            <asp:Button ID="btnDispos" runat="server" CssClass="buttonClear" OnClick="btnDispos_Click"
                                Text="<%$ Resources:BaseInfo,ConLease_butDel %>" />
                            <asp:Button ID="btnTempSave" runat="server" CssClass="buttonCancel"
                                Text="<%$ Resources:BaseInfo,Lease_NewLineBtnTemp %>" OnClick="btnTempSave_Click" Width="83px" />
                                <asp:Button ID="btnPutIn" runat="server" CssClass="buttonSave" Height="33px" Text="<%$ Resources:BaseInfo,Lease_NewLineBtnPutIn %>" OnClick="btnPutIn_Click" Width="82px" /></td>
                    ...
                    <input id="Hidden1" runat="server" type="hidden" /><asp:Button ID="ImaBtnOK" runat="server"
                        OnClick="ImaBtnOK_Click" Text="Button" Visible="False" Width="29px" /><input id="allvalue"
                            runat="server" style="width: 25px" type="hidden" /></td>
                <td style="width: 60px; height: 399px; text-align: center" valign="top">
                    </td>
            </tr>
        </table>
          <div id="chooseDiv">
            <table>
                <tr>
                    <td class="selectedtab" id="tab1" onclick="chooseCard(0);" style="height: 21px; width:100px;">
                        <span id="tabpage1"><asp:Label ID="Label36" runat="server" Text="<%$ Resources:BaseInfo,Tab_lblContractBase %>"></asp:Label></span></td>
                    <td class="tab" id="tab2" onclick="chooseCard(1);" style="height: 21px; width: 100px;">
                        <span id="Span1"><asp:Label ID="Label37" runat="server" Text="<%$ Resources:BaseInfo,Tab_lblFormul %>"></asp:Label></span></td>
                    <td class="tab" id="tab3" onclick="chooseCard(2);" style="height: 21px; width: 100px;">
                        <span id="Span2"><asp:Label ID="Label38" runat="server" Text="<%$ Resources:BaseInfo,Tab_lblUnionItem %>"></asp:Label></span></td>
                    <td class="tab" id="tab4" onclick="chooseCard(3);" style="height: 21px; width: 100px;">
                        <span id="Span3"><asp:Label ID="Label39" runat="server" Text="<%$ Resources:BaseInfo,Tab_lblShopBaseInfo %>"></asp:Label></span></td>
                </tr>
            </table>
        </div>
         <br />
