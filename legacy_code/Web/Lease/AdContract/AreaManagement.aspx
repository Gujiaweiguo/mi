<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaManagement.aspx.cs" Inherits="Lease_AdContract_AreaManagement" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Rpt_AreaManagement")%></title>
    ...
    <style type="text/css">
      ...
      <!--	    
	     function Load()
        {
            addTabTool("<%=strFresh %>,Lease/AdContract/AreaManagement.aspx");
            loadTitle();
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 27px; width: 100%;">
                            <tr>
                                ...
                                <td class="tdTopRightBackColor" style=" height: 27px; text-align:left;">
                                    <asp:Label
                                        ID="Label1" runat="server" Text='<%$ Resources:BaseInfo,Rpt_AreaManagement %>' Height="12pt" Width="218px"></asp:Label></td>
                                 ...
                                 <td colspan="3" class="tdBackColor">
                                     <table style="width: 100%" >
                                         ...
                                         <tr>
                                             ...
                                             <td class="baseLable">
                                                 <asp:Label ID="Label2" runat="server" Text="<%$ Resources:BaseInfo,Rpt_AreaTypeCode %>" CssClass="labelStyle"></asp:Label></td>
                                             <td>
                                                 <asp:TextBox ID="txtAdBordCode" runat="server" CssClass="ipt160px" MaxLength="32"></asp:TextBox></td>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label5" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_AreaName %>" Width="80px"></asp:Label></td>
                                         ...
                                         <tr>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LeaseAreaType_AreaType %>"></asp:Label></td>
                                             <td>
                                                 <asp:DropDownList ID="ddlAdType" runat="server" Width="163px">
                                                 </asp:DropDownList></td>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label4" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_Status %>"
                                             ...
                                             <td colspan="4" style="text-align: center">
                                                 <asp:GridView ID="gvAdBoard" runat="server" AutoGenerateColumns="False"  BorderStyle="Inset" BorderWidth="1px" CellPadding="3"
                                                     ...
                                                     <Columns>
                                                         ...
                                                         <asp:BoundField DataField="AreaName" HeaderText="<%$ Resources:BaseInfo,Rpt_AreaName %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="AreaTypeID" HeaderText="<%$ Resources:BaseInfo,LeaseAreaType_AreaType %>" >
                                                             <ItemStyle CssClass="hidden" />
                                                             <HeaderStyle CssClass="hidden" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="AreaTypeName" HeaderText="<%$ Resources:BaseInfo,LeaseAreaType_AreaType %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="AreaStatus" HeaderText="<%$ Resources:BaseInfo,Rpt_Status %>" >
                                                             <ItemStyle CssClass="hidden"/>
                                                             <HeaderStyle CssClass="hidden"/>
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="AreaStatusName" HeaderText="<%$ Resources:BaseInfo,Rpt_Status %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
