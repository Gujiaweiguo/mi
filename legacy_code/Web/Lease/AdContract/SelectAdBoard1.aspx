<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectAdBoard1.aspx.cs" Inherits="Lease_AdContract_SelectAdBoard1" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
	    ...
	    function Load()
	    {
	        addTabTool(document.getElementById("hidcon").value + ",Lease/AdContract/SelectAdBoard1.aspx");
	        loadTitle();
