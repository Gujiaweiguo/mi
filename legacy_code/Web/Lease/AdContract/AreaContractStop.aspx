<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaContractStop.aspx.cs" Inherits="Lease_AdContract_AreaContractStop" %>
...
<head id="Head1" runat="server">
    ...
    function Load()
    {
        addTabTool("<%=titleName%>,Lease/AdContract/AreaContractStop.aspx~<%=leaseItem %>,Lease/LeaseItemPalaver.aspx~<%=shopInfo %>,Lease/AdContract/AreaListPalaver.aspx~<%=espression %>,Lease/AdContract/AdBoardExpressionPalaver.aspx");
	    loadTitle();
    }
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" style="width: 100%">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" rowspan="1" style="height: 25px" valign="top">
                                                                    ...
                                                                    <asp:Button ID="btnMessage" runat="server" CssClass="buttonMessage" Enabled="False" Text="<%$ Resources:BaseInfo,WrkFlwEntity_btnMessage %>" /></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
