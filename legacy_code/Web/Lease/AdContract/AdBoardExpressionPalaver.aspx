<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdBoardExpressionPalaver.aspx.cs" Inherits="Lease_AdContract_AdBoardExpressionPalaver" %>
...
<body onload="Load()" style="margin:0px">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
            <!--********************left**********************-->
                <td class="tdBackColor" colspan="2" style="text-align:center;width:45%;" valign="top">
    ...
    <tr>
        ...
        <td align="left" style="width: 63px">
            <asp:TextBox ID="txtBeginDate"　 runat="server" Width="70px" CssClass="ipt160px" Height="18px" ReadOnly="True"></asp:TextBox></td>
        <td class="leftLable">
        ...
        <td align="left" style="width: 115px">
            <asp:TextBox ID="txtOverDate"  runat="server" CssClass="ipt160px" Width="70px" Height="18px" ReadOnly="True"></asp:TextBox></td>
    </tr>
    ...
    <tr class="gridView" style="padding-left:10px;">
        <td style="width:70%; text-align: center;" colspan="7" class="tdBackColor" valign="top">
            <asp:GridView ID="GVType" runat="server" AutoGenerateColumns="False" Height="150px"
                Width="90%" OnRowDataBound="GVType_RowDataBound" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" PageSize="8">
                <Columns>
        ...
        <td colspan="4" valign="middle" style="text-align: center">
            <table border="0" cellpadding="0" cellspacing="0" width="280">
                ...
                <tr class="bodyLine">
                    ...
                    <asp:Button ID="btnBackType" runat="server" CssClass="buttonBack"
                                                                OnClick="btnBackType_Click" Text="<%$ Resources:BaseInfo,Button_back %>" Visible="False" />
                    <asp:Button
                                                                    ID="btnNextType" runat="server" CssClass="buttonNext"
                                                                    OnClick="btnNextType_Click" Text="<%$ Resources:BaseInfo,Button_next %>" Visible="False" /></td>
                <!--*****************middle***********************
                -->
                                    ...
                                    <table class="tblFast" border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 90px">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tdBackColor" colspan="2" style="vertical-align: top; height: 28px">
                                                ...
                                                <asp:TextBox ID="txtFixedRental" runat="server" CssClass="ipt160px" Width="65px" style="ime-mode:disabled;" Height="18px" ReadOnly="True">0</asp:TextBox></td>
