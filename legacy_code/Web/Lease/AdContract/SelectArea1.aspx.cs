...
public partial class Lease_AdContract_SelectArea1 : BasePage
{
    ...
    {
        Response.Redirect("../AdContract/UpdateAreaContract1.aspx?VoucherID=" + GrdCust.SelectedRow.Cells[0].Text + "&modify=" + 1);
    }
