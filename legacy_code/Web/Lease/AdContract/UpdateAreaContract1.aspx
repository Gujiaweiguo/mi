<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateAreaContract1.aspx.cs" Inherits="Lease_AdContract_UpdateAreaContract1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
     <title><%= (String)GetGlobalResourceObject("BaseInfo", "LeaseAreaType_AreaAdd")%></title>
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AdContract/UpdateAreaContract1.aspx~<%=leaseItem %>,Lease/LeaseItem1.aspx~<%=shopInfo %>,Lease/AdContract/AreaList1.aspx~<%=espression %>,Lease/AdContract/AdBoardExpression1.aspx");
	        loadTitle();
	    }
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="height: 386px; width: 97%;">
        <tr>
            <td style="width: 430px; height: 24px; text-align: left;" class="tdTopRightBackColor" align="left">
                ...
                <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,LeaseAreaType_AreaAdd %>" Width="314px"></asp:Label></td>
