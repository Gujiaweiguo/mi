<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdBoardList.aspx.cs" Inherits="Lease_AdContract_AdBoardList" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
        ...
        {
            if(isEmpty(document.all.txtConAdBoardName.value))
            {
                alert('<%= enterInfo %>');
                document.all.txtConAdBoardName.focus();
                return false;
            }
        ...
        function ShowTree()
        {
    	    strreturnval=window.showModalDialog('SelectAdType.aspx','window','dialogWidth=237px;dialogHeight=420px');
		    window.document.all("allvalue").value = strreturnval;
		    if ((window.document.all("allvalue").value != "undefined") && (window.document.all("allvalue").value != ""))
		    {
		         var objImgBtn1 = document.getElementById('<%= LinkButton1.ClientID %>');
       ...
       <tr>
            ...
            <td class="tdBackColor" valign="top" style="width:30%; height: 349px;" align="right">
                 ...
                 <table class="tdBackColor">
                       ...
                       <tr>
                           ...
                           <td style="width: 329px; height: 30px;" class="tdBackColor" align="left">
                               <asp:TextBox ID="txtAdBoardCode" runat="server" CssClass="ipt160px" Width="129px"></asp:TextBox></td>
                           <td align="left" class="tdBackColor" style="width: 329px; height: 30px">
                             <asp:RadioButton ID="rbtDay" runat="server" Checked="True" GroupName="freq" Text="<%$ Resources:BaseInfo,Internet_optDaily %>" AutoPostBack="True" OnCheckedChanged="rbtDay_CheckedChanged" />
                             <asp:RadioButton ID="rbtWeek" runat="server" GroupName="freq" Text="<%$ Resources:BaseInfo,Internet_optWeekly %>" AutoPostBack="True" OnCheckedChanged="rbtWeek_CheckedChanged" />
                             <asp:RadioButton ID="rbtMonth" runat="server" GroupName="freq" Text="<%$ Resources:BaseInfo,Internet_optMthly %>" AutoPostBack="True" OnCheckedChanged="rbtMonth_CheckedChanged" /></td>
                       </tr>
                       <tr><td style="TEXT-ALIGN: right; width: 154px;" class="tdBackColor">
                           <asp:Label ID="lblAdBoardName" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,AdBoard_lblAdBoardName %>"></asp:Label></td><td style="WIDTH: 329px; HEIGHT: 21px" class="tdBackColor" align="left"><asp:TextBox id="txtConAdBoardName" runat="server" CssClass="ipt160px" Width="129px" MaxLength="64" ReadOnly="True"></asp:TextBox></td>
                           ...
                           <td>
                               ...
                               <asp:CheckBoxList ID="cblWeek" runat="server" Visible="False">
                               </asp:CheckBoxList>
                               <asp:DropDownList ID="ddlMonthFrom" runat="server" Visible="False">
                               </asp:DropDownList>
                               <asp:Label ID="Label2" runat="server" Text="—" Visible="False"></asp:Label>
                               <asp:DropDownList ID="ddlMonthTo" runat="server" Visible="False">
                               </asp:DropDownList>
                           </td>
                           </tr>
                           </table>
                       ...
                       <tr>
                           ...
                           <td style="WIDTH: 329px" class="tdBackColor" align="left">
                               <asp:TextBox ID="txtStartDate" onclick="calendar()" runat="server" CssClass="ipt160px" Width="129px"></asp:TextBox></td>
                       </tr>
                       <tr><td style="TEXT-ALIGN: right; width: 154px;" class="tdBackColor">
                       ...
                       <tr>
                           ...
                           <td class="tdBackColor" align="left" style="width: 329px">
                               <asp:TextBox ID="txtTime" runat="server" CssClass="ipt160px" Width="50px"></asp:TextBox></td>
                       </tr>
                     <tr>
                         ...
                         <td align="left" class="tdBackColor" style="width: 329px">
                             <asp:TextBox ID="txtArea" runat="server" CssClass="ipt160px" MaxLength="4" Width="50px"></asp:TextBox></td>
                     </tr>
                       <tr>
                ...
                <tr style="height:45px" valign="top">
                    ...
                    <asp:Button ID="btnShopAdd" runat="server" CssClass="buttonSave"
                                   OnClick="btnShopAdd_Click" Text="<%$ Resources:BaseInfo,Dept_TitleAdd %>" />
                        <asp:Button ID="btnShopDel" runat="server" CssClass="buttonClear"
                                   OnClick="btnShopDel_Click" Text="<%$ Resources:BaseInfo,Btn_Del %>" />
