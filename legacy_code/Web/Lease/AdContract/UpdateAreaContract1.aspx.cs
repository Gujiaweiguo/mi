...
public partial class Lease_AdContract_UpdateAreaContract1 : BasePage
{
    #region 定义
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            baseInfo = (String)GetGlobalResourceObject("BaseInfo", "Ad_lblMakeAdBoardContract");
            leaseItem = (String)GetGlobalResourceObject("BaseInfo", "Tab_lblLeaseItem");
            shopInfo = (String)GetGlobalResourceObject("BaseInfo", "Menu_DefineBillArea");
