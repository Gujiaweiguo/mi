<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaContractStopPalaver.aspx.cs" Inherits="Lease_AdContract_AreaContractStopPalaver" %>
...
<head id="Head1" runat="server">
    ...
    function Load()
    {
        addTabTool("<%=titleName%>,Lease/AdContract/AreaContractStopPalaver.aspx~<%=leaseItem %>,Lease/LeaseItemPalaver.aspx~<%=shopInfo %>,Lease/AdContract/AreaListPalaver.aspx~<%=espression %>,Lease/AdContract/AdBoardExpressionPalaver.aspx");
	    loadTitle();
    }
                                                            ...
                                                            <tr style="height: 5px">
                                                                ...
                                                                <td rowspan="1" valign="top" style="width: 206px">
                                                                    ...
                                                                    <asp:Button ID="btnMessage" runat="server" CssClass="buttonMessage"
                                                                        Text="<%$ Resources:BaseInfo,WrkFlwEntity_btnMessage %>" /></td>
                                                            </tr>
                                                            <tr>
