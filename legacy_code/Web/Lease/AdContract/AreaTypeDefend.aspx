<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaTypeDefend.aspx.cs" Inherits="Lease_AdContract_AreaTypeDefend" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "LeaseAreaType_AreaTypeDefend")%></title>
    ...
    <style type="text/css">
      ...
      <!--	    
	     function Load()
        {
            addTabTool("<%=baseInfo %>,Lease/AdContract/AreaTypeDefend.aspx");
            loadTitle();
        }
         //输入验证
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 27px; width: 100%;">
                            <tr>
                                ...
                                <td class="tdTopRightBackColor" style=" height: 27px; text-align:left;">
                                    <asp:Label
                                        ID="Label1" runat="server" Text='<%$ Resources:BaseInfo,LeaseAreaType_AreaTypeDefend %>' Height="12pt" Width="218px"></asp:Label></td>
                                             ...
                                             <td colspan="4" style="text-align: center">
                                                 <asp:GridView ID="gvAdBoard" runat="server" AutoGenerateColumns="False"  BorderStyle="Inset" BorderWidth="1px" CellPadding="3"
                                                     ...
                                                     <Columns>
                                                         ...
                                                         <asp:BoundField DataField="AreaTypeCode" HeaderText="<%$ Resources:BaseInfo,CustType_lblCustTypeCode %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="AreaTypeDesc" HeaderText="<%$ Resources:BaseInfo,CustType_lblCustTypeName %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
