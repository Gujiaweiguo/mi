<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdBoardExpression1.aspx.cs" Inherits="Lease_AdContract_AdBoardExpression1" %>
...
<body onload="Load()" style="margin:0px">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
            <!--********************left**********************-->
                <td class="tdBackColor" colspan="2" style="text-align:left;width:39%;" valign="top">
    ...
    <tr>
        ...
        <td align="left" style="height: 15px" colspan="3">
            <asp:DropDownList ID="cmbChargeTypeID" runat="server" CssClass="textBoxStyle" Width="200px" OnSelectedIndexChanged="cmbChargeTypeID_SelectedIndexChanged" AutoPostBack="True" Enabled="false">
            </asp:DropDownList></td> 
    </tr>
    <tr>
        ...
        <td align="left" colspan="3" style="height: 14px">
            <asp:DropDownList ID="cmbFormulaType" runat="server" CssClass="textBoxStyle" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="cmbFormulaType_SelectedIndexChanged" Enabled="false">
            </asp:DropDownList></td>
    </tr>
    <tr>
        <td class="leftLable">
        ...
        <td align="left" style="width: 63px">
            <asp:TextBox ID="txtBeginDate"　onclick="calendar()" runat="server" Width="70px" CssClass="ipt160px" Height="18px" Enabled="false"></asp:TextBox></td>
        <td class="leftLable">
        ...
        <td align="left" style="width: 115px">
            <asp:TextBox ID="txtOverDate" onclick="calendar()" runat="server" CssClass="ipt160px" Width="70px" Height="18px" Enabled="false"></asp:TextBox></td>
    </tr>
    ...
    <tr class="gridView" style="padding-left:10px;">
        <td style="width:296px; text-align: center;" colspan="7" class="tdBackColor" valign="top">
            <asp:GridView ID="GVType" runat="server" AutoGenerateColumns="False" Height="150px"
                Width="286px" OnRowDataBound="GVType_RowDataBound" BackColor="White" BorderColor="#E1E0B2" BorderWidth="1px" PageSize="8" Enabled="false">
                <Columns>
        ...
        <td colspan="4" valign="middle" style="text-align: center">
            <table border="0" cellpadding="0" cellspacing="0" width="280">
                ...
                <tr class="bodyLine">
                    ...
                    &nbsp;
                    <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="True" Visible="False" Width="12px" Height="1px" Enabled="false"></asp:TextBox>
                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" Height="1px" Width="1px" Enabled="false"></asp:LinkButton>
                    <asp:Button ID="btnBackType" runat="server" CssClass="buttonBack" Height="31px"
                                                                OnClick="btnBackType_Click" Text="<%$ Resources:BaseInfo,Button_back %>" Width="71px" /><asp:Button
                                                                    ...
                                                                    OnClick="btnNextType_Click" Text="<%$ Resources:BaseInfo,Button_next %>" Width="73px" Enabled="false" /></td>
                <!--*****************middle***********************
                -->
                <td style="3%; height: 370px; padding-left:6px; width: 14px;"></td> 
                <!--************************right********************-->
                <td style="text-align: center; width:59%; height: 370px;" valign="top">
                                    ...
                                    <table class="tblFast" border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 90px">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tdBackColor" colspan="2" style="vertical-align: top; height: 28px">
                                                ...
                                                <asp:TextBox ID="txtFixedRental" runat="server" CssClass="ipt160px" Width="65px" style="ime-mode:disabled;" Height="18px" Enabled="false">0</asp:TextBox></td>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style=" padding-left:5px;">
                                                    <tr height="30">
                                                        <td class="tdBackColor" colspan="4" align="left" rowspan="2" valign="top">
                                                            &nbsp;&nbsp;
                                <fieldset style="border-right: #c0c0c0 1px solid; border-top: #c0c0c0 1px solid;
                                    border-left: #c0c0c0 1px solid; border-bottom: #c0c0c0 1px solid; width: 326px; vertical-align: middle; height: 58px;">
                                    &nbsp;
            <%--<asp:Button ID="IBtnAdd" runat="server" CssClass="buttonSave" OnClick="IBtnAdd_Click"
                Text="<%$ Resources:BaseInfo,PotCustomer_butAdd %>" Height="30px" Width="69px"  />
            <asp:Button ID="IBtnSave" runat="server" CssClass="buttonCancel" OnClick="IBtnSave_Click"
                Text="<%$ Resources:BaseInfo,PotCustomer_butSave %>" Height="30px" Width="73px" Enabled="False" />&nbsp;
            <asp:Button ID="IBtnDel" runat="server" CssClass="buttonClear" OnClick="IBtnDel_Click"
                Text="<%$ Resources:BaseInfo,Btn_Del %>" Height="31px" Width="74px" />--%>
                                    <asp:Button ID="IBtnModify" runat="server" CssClass="buttonEdit" Height="29px" OnClick="IBtnModify_Click"
                                        Text="<%$ Resources:BaseInfo,Btn_Edit %>" Visible="False" Width="67px" Enabled="false" /></fieldset>
                                                            &nbsp;&nbsp;
                                                        </td>
                                                    </tr>                                                    
