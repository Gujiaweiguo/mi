<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdBoardExpression.aspx.cs" Inherits="Lease_AdContract_AdBoardExpression" %>
            ...
            <asp:Button ID="IBtnDel" runat="server" CssClass="buttonClear" OnClick="IBtnDel_Click"
                Text="<%$ Resources:BaseInfo,Btn_Del %>" />
                                    <asp:Button ID="IBtnModify" runat="server" CssClass="buttonEdit" OnClick="IBtnModify_Click"
                                        Text="<%$ Resources:BaseInfo,Btn_Edit %>" Visible="False" /></fieldset>
                                                            &nbsp;&nbsp;
                                                        </td>
                                                    </tr>                                                    
