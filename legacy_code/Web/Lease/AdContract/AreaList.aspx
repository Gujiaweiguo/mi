<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaList.aspx.cs" Inherits="Lease_AdContract_AreaList" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
        ...
        {
            if(isEmpty(document.all.txtConAreaName.value))
            {
                alert('<%= enterInfo %>');
                document.all.txtConAreaName.focus();
                return false;
            }
       ...
       <tr>
            ...
            <td class="tdBackColor" valign="top" style="width:30%; height: 349px;" align="right">
                 ...
                 <table class="tdBackColor" style="width: 238px" >
                       ...
                       <tr>
                           ...
                           <td style="width: 329px; height: 30px;" class="tdBackColor">
                               <asp:DropDownList ID="ddlAreaCode" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlAreaCode_SelectedIndexChanged"
                                   Width="133px">
                               </asp:DropDownList></td>
                       </tr>
                       ...
                       <tr>
                           ...
                           <td class="tdBackColor" rowspan="2">
                               &nbsp; &nbsp;&nbsp;
                               <asp:TextBox ID="txtNote" runat="server" CssClass="ipt150px" Height="97px"></asp:TextBox></td>
                       </tr>
                       <tr>
                           <td style="text-align: right; width: 2239px;" class="tdBackColor">
                               </td>
                ...
                <tr style="height:45px" valign="top">
                    ...
                    <td class="tdBackColor" style="width: 40%; text-align: center; padding-right:20px; height: 44px;" valign="top"><asp:Button ID="btnShopAdd" runat="server" CssClass="buttonSave"
