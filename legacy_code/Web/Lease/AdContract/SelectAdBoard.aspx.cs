...
public partial class Lease_AdContract_SelectAdBoard : BasePage
{
    ...
    {
       Response.Redirect("../AdContract/UpdateAdContract.aspx?VoucherID=" + GrdCust.SelectedRow.Cells[0].Text + "&modify=" + 1);
    }
