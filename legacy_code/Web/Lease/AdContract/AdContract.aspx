<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdContract.aspx.cs" Inherits="Lease_Default" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
     <title><%= (String)GetGlobalResourceObject("BaseInfo", "Ad_lblMakeAdBoardContract")%></title>
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AdContract/AdContract.aspx~<%=leaseItem %>,Lease/LeaseItem.aspx~<%=shopInfo %>,Lease/AdContract/AdBoardList.aspx~<%=espression %>,Lease/AdContract/AdBoardExpression.aspx");
	        loadTitle();
	    }
        ...
        function InputValidator(sForm)
        {
            ...
            if(isEmpty(document.all.txtRefID.value))
            {
                parent.document.all.txtWroMessage.value=('<%= refID %>');
                return false;
            }
            
            if(isEmpty(document.all.txtNorentDays.value))
            {
                parent.document.all.txtWroMessage.value=('<%= norentDays %>');
                return false;
            }
        }
...
<body style="margin:0px" onload="Load()">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ContentTemplate>
         <div id="BaseBargain">
    <table border="0" cellpadding="0" cellspacing="0" style="height: 386px; width: 99%;">
        <tr>
        ...
        <tr>
            <td class="tdBackColor" colspan="3" style="width: 99%; height: 339px;"
                    valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%" id="TABLE1">
                    <tr>
                        <td style="width:99%; height:15px;" colspan="4" class="tdBackColor">
                        </td>
                    </tr>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtCustName" runat="server" CssClass="ipt160px" MaxLength="64"></asp:TextBox>
            <img id="ImgtxtCustName" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" />
            </td>
    </tr>
    <tr>
        <td class="baseLable">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="cmbContractStatus" runat="server" CssClass="ipt160px" ReadOnly="True"></asp:TextBox>
                <img id="ImgcmbContractStatus" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" />
                </td>
        </tr>
        <tr>
            ...
            <asp:TextBox ID="txtContractCode" runat="server" CssClass="ipt160px" MaxLength="32"></asp:TextBox>
            <img id="ImgtxtContractCode" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" />
            </td>
        </tr>
        <tr>
            <td class="baseLable">
            ...
            <td>
            <asp:TextBox ID="txtRefID" runat="server" CssClass="ipt160px" MaxLength="16"></asp:TextBox>
            <img id="ImgtxtRefID" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" />
            </td>
        </tr>
    <tr>
        <td class="baseLable">
        ...
        <td>
            <asp:TextBox ID="txtConStartDate" onclick="calendarExt(GetNorentDays)" runat="server" CssClass="ipt160px"></asp:TextBox>
        <img id="ImgtxtConStartDate" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" />
        </td>
    </tr>
        <tr>
            <td class="baseLable">
            ...
            <td>
                <asp:TextBox ID="txtConEndDate" onclick="calendar()" runat="server" CssClass="ipt160px"></asp:TextBox>
                <img id="ImgtxtConEndDate" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" />
                </td>
        </tr>
                    <tr>
                        <td class="baseLable">
    ...
    <tr>
        <td class="baseLable" style="width: 81px">
        ...
        <td>
            <asp:TextBox ID="txtChargeStart" onclick="calendarExt(GetNorentDays)" runat="server" CssClass="ipt160px"></asp:TextBox>
        <img id="ImgtxtChargeStart" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" />
        </td>
    </tr>
    <tr>
        <td class="baseLable" style="width: 81px">
        ...
        <td class="baseInput">
                            <asp:TextBox ID="txtNorentDays" runat="server" BackColor="#F5F5F4" CssClass="ipt160px"></asp:TextBox>
        <img id="ImgtxtNorentDays" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" />
        </td>
    </tr>
                    <tr>
                        <td class="baseLable" style="width: 81px">
            <asp:Label ID="Label32" runat="server" Text="<%$ Resources:BaseInfo,LeaseholdContract_labEConURL %>" CssClass="labelStyle" Visible="False"></asp:Label></td>
                        <td class="baseInput">
            <asp:TextBox ID="txtBargain" runat="server" CssClass="ipt160px" MaxLength="128" Visible="False"></asp:TextBox></td>
                    </tr>
    <tr style="height:20px">
    ...
    <tr style="height:20px">
        ...
        <tr style="height:5px" >
            <td style="height: 5px; width: 81px;">
            </td>
        ...
        <tr style="height:15px">
            <td colspan="2"></td>
                    ...
                    <tr>
                        <td align="center" colspan="2" rowspan="1" valign="top" style="height: 28px;">
                            &nbsp;
  ...
  <asp:HiddenField ID="HidenVouchID" runat="server"></asp:HiddenField>
  <asp:HiddenField ID="HidenWrkID" runat="server"></asp:HiddenField>
