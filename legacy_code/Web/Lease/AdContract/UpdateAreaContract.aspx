<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateAreaContract.aspx.cs" Inherits="Lease_AdContract_UpdateAreaContract" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AdContract/UpdateAreaContract.aspx~<%=leaseItem %>,Lease/LeaseItem.aspx~<%=shopInfo %>,Lease/AdContract/AreaList.aspx~<%=espression %>,Lease/AdContract/AdBoardExpression.aspx");
	        loadTitle();
	    }
