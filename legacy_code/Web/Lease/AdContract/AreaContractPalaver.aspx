<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaContractPalaver.aspx.cs" Inherits="Lease_AdContract_AreaContractPalaver" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AdContract/AreaContractPalaver.aspx~<%=leaseItem %>,Lease/LeaseItemPalaver.aspx~<%=shopInfo %>,Lease/AdContract/AreaListPalaver.aspx~<%=espression %>,Lease/AdContract/AdBoardExpressionPalaver.aspx");
	        loadTitle();
	    }
