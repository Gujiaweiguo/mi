<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaListPalaver.aspx.cs" Inherits="Lease_AdContract_AreaListPalaver" %>
       ...
       <tr>
            ...
            <td class="tdBackColor" valign="top" style="width:30%; height: 349px;" align="right">
                 ...
                 <table class="tdBackColor" style="width: 238px" >
                       ...
                       <tr>
                           ...
                           <td style="width: 329px; height: 30px;" class="tdBackColor">
                               <asp:TextBox ID="txtConAreaCode" runat="server" CssClass="ipt160px" Width="128px" MaxLength="16" ReadOnly="True"></asp:TextBox></td>
                       </tr>
                ...
                <tr style="height:45px" valign="top">
                    ...
                    <td class="tdBackColor" style="width: 40%; text-align: right; padding-right:20px; height: 44px;" valign="top">
                        &nbsp;&nbsp;
                    </td>
                </tr>
            </table>
