<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectAreaType.aspx.cs" Inherits="Lease_AdContract_SelectAreaType" %>
...
//        txtObjId.value = value;
        ...
        if(tradeLevel.length > 9)
        {
            var len = tradeLevel.length-3;
            window.returnValue=tradeLevel.slice(len);
            window.close();
            return true;
        }
    } 
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="height: 32px; width: 230px;">
            <tr>
                ...
                <td class="tdTopRightBackColor" style="height: 27px; text-align: left">
                    <asp:Label ID="Label1" runat="server" Height="12pt" Text="<%$ Resources:BaseInfo,Rpt_Area %>"></asp:Label><asp:Label ID="Label2" runat="server" Height="12pt" Text="<%$ Resources:BaseInfo,Rpt_List %>"></asp:Label></td>
