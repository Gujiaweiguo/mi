...
public partial class Lease_Default : BasePage
{
    #region 定义
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["Type"] == "New")
            {
                ...
                cookies.Values.Add("conStatus",Server.UrlEncode(cmbContractStatus.Text));
    ...
    protected void BindPenalty()
    {
        ...
        //}
        string str_sql = "select userID,userName from users where userstatus=1";
        baseBO.WhereClause = "";
        DataSet usersDS = baseBO.QueryDataSet(str_sql);
        int count = usersDS.Tables[0].Rows.Count;
        for (int i = 0; i < count; i++)
