<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExamineAdContract.aspx.cs" Inherits="Lease_AdContract_ExamineAdContract" %>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="height: 330px" width="255">
                                                        ...
                                                        <tr>
                                                            <td class="tdBackColor" style="width: 85px; height: 22px; text-align: right">
                                                                <asp:Label ID="lblCustCode" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_lblCustCode %>" Width="92px"></asp:Label></td>
                                                        ...
                                                        <tr>
                                                            <td class="tdBackColor" style="width: 85px; height: 22px; text-align: right">
                                                                <asp:Label ID="lblCustName" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_lblCustName %>" Width="93px"></asp:Label></td>
                                                            <td class="tdBackColor" style="width: 6px; height: 22px">
                                                            </td>
                                                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                                        ...
                                                        <tr>
                                                            <td class="tdBackColor" style="width: 85px; height: 22px; text-align: right">
                                                                &nbsp;<asp:Label ID="lblCustShortName" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_lblCustShortName %>" Width="97px"></asp:Label></td>
                                                            <td class="tdBackColor" style="width: 6px; height: 22px">
                                                            </td>
                                                            <td class="tdBackColor" style="width: 160px; height: 22px">
