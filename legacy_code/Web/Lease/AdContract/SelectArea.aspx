<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectArea.aspx.cs" Inherits="Lease_AdContract_SelectArea" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
	    ...
	    function Load()
	    {
	        addTabTool(document.getElementById("hidcon").value + ",Lease/AdContract/SelectArea.aspx");
	        loadTitle();
