<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaContract.aspx.cs" Inherits="Lease_AdContract_AreaContract" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AdContract/AreaContract.aspx~<%=leaseItem %>,Lease/LeaseItem.aspx~<%=shopInfo %>,Lease/AdContract/AreaList.aspx~<%=espression %>,Lease/AdContract/AdBoardExpression.aspx");
	        loadTitle();
	    }
...
<body style="margin:0px" onload="Load()">
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="height: 386px; width: 100%;">
        ...
        <tr>
            <td class="tdBackColor" colspan="3" style="height: 339px;"
                    valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%" id="TABLE1">
                    <tr>
                        <td style="height:15px;" colspan="4" class="tdBackColor">
                        </td>
                    </tr>
                    ...
                    <!--  *********left
                    -->
                    <td width="50%" valign="top" style="height: 50%">
    ...
    <tr>
        ...
        <tr>
            ...
            <asp:DropDownList ID="DDownListTerm" runat="server" Width="165px">
                    ...
                    <!--  *********right
                    -->
                    <td width="50%" style="height: 50%">
                    
                <table class="tblBase" width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr style="height:5px">
                        <td style="width:15%;">
                        </td>
                        <td class="baseInput" style="width: 35%">
    ...
    <tr style="height:20px">
        ...
        <tr style="height:15px">
            <td colspan="2"></td>
                    ...
                    <!--  *********
                    -->   
  <input id="Hidden_txtNorentDays" runat="server" type="hidden"/><asp:HiddenField ID="HidenWrkID" runat="server"></asp:HiddenField>
