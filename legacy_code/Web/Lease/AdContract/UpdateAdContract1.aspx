<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateAdContract1.aspx.cs" Inherits="Lease_AdContract_UpdateAdContract1" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/AdContract/UpdateAdContract1.aspx~<%=leaseItem %>,Lease/LeaseItem1.aspx~<%=shopInfo %>,Lease/AdContract/AdBoardList1.aspx~<%=espression %>,Lease/AdContract/AdBoardExpression1.aspx");
	        loadTitle();
	    }
...
<body style="margin:0px" onload="Load()">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ContentTemplate>
         <div id="BaseBargain">
    <table border="0" cellpadding="0" cellspacing="0" style="height: 386px; width: 97%;">
        <tr>
            <td style="width: 430px; height: 24px; text-align: left;" class="tdTopRightBackColor" align="left">
                ...
                <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,Ad_lblMakeAdBoardContract %>" Width="314px"></asp:Label></td>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtCustCode" runat="server" CssClass="ipt160px" MaxLength="16" ReadOnly="True" Enabled="false" ></asp:TextBox>
            </td>
    </tr>
    <tr>
        <td class="baseLable">
        ...
        <td>
            <asp:TextBox ID="txtCustName" runat="server" CssClass="ipt160px" MaxLength="64" ReadOnly="True" Enabled="false" ></asp:TextBox></td>
    </tr>
    <tr>
        <td class="baseLable">
            <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_lblCustShortName %>"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtCustShortName" runat="server" CssClass="ipt160px" MaxLength="32" ReadOnly="True" Enabled="false" ></asp:TextBox>
            </td>
    </tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="cmbContractStatus" runat="server" CssClass="ipt160px" ReadOnly="True" Enabled="false" ></asp:TextBox></td>
        </tr>
        <tr>
            ...
            <asp:TextBox ID="txtContractCode" runat="server" CssClass="ipt160px" MaxLength="32" Enabled="false" ></asp:TextBox></td>
        </tr>
        <tr>
            <td class="baseLable">
            <asp:Label ID="Label7" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LeaseholdContract_labRefID %>"></asp:Label></td>
            <td>
            <asp:TextBox ID="txtRefID" runat="server" CssClass="ipt160px" MaxLength="16" Enabled="false" ></asp:TextBox></td>
        </tr>
    <tr>
        <td class="baseLable">
        ...
        <td>
            <asp:TextBox ID="txtConStartDate" onclick="calendarExt(GetNorentDays)" runat="server" CssClass="ipt160px" Enabled="false" ></asp:TextBox></td>
    </tr>
        <tr>
            <td class="baseLable">
            ...
            <td>
                <asp:TextBox ID="txtConEndDate" onclick="calendar()" runat="server" CssClass="ipt160px" Enabled="false" ></asp:TextBox></td>
        </tr>
                    <tr>
                        <td class="baseLable">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtChargeStart" onclick="calendarExt(GetNorentDays)" runat="server" CssClass="ipt160px" Enabled="false" ></asp:TextBox></td>
    </tr>
    <tr>
        <td class="baseLable">
                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:BaseInfo,Lease_lblNorentDays %>" CssClass="labelStyle"></asp:Label></td>
        <td class="baseInput">
                            <asp:TextBox ID="txtNorentDays" runat="server" BackColor="#F5F5F4" CssClass="ipt160px" Enabled="false" ></asp:TextBox></td>
    </tr>
                    <tr>
                        <td class="baseLable">
            <asp:Label ID="Label32" runat="server" Text="<%$ Resources:BaseInfo,LeaseholdContract_labEConURL %>" CssClass="labelStyle"></asp:Label></td>
                        <td class="baseInput">
            <asp:TextBox ID="txtBargain" runat="server" CssClass="ipt160px" MaxLength="128" Enabled="false" ></asp:TextBox></td>
                    </tr>
    <tr style="height:20px">
            <td colspan=2></td>
        </tr>
    ...
    <tr>
        ...
        <td valign="top">
            <asp:TextBox ID="listBoxAddItem" runat="server" Height="72px" CssClass="ipt160px" TextMode="MultiLine" Enabled="false" ></asp:TextBox></td>
    </tr>
    <tr style="height:20px">
        ...
        <td rowspan="2" valign="top">
            <asp:TextBox ID="listBoxRemark" runat="server" Height="58px" CssClass="ipt160px" TextMode="MultiLine" Enabled="false" ></asp:TextBox></td>
                    </tr>
        <tr>
                    ...
                    <tr style="height:5px">
                        <td>
                            <asp:Button ID="btnBindDealType" runat="server" CssClass="hidden" Height="1px" Text="Button"
                                Width="1px" OnClick="btnBindDealType_Click" Enabled="false"  />
                            <asp:TextBox ID="hidTradeID" runat="server" CssClass="hidden" Width="1px" Enabled="false" ></asp:TextBox></td>
