...
public partial class Lease_AdContract_SelectAdBoard1 : BasePage
{
    ...
    {
        string sql = "ContractStatus =" + Contract.CONTRACTSTATUS_TYPE_INGEAR +"And BizMode = " + Contract.BIZ_MODE_AdBoard;
    ...
    {
       Response.Redirect("../AdContract/UpdateAdContract1.aspx?VoucherID=" + GrdCust.SelectedRow.Cells[0].Text + "&modify=" + 1);
    }
