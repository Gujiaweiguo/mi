<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConUnionItem.aspx.cs" Inherits="Lease_LeaseConUnion_ConUnionItem" %>
            ...
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" class="tdBackColor" style="width:100%;">
                    <tr style="height: 29px">
                        ...
                        <td class="tdTopRightBackColor" style="width: 635px; height: 29px; text-align: left">
                            <asp:Label ID="Label29" runat="server" Text="<%$ Resources:BaseInfo,Tab_lblLeaseBalanceItem %>"
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="tblLease" style="width: 100%;
                    ...
                    <tr>
                        ...
                        <td class="tdBackColor" style="width: 229px; height: 23px">
                            <asp:TextBox ID="txtMonthSettleDays" runat="server" CssClass="ipt160px" Style="ime-mode: disabled"></asp:TextBox><asp:Label
                                ID="Label3" runat="server" Text="<%$ Resources:BaseInfo,Prompt_NatureMonth %>"></asp:Label></td>
                        <td class="tdBackColor" style="width: 107px; text-align: right">
                        </td>
                        <td class="tdBackColor" style="width: 262px">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="tdBackColor" style="width: 262px">
                            <asp:Button ID="btnTempSave" runat="server" CssClass="buttonCancel" Height="31px"
                                OnClick="btnTempSave_Click" Text="<%$ Resources:BaseInfo,PotCustomer_butSave %>" /></td>
                    </tr>
                    <tr>
                        <td align="right" class="tdBackColor" style="padding-right: 5px; width: 163px">
                    ...
                    <tr>
                        <td align="right" class="tdBackColor" style="padding-right: 5px; width: 163px; height: 28px">
                        ...
                        <td class="tdBackColor" style="width: 262px; height: 28px">
                        </td>
                    </tr>
                    <tr>
