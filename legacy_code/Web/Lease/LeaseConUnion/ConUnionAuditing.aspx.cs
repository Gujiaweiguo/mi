...
public partial class Lease_LeaseConUnion_ConUnionAuditing : BasePage
{
#region 定义
    ...
    //    txtTradeID.Items.Add(new ListItem(selected));
    ...
    protected void btnTempSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //int i = basetrans.ExecuteUpdate("Update Contract Set ContractStatus=" + Contract.CONTRACTSTATUS_TYPE_INGEAR + " Where ContractID=" + voucherID);
            //if (i != 1)
            //{
