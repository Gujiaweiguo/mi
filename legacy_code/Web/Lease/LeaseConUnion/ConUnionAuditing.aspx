<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConUnionAuditing.aspx.cs" Inherits="Lease_LeaseConUnion_ConUnionAuditing" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool('<%= (String)GetGlobalResourceObject("BaseInfo", "Lease_lblBasicContractInfo")%>'+",Lease/LeaseConUnion/ConUnionAuditing.aspx~"+'<%= (String)GetGlobalResourceObject("BaseInfo", "Tab_lblLeaseBalanceItem")%>'+",Lease/LeaseConUnion/ConUnionItemAuditing.aspx~"+'<%= (String)GetGlobalResourceObject("BaseInfo", "Tab_lblShopInfo")%>'+",Lease/ShopBaseInfoPalaver.aspx~<%=espression %>,Lease/ExpressionPalaver.aspx");
	        loadTitle();
	    }
...
<body onload="Load()" style="margin:0px" >
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height:450px;">
        <tr>
            ...
            <td style="" class="tdTopRightBackColor" align="left"></td>
            <td  class="tdTopRightBackColor" valign="top" align="right">
        ...
        <td style="height:18px;">
            <asp:DropDownList ID="ddlSubs" runat="server" BackColor="#F5F5F4" Width="165px">
                    ...
                    <tr>
                        ...
                        <td style="height:18px;">
                            <asp:TextBox ID="txtTradeID" runat="server" BackColor="#F5F5F4" 
                                Enabled="False" CssClass="ipt160px"></asp:TextBox>
                        </td>
                    </tr>
        <tr>
            <td class="baseLable" style="width: 202px">
                    ...
                    <tr>
                        ...
                        <td rowspan="1" valign="top">
                            &nbsp;<asp:Button
                                    ...
                                    Text="<%$ Resources:BaseInfo,CustPalaver_butConsent %>" /><asp:Button
