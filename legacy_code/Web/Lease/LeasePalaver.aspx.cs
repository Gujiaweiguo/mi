...
public partial class Lease_LeasePalaver : BasePage
{
    #region 定义
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!this.IsPostBack)
        {
           ...
           存入cookies*/
            ...
            baseInfo = (String)GetGlobalResourceObject("BaseInfo", "Lease_lblBasicContractInfo");//合同基本信息
            leaseItem = (String)GetGlobalResourceObject("BaseInfo", "Tab_lblLeaseBalanceItem");//结算条款
            shopInfo = (String)GetGlobalResourceObject("BaseInfo", "Tab_lblShopInfo");//商铺信息
    ...
    protected void GetContractInfo(int contractID)
    {
        ...
        if (contractDs.Tables[0].Rows.Count > 0)
        {
            ...
            if (contractDs.Tables[0].Rows[0]["TradeID"].ToString() != "")
                cmbTradeID.SelectedValue = contractDs.Tables[0].Rows[0]["TradeID"].ToString();
            else
                cmbTradeID.SelectedValue ="";
            //cmbTradeID.SelectedValue = (contractDs.Tables[0].Rows[0]["TradeID"].ToString() == null ? "0" : contractDs.Tables[0].Rows[0]["TradeID"].ToString());
            ...
            this.ddlContractType.SelectedValue = ((contractDs.Tables[0].Rows[0]["ContractTypeID"].ToString() == null||contractDs.Tables[0].Rows[0]["ContractTypeID"].ToString() == "") ? "" : contractDs.Tables[0].Rows[0]["ContractTypeID"].ToString());
            this.ddlSubs.SelectedValue = ((contractDs.Tables[0].Rows[0]["SubsID"].ToString() == null||contractDs.Tables[0].Rows[0]["SubsID"].ToString() == "") ? "" : contractDs.Tables[0].Rows[0]["SubsID"].ToString());
            //add end
            ...
            listBoxExclusive.Text = (contractDs.Tables[0].Rows[0]["Exclusive"].ToString() == null ? "" : contractDs.Tables[0].Rows[0]["Exclusive"].ToString());
