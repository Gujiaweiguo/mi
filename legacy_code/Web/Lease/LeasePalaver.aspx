<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeasePalaver.aspx.cs" Inherits="Lease_LeasePalaver" ResponseEncoding="gb2312"%>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/LeasePalaver.aspx~<%=leaseItem %>,Lease/LeaseItemPalaver.aspx~<%=shopInfo %>,Lease/ShopBaseInfoPalaver.aspx~<%=espression %>,Lease/ExpressionPalaver.aspx");
	        loadTitle();
	    }
...
<body onload="Load()" style="margin:0px" >
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td style="height: 18px">
                            <asp:DropDownList ID="ddlSubs" runat="server" BackColor="#F5F5F4" Enabled="False"
                                Width="165px">
                            </asp:DropDownList></td>
                    </tr>
    <tr>
        ...
        <tr>
            ...
            <asp:TextBox ID="txtRefID" runat="server" CssClass="ipt160px" BackColor="#F5F5F4" ReadOnly="True"></asp:TextBox></td>
                    ...
                    <tr>
                        <td class="baseLable" style="width: 202px; height: 28px">
                            <asp:Label ID="Label12" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Contract_ContractType %>"></asp:Label></td>
                        <td style="height: 28px">
                            <asp:DropDownList ID="ddlContractType" runat="server" BackColor="#F5F5F4" Enabled="False"
                                Width="165px">
                            </asp:DropDownList></td>
                    </tr>
    <tr>
        ...
        <tr style="height:8px">
            ...
            <td class="baseInput" style="height: 8px">
                <table width="165" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="baseLable" style="width: 112px; height: 30px;">
    ...
    <tr>
        <td class="baseLable" style="width: 112px; height: 15px;">
    ...
    <tr>
        <td class="baseLable" style="width: 112px; height: 15px;">
            <asp:Label ID="Label15" runat="server" CssClass="labelStyle" Text="排他条款"></asp:Label></td>
        <td rowspan="2" valign="top">
            <asp:TextBox ID="listBoxExclusive" runat="server" Height="52px" 
                CssClass="ipt160px"></asp:TextBox></td>
    </tr>
        <tr>
            <td style="width: 112px; height: 20px;">
            </td>
            ...
            <td style="width: 112px">
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <br />
                            &nbsp;<asp:Button
                                    ID="btnSave" runat="server" CssClass="buttonSave"  OnClick="btnTempSave_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                                    Text="<%$ Resources:BaseInfo,CustPalaver_butConsent %>"  />&nbsp;<asp:Button ID="btnBlankOut" runat="server" CssClass="buttonClear"  OnClick="btnDispose_Click" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                                Text="<%$ Resources:BaseInfo,CustPalaver_butOverrule %>"  />&nbsp;<asp:Button ID="btnMessage" runat="server" CssClass="buttonMessage" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"
                                                         Text="<%$ Resources:BaseInfo,WrkFlwEntity_btnMessage %>"  />&nbsp;<asp:Button
                                        ID="btnPutIn" runat="server" CssClass="buttonSave"  OnClick="btnPutIn_Click"
                                        Text="<%$ Resources:BaseInfo,Lease_NewLineBtnPutIn %>" Visible="False"  />
                            &nbsp; &nbsp; &nbsp;&nbsp;
                        </td>
                    </tr>
                    <tr>
