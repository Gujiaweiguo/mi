<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NodeMessage.aspx.cs" Inherits="Lease_NodeMessage" %>
                        ...
                        <td colspan="3" style="margin-left:20px; margin-right:20px">
                            <asp:GridView ID="GVMessage" runat="server" AutoGenerateColumns="False" PageSize="15" Width="100%">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="prevoucherMemo" HeaderText="<%$ Resources:BaseInfo,WrkFlwEntity_lblConfirmMessage %>" >
                                        <ItemStyle BorderColor="#E1E0B2" />
                                        <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                    </asp:BoundField>
