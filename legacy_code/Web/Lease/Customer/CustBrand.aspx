<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustBrand.aspx.cs" Inherits="Lease_PotCustomer_CustBrand" %>
            ...
            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="height: 221px; width: 305px;">
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style=" height: 22px" align="left">
                                <img id="ImgTrade" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <img id="ImgBrandName" src="../../App_Themes/Main/Images/must.gif" style="width: 16px; height: 16px" /></td>
                        </tr>
                        <tr>
                            <td class="tdBackColor" colspan="4" style="width: 255px; height: 5px">
                            </td>
                        ...
                        <tr>
                            <td class="tdBackColor" colspan="4" style=" height: 3px">
                            </td>
                        </tr>
                        <tr>
                            <td class="tdBackColor" style="width: 84px; height: 22px; text-align: right">
                ...
                <td class="tdBackColor" style="width: 280px; height: 330px" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 286px; height: 311px">
                        ...
                        <tr>
                            <td class="tdBackColor" style="vertical-align: top; width: 302px; height: 258px;
                        ...
                        <tr>
                            <td class="tdBackColor" style="width: 302px; height: 30px; text-align: center; vertical-align: middle;">
                        ...
                        <tr>
                            <td class="tdBackColor" style="vertical-align: top; width: 302px; height: 34px; text-align:center">
                                &nbsp; &nbsp;
                            </td>
                        </tr>
                    </table>
