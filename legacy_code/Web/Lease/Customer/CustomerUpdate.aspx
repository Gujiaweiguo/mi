<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerUpdate.aspx.cs" Inherits="Lease_Customer_CustomerUpdate" %>
...
<body onload='chooseCard(0);' topmargin=0 leftmargin=0>
    <form id="form1" runat="server">
        <div style="left: 89px; overflow: auto; width: 272px; position: absolute; top: 848px;
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <div id="PotCustomerList" style="width: 100px; height: 100px">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 553px; height: 405px">
                    <tbody>
                        <tr>
                            <td class="tdTopBackColor" style="width: 496px; height: 25px; vertical-align: middle; text-align: left;" valign="top">
                        ...
                        <tr>
                            <td class="tdBackColor" colspan="2" style="width: 255px; height: 320px; text-align: left"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="height: 310px" width="255">
                                    ...
                                    <tr>
                                        <td class="tdBackColor" style="width: 85px; height: 23px; text-align: right">
            ...
            <div style="width: 142px; height: 100px" id="PotCustLicense">
                <table border="0" cellpadding="0" cellspacing="0" style="height: 405px; width: 553px;">
                    <tr>
                        <td class="tdTopBackColor" style="width: 241px; height: 25px; vertical-align: middle; text-align: left;" valign="top">
                            <img alt="" class="imageLeftBack" />
