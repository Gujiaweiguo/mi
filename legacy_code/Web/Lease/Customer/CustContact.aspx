<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustContact.aspx.cs" Inherits="Lease_Customer_CustContact" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="height: 221px; width: 305px;">
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtName" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtDuty" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtChargeArea" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtphone" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtFax" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtmobil" runat="server" CssClass="ipt160px" ></asp:TextBox></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdBackColor" style="width: 160px; height: 22px">
                                <asp:TextBox ID="txtEmail" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                            <td class="tdBackColor" style="width: 5px; height: 22px">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="tdBackColor" style="vertical-align: top; width: 302px; height: 254px;
                                ...
                                <asp:GridView ID="GrdCustBrand" runat="server" AutoGenerateColumns="False" BackColor="White"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ContactMan" HeaderText="<%$ Resources:BaseInfo,User_lblUserName %>">
