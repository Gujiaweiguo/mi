<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustLicense.aspx.cs" Inherits="Lease_Customer_CustLicense" %>
...
<body onload='Load()' topmargin=0 leftmargin=0>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
            <div style="width: 100%; height: 100px" id="PotCustLicense">
                <table border="0" cellpadding="0" cellspacing="0" style="height: 405px; width: 100%;">
                    ...
                    <tr>
                        <td class="tdBackColor" colspan="2" style="width:50%; height: 351px; text-align: left"
                            valign="top">
