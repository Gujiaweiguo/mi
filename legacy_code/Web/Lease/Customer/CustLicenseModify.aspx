<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustLicenseModify.aspx.cs" Inherits="Lease_Customer_CustLicenseModify" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="height: 405px; width:100%;">
                    <tr>
                        <td class="tdTopBackColor" style="height: 25px; vertical-align: middle; text-align: left;" valign="top">
                            ...
                            <asp:Label ID="Label5" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,Customer_labCustomerUpdate %>"></asp:Label></td>
                        <td class="tdTopRightBackColor" colspan="2" style="height: 25px" valign="top">
                            <img class="imageRightBack" /></td>
                    </tr>
                    <tr>
                        <td class="tdBackColor" colspan="2" style="width: 50%; height: 330px; text-align: center"
                            valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" style="height: 216px; width: 100%;">
                                    ...
                                    <td style="width: 280px; height: 1px; background-color: white" colspan="4">
                                                                ...
                                                                <td colspan="1" style="width: 280px; height: 1px; background-color: white">
                                                                </td>
                                </tr>
                                <tr>
                                    <td class="tdBackColor" colspan="4" style=" height: 15px; vertical-align: middle; text-align: center;" valign="bottom">
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 80%">
                                            <tr>
                                                <td style="width: 160px; height: 1px; background-color: #738495; left: 0px; top: 10px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 160px; height: 1px; background-color: #ffffff; left: 0px; top: 10px;">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="tdBackColor" colspan="1" style="vertical-align: middle; height: 15px;
                                ...
                                <tr>
                                    ...
                                    <td class="tdBackColor" colspan="1" style="vertical-align: top; width: 255px; height: 5px;
                                        text-align: center" valign="bottom">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="tdBackColor" colspan="1" style="height: 5px">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="tdBackColor" colspan="1" style="width: 255px; height: 10px">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdBackColor" style="width: 85px; height: 22px; text-align: right">
                                ...
                                <tr>
                                    ...
                                    <td class="tdBackColor" colspan="1" style="width: 255px; height: 22px; text-align: center">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdBackColor" colspan="7" style=" height: 22px; text-align: center">
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 80%">
                                            <tr>
                                                <td style="width: 160px; height: 1px; background-color: #738495; left: 0px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 160px; height: 1px; background-color: #ffffff; left: 0px;">
                                                </td>
                                            </tr>
                                        </table>
                                        </td>
                        ...
                        <td class="tdBackColor" style="width: 50%; height: 351px" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" style="height: 311px; width:100%; vertical-align:top;">
                                <tr>
                                    <td style="width: 280px; height: 1px; background-color: white">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdBackColor" style=" height: 22px; text-align: center">
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 80%">
                                            <tr>
                                ...
                                <tr>
                                    <td class="tdBackColor" style="width: 100%; height: 254px; text-align: center" valign="top">
                                        <asp:GridView ID="GrdCustLicense" runat="server" AutoGenerateColumns="False" BackColor="White" BorderStyle="Inset" BorderWidth="1px" CellPadding="3" Height="285px"
                                            ...
                                            PageSize="11" Width="273px" AllowPaging="True" OnPageIndexChanging="GrdCustLicense_PageIndexChanging">
                                            <Columns>
