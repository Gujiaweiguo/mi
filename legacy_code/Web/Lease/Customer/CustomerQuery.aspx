<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerQuery.aspx.cs" Inherits="Lease_Customer_CustomerQuery" %>
...
<body onload='chooseCard(0);' topmargin=0 leftmargin=0>
    <form id="form1" runat="server">
        <div style="left: 100px; overflow: auto; width: 272px; position: absolute; top: 965px;
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td id="tab3" class="tab" onclick="chooseCard(2);" style="height: 21px; width: 70px;">
                            <span id="tabpage3">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <table style="width: 553px; height: 405px" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    <tr>
                        <td style="width: 290px; height: 25px; vertical-align: middle; text-align: left;" class="tdTopBackColor" valign="top">
                            <img class="imageLeftBack" alt="" />
                            <asp:Label ID="labCustomer" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,Customer_labCustomerQuery %>" Width="228px"></asp:Label></td>
                        <td style="width: 538px; height: 25px; text-align: right" class="tdTopRightBackColor"
                            valign="top" colspan="2">
                            <img class="imageRightBack" alt="" /></td>
                    </tr>
                    <tr>
                        <td style="width: 535px; height: 329px; text-align: center" class="tdBackColor" valign="top"
                            colspan="3">
                            <table style="width: 551px; height: 380px" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    <tr>
                                        <td style="width: 533px; height: 1px; background-color: white" colspan="8">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 85px; height: 22px; text-align: right" class="tdBackColor">
                                            <asp:Label ID="Label1" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_lblCustType %>"></asp:Label></td>
                                        <td style="width: 8px; height: 22px" class="tdBackColor">
                                        </td>
                                        <td style="width: 137px; height: 22px; text-align: left" class="tdBackColor">
                                        ...
                                        <td style="width: 120px; height: 22px; text-align: left" class="tdBackColor">
                                            <asp:TextBox ID="TextBox2" runat="server" CssClass="textstyle"></asp:TextBox></td>
                                        <td style="width: 100px; height: 22px" class="tdBackColor">
                                            <asp:Button ID="btnQuery" OnClick="btnQuery_Click" runat="server" CssClass="buttonQuery"
                                                Text="<%$ Resources:BaseInfo,User_lblQuery %>"></asp:Button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 495px; height: 12px; text-align: center" class="tdBackColor" colspan="8">
                                            <table style="left: 12px; width: 526px; position: relative" cellspacing="0" cellpadding="0"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 495px; height: 260px; text-align: center; vertical-align: top;" class="tdBackColor" colspan="8">
                                    ...
                                    <tr>
                                        ...
                                        <asp:Label
                                                    ID="lblTotalNum" runat="server"></asp:Label>
             ...
             <table border="0" cellpadding="0" cellspacing="0" style="height: 405px; width: 553px;" width="535" id="TABLE1" >
                        <tr>
                            <td class="tdTopBackColor" style="width: 358px; height: 25px; vertical-align: middle; text-align: left;" valign="top">
                            ...
                            <td class="tdBackColor" style="width: 280px; height: 320px" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" style="height: 100px" width="280">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdBackColor" style="width: 160px; height: 22px">
                                            <asp:TextBox ID="txtTitle" runat="server" CssClass="Enabledipt160px" ReadOnly="True"></asp:TextBox></td>
                                        <td class="tdBackColor" style="width: 30px; height: 22px">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdBackColor" style="width: 160px; height: 22px">
                                            <asp:TextBox ID="txtEMail" runat="server" CssClass="Enabledipt160px" ReadOnly="True"></asp:TextBox></td>
                                        <td class="tdBackColor" style="width: 30px; height: 22px">
                                        </td>
                                    </tr>
                                    				    <tr>
            ...
            <div style="width: 142px; height: 100px" id="PotCustLicense">
                <table border="0" cellpadding="0" cellspacing="0" style="height: 405px; width: 553px;">
                    <tr>
                        <td class="tdTopBackColor" style="width: 249px; height: 25px; vertical-align: middle; text-align: left;" valign="top">
                            <img alt="" class="imageLeftBack" />
                            <asp:Label ID="Label5" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,Customer_labCustomerQuery %>"></asp:Label></td>
                        <td class="tdTopRightBackColor" colspan="2" style="width: 528px; height: 25px" valign="top">
                            <img class="imageRightBack" /></td>
                    </tr>
                    <tr>
                        <td class="tdBackColor" colspan="2" style="width: 280px; height: 351px; text-align: left"
                            valign="top">
                  ...
                  BorderStyle="Inset" BorderWidth="1px" PageSize="11">
                       <Columns>
                          <asp:BoundField DataField="CustLicenseID">
                           ...
                           <asp:CommandField HeaderText="<%$ Resources:BaseInfo,User_btnChang %>" ShowSelectButton="True">
                               ...
                               <ItemStyle BorderColor="#E1E0B2" />
                                ...
                                <tr>
                                    <td class="tdBackColor" style="width: 280px; height: 22px; text-align: right"><asp:Label
                    ID="lblLCurrent" runat="server" ForeColor="Red">1</asp:Label><asp:Label ID="lblLTotalNum"
                        runat="server"></asp:Label>&nbsp;<asp:Button ID="btnLBack" runat="server" CssClass="buttonBack"
                            Enabled="False" OnClick="btnLBack_Click" Text="<%$ Resources:BaseInfo,Button_back %>" /><asp:Button
                                ID="btnLNext" runat="server" CssClass="buttonNext" Enabled="False" OnClick="btnLNext_Click"
