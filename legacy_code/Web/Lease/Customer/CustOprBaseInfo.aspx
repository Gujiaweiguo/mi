<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustOprBaseInfo.aspx.cs" Inherits="Lease_Customer_CustOprBaseInfo" %>
        ...
        <table id="TABLE0" border="0" cellpadding="0" cellspacing="0" style="height: 24px;
            ...
            <tr>
                ...
                <td class="tdTopBackColor">
                    <%= (String)GetGlobalResourceObject("BaseInfo", "PotCustomer_ManageSurvey")%>
                    </td>
            </tr>
        </table>
