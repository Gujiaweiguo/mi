<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConTerminateBillStop.aspx.cs" Inherits="Lease_ConOvertimeBillStop_ConTerminateBillStop" %>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblBase" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td rowspan="1" style="height: 28px" valign="top">
                                                                    <asp:Button ID="btnOverTime" runat="server" CssClass="buttonSave" Height="32px" OnClick="btnOverTime_Click"
                                                                        Text="<%$ Resources:BaseInfo,Dept_TitleAdd %>" /></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
