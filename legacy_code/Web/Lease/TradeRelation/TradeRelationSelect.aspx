<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TradeRelationSelect.aspx.cs" Inherits="Lease_TradeRelation_TradeRelationSelect" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="height: 32px; width: 230px;">
            <tr>
                ...
                <td class="tdTopRightBackColor" style="height: 27px; text-align: left">
                    <asp:Label ID="Label1" runat="server" Height="12pt" Text="<%$ Resources:BaseInfo,LeaseholdContract_labTradeID %>"></asp:Label></td>
