<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrandeRelationAdd.aspx.cs" Inherits="Lease_TradeRelation_TrandeRelationAdd" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "RentableArea_lblTradeAdd")%></title>
...
var cp2 = new ColorPicker(); 
	...
	{
	    treearray();
	    addTabTool("<%=baseInfo %>,Lease/TradeRelation/TrandeRelationAdd.aspx");
        loadTitle();
	}
	function CheckData()
    {
...
//        if(isInteger(document.all.txtAItemID.value)==false)
//        {
//            parent.document.all.txtWroMessage.value="please input nummber.";
//            document.all.txtAItemID.value="";
//            document.all.txtAItemID.focus();
//            return false;
//        }
            ...
            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="height: 330px; width: 100%;" >
                        <tr>
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 22px; width:100%;">
                            ...
                            <tr>
                                ...
                                <asp:Label ID="labBuildingTitle" runat="server" CssClass="lblTitle"  Text="<%$ Resources:BaseInfo,RentableArea_lblTradeTable %>"></asp:Label></td>
                        ...
                        <tr>
                          ...
                          <tr>
                                ...
                                <tr>
                                <td style="height:5px; text-align: center;"><table border="0" cellpadding="0" cellspacing="0" style="width: 222px">
                                    <tr>
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="width: 262px; height: 338px">
                         <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="vertical-align: top; height: 350px; background-color: #e1e0b2;
                                ...
                                <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderStyle="Inset" BorderWidth="1px"
                                    ...
                                    <table style="width: 176px; height: 263px">
                                        <tr>
                ...
                <td colspan="3" style="height: 402px; width: 49%; vertical-align:top;">
                    <table border="0" cellpadding="0" cellspacing="0" style="height: 367px; width: 100%; ">
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 22px; width: 100%;   ">
                            ...
                            <tr>
                                <td class="tdTopRightBackColor"    valign="top" style="width: 8px; height:27px;  text-align:left" >
                                    ...
                                    <td class="tdTopRightBackColor" style="height: 27px; text-align:left;">
                                <asp:Label ID="Label4" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,RentableArea_lblTradeAdd %>"></asp:Label></td>
                        ...
                        <tr>
                            <td class="tdBackColor" colspan="4" rowspan="10" style="height: 380px; text-align: center; width: 391px;"
                ...
                <td style="width: 100%; height: 335px; vertical-align: top;">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 360px;">
                                    ...
                                    <tr>
                                        <td style="width: 61px; height: 30px; text-align: right">
                                            <asp:Label ID="lblTradePCode" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblTradeCode %>"
                                    ...
                                    <tr>
                                        <td style="width: 61px; height: 30px; text-align: right">
                                            <asp:Label ID="lblTradePName" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblTradeName %>" Width="90px"></asp:Label></td>
                                        <td style="height: 30px; width: 13px;">
                                           </td>
                                        <td style="height: 30px; width: 155px; text-align: left;">
                        <asp:TextBox ID="txtTradePName" runat="server" CssClass="textstyle" ReadOnly="True" MaxLength="32"></asp:TextBox></td>
                                 ...
                                 <tr>
                                        <td style="width: 61px; height: 30px; text-align: right">
                                            <asp:Label ID="lblTradePSatus" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblTradeStatus %>"
                                    ...
                                    <tr>
                                        <td style="width: 61px; height: 30px; text-align: right">
                                            <asp:Label ID="Labbgcolor" runat="server" CssClass="labelStyle" Text="图示颜色"
                                                Width="90px"></asp:Label></td>
                                        <td style="width: 13px; height: 30px">
                                        </td>
                                        <td style="width: 155px; height: 30px; text-align: left;">
                                         <asp:TextBox ID="txtbgcolor" name="NEW" runat="server" ReadOnly="True" OnClick="colordiv();"    CssClass="textstyle" ></asp:TextBox></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="3" rowspan="2" style="height: 15px">
                                        </td>
                                    </tr>
                                    <tr>
                                    </tr>
