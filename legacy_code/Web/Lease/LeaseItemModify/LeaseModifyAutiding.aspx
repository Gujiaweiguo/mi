<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaseModifyAutiding.aspx.cs" Inherits="Lease_LeaseItemModify_LeaseModifyAutiding" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Lease/LeaseItemModify/LeaseModifyAutiding.aspx~<%=leaseItem %>,Lease/LeaseItemModify/LeaseItemModifyAutiding.aspx~<%=shopInfo %>,Lease/LeaseItemModify/LeaseConShopModifyAutiding.aspx");
	        loadTitle();
	    }
    </script>
</head>
