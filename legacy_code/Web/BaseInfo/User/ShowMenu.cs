...
namespace BaseInfo.User
{
    public class ShowMenu : BasePO, ITreeNode
    {
        ...
        {
            return "MenuID,MenuName,MenuLevel,PMenuID,MenuURL,MenuOrder";
        }
        ...
        private Queue<ITreeNode> children = new Queue<ITreeNode>();
         ...
         * 获取子节点的集合
         */
        public Queue<ITreeNode> GetChildren()
        {
        ...
        {
            this.children.Enqueue(childNode);
        }
