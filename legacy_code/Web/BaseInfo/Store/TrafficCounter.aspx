<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrafficCounter.aspx.cs" Inherits="BaseInfo_Store_TrafficCounter" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
      ...
      <!--	    
	     function Load()
        {
            addTabTool("<%=baseInfo %>,BaseInfo/Store/TrafficCounter.aspx");
            loadTitle();
        }
        function CheckData()
    {
        if(isEmpty(document.all.txtTrafficPoint.value))  
        {
            parent.document.all.txtWroMessage.value='<%=(string)GetGlobalResourceObject("BaseInfo", "Hidden_hidMessage") %>';
            document.all.txtTrafficPoint.focus();
            return false;					
        }        
        if(isEmpty(document.all.txtTrafficCounterID.value))  
        {
            parent.document.all.txtWroMessage.value='<%=(string)GetGlobalResourceObject("BaseInfo", "Hidden_hidMessage") %>';
            document.all.txtTrafficCounterID.focus();
            return false;					
        }
        if(!isDigit(document.all.txtTrafficCounterID.value))  
        {
            parent.document.all.txtWroMessage.value='数字格式不正确。';
            document.all.txtTrafficCounterID.focus();
            return false;					
        }
    }
                             ...
                             <tr style="height: 1px">
                                 <td colspan="3" class="tdBackColor">
                                     <table style="width: 100%" >
                                         ...
                                         <tr>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_BusinessItem %>"
                                             ...
                                             <td class="baseLable">
                                                 <asp:Label ID="Label6" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Traffic_TrafficDoorName %>"></asp:Label></td>
                                             <td class="baseInput" style="width: 497px">
                                                 <asp:DropDownList ID="ddlTrafficDoor" runat="server" Width="165px">
                                                 </asp:DropDownList>
                                             </td>
                                         </tr>
                                         <tr>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label2" runat="server" Text="<%$ Resources:BaseInfo,Traffic_TrafficCounterID %>" CssClass="labelStyle"></asp:Label></td>
                                             <td>
                                                 <asp:TextBox ID="txtTrafficCounterID" runat="server" CssClass="ipt160px" MaxLength="12"></asp:TextBox></td>
                                             <td class="baseLable">
                                                 <asp:Label ID="Label5" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Traffic_TrafficPoint %>"></asp:Label></td>
                                             <td class="baseInput" style="width: 497px">
                                                 <asp:TextBox ID="txtTrafficPoint" runat="server" CssClass="ipt160px" MaxLength="10"></asp:TextBox></td>
                                         </tr>
                                         <tr>
                                             <td class="baseLable">
                                         ...
                                         <tr>
                                             <td colspan="4" style="text-align: center">
                                                 <asp:GridView ID="gvTrafficPoint" runat="server" AutoGenerateColumns="False"  BorderStyle="Inset" BorderWidth="1px" CellPadding="3"
                                                     ...
                                                     <Columns>
                                                         ...
                                                         <asp:BoundField DataField="counterid" HeaderText="<%$ Resources:BaseInfo,Traffic_TrafficCounterID %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="name" HeaderText="<%$ Resources:BaseInfo,Traffic_TrafficPoint %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="statusname" HeaderText="<%$ Resources:BaseInfo,Rpt_Status %>" >
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                         </asp:BoundField>
