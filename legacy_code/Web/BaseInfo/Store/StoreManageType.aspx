<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StoreManageType.aspx.cs" Inherits="BaseInfo_Store_StoreManageType" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Store_StoreManageTypeVindicate")%></title>    
    ...
    <script type="text/javascript">
     function Load()
    {
        addTabTool("<%=strBaseInfo %>,BaseInfo/Store/StoreManageType.aspx");
        loadTitle();
    }
        //text控件文本验证
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 370px">
                                        <tr>
                                            <td class="tdTopBackColor" style="vertical-align: middle; height: 25px;
                                                ...
                                                <asp:Label ID="labCustomer" runat="server" Text="<%$ Resources:BaseInfo,Store_StoreManageTypeVindicate %>" Width="376px"></asp:Label></td>
                                                ...
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tdBackColor" style="width: 232px; height: 30px; text-align: left">
                                                            <asp:TextBox ID="txtName" runat="server" CssClass="ipt160px" MaxLength="32"></asp:TextBox></td>
                                                        <td class="tdBackColor" style="height: 30px">
                                                        </td>
                                                        ...
                                                        <td class="tdBackColor" style="width: 127px; height: 30px; text-align: left">
                                                            <asp:DropDownList ID="ddlTypeStatus" runat="server" BackColor="White" CssClass="cmb160px" Width="165px">
                                                            </asp:DropDownList></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="8" style="height: 192px;padding-left:10px; padding-right:10px" valign="top">
                                                            &nbsp;<asp:GridView ID="GrdVewCreditLevel" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField DataField="TypeId">
                                                                        <ItemStyle CssClass="hidden" />
                                                                        <HeaderStyle CssClass="hidden" />
                                                                        <FooterStyle CssClass="hidden" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="TypeName" HeaderText="<%$ Resources:BaseInfo,PotCustomer_LevelName %>" >
