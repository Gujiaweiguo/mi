<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LicenseType.aspx.cs" Inherits="BaseInfo_Store_LicenseType" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Store_LicenseCardVindicate")%></title>    
    ...
    <script type="text/javascript">
     function Load()
    {
        addTabTool("<%=strBaseInfo %>,BaseInfo/Store/LicenseType.aspx");
        loadTitle();
    }
        //text控件文本验证
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 370px">
                                        <tr>
                                            <td class="tdTopBackColor" style="vertical-align: middle; height: 25px;
                                                ...
                                                <asp:Label ID="labCustomer" runat="server" Text="<%$ Resources:BaseInfo,Store_LicenseCardVindicate %>" Width="376px"></asp:Label></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="8" style="height: 192px;padding-left:10px; padding-right:10px" valign="top">
                                                            &nbsp;<asp:GridView ID="GrdVewCreditLevel" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField DataField="LicenseTypeId">
                                                                        <ItemStyle CssClass="hidden" />
                                                                        <HeaderStyle CssClass="hidden" />
                                                                        <FooterStyle CssClass="hidden" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="LicenseTypeName" HeaderText="<%$ Resources:BaseInfo,PotCustomer_LevelName %>" >
