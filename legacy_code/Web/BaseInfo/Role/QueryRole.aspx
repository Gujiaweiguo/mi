<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryRole.aspx.cs" Inherits="BaseInfo_Role_Default" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Menu_BrowsingCurrentRoles")%></title>
...
function ShowTitle()
{
    ...
    addTabTool("<%=baseInfo %>,BaseInfo/Role/QueryRole.aspx");
    loadTitle();
}
		-->
</script>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="height: 430px; width:100%">
            <tr>
                <td style="width: 30%; height: 402px; vertical-align: top;">
                    <table border="0" cellpadding="0" cellspacing="0" style="height: 370px; width:100%;">
                        <tr>
                        ...
                        <tr>
                            <td class="tdBackColor" colspan="4" rowspan="10" style="height: 370px; text-align: center; width: 226px;"
                                valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 250px; height: 370px">
                                <tr>
                                <td style="height:5px">
                                </td>
                                </tr>
                                    <tr>
                                        <td colspan="4" rowspan="9" style="height: 206px; text-align: center; width: 250px;" valign="top">
                                        <table>
                                        <tr>
                                        <td style="width: 215px">
                                    <asp:GridView ID="GrdRole" runat="server" AutoGenerateColumns="False" Height="300px" OnRowDataBound="GrdRole_RowDataBound" Width="250px" BackColor="White"  CellPadding="3"  BorderStyle="Inset" BorderWidth="1px" OnSelectedIndexChanged="GrdRole_SelectedIndexChanged" PageSize="13" AllowPaging="True" OnPageIndexChanging="GrdRole_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:CommandField SelectText="<%$ Resources:BaseInfo,User_lblUserQuery %>" ShowSelectButton="True" >
                                                ...
                                                <SelectedRowStyle BackColor="#FFFF9B" Font-Bold="False" ForeColor="Black" />
                ...
                <td colspan="3" style="height: 402px; width: 67%; vertical-align:top;">
                    <table border="0" cellpadding="0" cellspacing="0" style="height: 390px; width:100%; ">
                        ...
                        <tr>
                            <td class="tdBackColor" colspan="4" rowspan="10" style="height: 370px; text-align: center"
                                valign="top">
                ...
                <td style="height: 344px; width: 265px; vertical-align:top;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 208px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 30px; width: 154px;">
                                            <asp:TextBox ID="txtRoleCode" runat="server" CssClass="Enabletextstyle" ReadOnly="True"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 61px; height: 30px; text-align: right">
                                        ...
                                        <td style="height: 30px; width: 154px;">
                        <asp:TextBox ID="txtRoleName" runat="server" CssClass="Enabletextstyle" ReadOnly="True"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 61px; height: 30px; text-align: right">
                        ...
                        <asp:DropDownList ID="cmbLeader" runat="server" CssClass="textstyle" Enabled="False">
                                    ...
                                    <tr>
                                        <td colspan="3" rowspan="2" style="height: 17px; text-align:right; position: relative; top: 15px;">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                    </tr>
                    ...
                    <asp:Label ID="lblTotalNum" runat="server" Height="9px" Width="62px" CssClass="hidden"></asp:Label>
                                            <asp:Label ID="lblCurrent" runat="server" ForeColor="Red"
                                                        Height="9px" Width="1px">1</asp:Label></td>
                </tr>
                </table>
                                </td>
                        </tr>
