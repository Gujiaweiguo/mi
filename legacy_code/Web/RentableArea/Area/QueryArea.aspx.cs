...
public partial class LeaseArea_Area_QueryArea : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //得到数据集
        GridView1.DataSource = baseBO.Query(areaInfo);
        GridView1.DataBind();
    }
    ...
    {
        string sql = "Update Area Set AreaStatus='" + Area.AREA_STATUS_INVALID + "' where AreaID=" + Convert.ToInt32(GridView1.SelectedRow.Cells[0].Text);
    ...
    {
        Response.Redirect("ChangeArea.aspx?AreaID=" + GridView1.Rows[e.NewEditIndex].Cells[0].Text);
