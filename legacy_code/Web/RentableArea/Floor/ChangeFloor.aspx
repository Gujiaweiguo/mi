<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeFloor.aspx.cs" Inherits="LeaseArea_Floor_ChangFloor" MasterPageFile="~/BaseInfo/User/MasterPage.master" %>
                            ...
                            <table align="center" style="width: 353px; position: relative; height: 63px">
                                <tr>
                                    <td style="width: 290px; height: 21px">
                                        <asp:Label ID="lblFloorCode" runat="server" Text='<%$ Resources:BaseInfo,RentableArea_lblFloorCode %>' CssClass="label"></asp:Label></td>
                                    <td style="width: 492px; height: 21px" align="left">
                                        <asp:TextBox ID="txtFloorCode" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="width: 290px">
                                        <asp:Label ID="lblFloorName" runat="server" Text='<%$ Resources:BaseInfo,RentableArea_lblFloorName %>' CssClass="label"></asp:Label></td>
                                    <td style="width: 492px" align="left">
                                        <asp:TextBox ID="txtFloorName" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="width: 290px">
                                        <asp:Label ID="lblFloorStatus" runat="server" Text='<%$ Resources:BaseInfo,RentableArea_lblFloorStatus %>' CssClass="label"></asp:Label></td>
                                    <td style="width: 492px" align="left">
                                        <asp:DropDownList ID="cmbFloorStatus" runat="server" Width="153px" CssClass="cmb160px">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
