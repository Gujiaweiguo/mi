<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeBuilding.aspx.cs" Inherits="LeaseArea_ChangBuilding" MasterPageFile="~/BaseInfo/User/MasterPage.master" %>
                                    ...
                                    <table align="center" style="width: 353px; height: 63px">
                                        <tr>
                                            <td style="width: 290px; height: 21px">
                                                <asp:Label ID="lblBuildingCode" runat="server" CssClass="label" Text='<%$ Resources:BaseInfo,RentableArea_lblBuildingCode %>'></asp:Label></td>
                                            <td style="width: 492px; height: 21px">
                                                <asp:TextBox ID="txtBuildingCode" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 290px">
                                                <asp:Label ID="lblBuildingName" runat="server" Text='<%$ Resources:BaseInfo,RentableArea_lblBuildingName %>' CssClass="label"></asp:Label></td>
                                            <td style="width: 492px">
                                                <asp:TextBox ID="txtBuildingName" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 290px; height: 21px">
                                                <asp:Label ID="lblBuildingAddr" runat="server" Text='<%$ Resources:BaseInfo,RentableArea_lblBuildingAddr %>' CssClass="label"></asp:Label></td>
                                            <td style="width: 492px; height: 21px">
                                                <asp:TextBox ID="txtBuildingAddr" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 290px">
                                                <asp:Label ID="lblPostCode" runat="server" Text='<%$ Resources:BaseInfo,RentableArea_lblPostCode %>' CssClass="label"></asp:Label></td>
                                            <td style="width: 492px">
                                                <asp:TextBox ID="txtPostCode" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 290px">
                                                <asp:Label ID="lblBuildingStatus" runat="server" Text='<%$ Resources:BaseInfo,RentableArea_lblBuildingStatus %>' CssClass="label"></asp:Label></td>
                                            <td style="width: 492px">
