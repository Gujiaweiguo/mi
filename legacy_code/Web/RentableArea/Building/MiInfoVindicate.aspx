<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MiInfoVindicate.aspx.cs" Inherits="RentableArea_Building_MiInfoVindicate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "RentableArea_lblBuildingtit")%></title>
           ...
           <table border="0" cellpadding="0" cellspacing="0" style="height: 301px; width: 100%;" width="500">
            <tr>
                <td class="tdTopBackColor" style="width: 478px; height: 25px" valign="top">
                    ...
                    <asp:Label ID="labBuildingTitle" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,Dept_MallAdd %>"></asp:Label></td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width:475px; height:230px;">
            ...
            <tr>
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtMallName" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtPropertytel" runat="server" CssClass="ipt160px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 60px;height:22px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtOfficeAddr" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                <td style="width: 20px;height:22px;" class="tdBackColor">
                </td>
                <td style="width: 70px;height:22px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtLegalRep" runat="server" CssClass="ipt160px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 60px;height:22px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtOfficeAddr2" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                <td style="width: 20px;height:22px;" class="tdBackColor">
                </td>
                <td style="width: 70px;height:22px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtLegalRepTitle" runat="server" CssClass="ipt160px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 60px;height:22px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtOfficeAddr3" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                <td style="width: 20px;height:22px;" class="tdBackColor">
                </td>
                <td style="width: 70px;height:22px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtRegCap" runat="server" CssClass="ipt160px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 60px;height:22px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtPostAddr" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                <td style="width: 20px;height:22px;" class="tdBackColor">
                </td>
                ...
                <td style="width: 160px;height:22px; vertical-align: middle; text-align: left;" class="tdBackColor">
                    <asp:TextBox ID="txtRegAddr" runat="server" CssClass="ipt160px"></asp:TextBox></td>
            </tr>
            <tr>
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtPostAddr2" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                <td style="width: 20px;height:22px;" class="tdBackColor">
                </td>
                <td style="width: 70px;height:22px; text-align: right;" class="tdBackColor">
                    </td>
            ...
            <tr>
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtPostAddr3" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                <td style="width: 20px;height:22px;" class="tdBackColor">
                </td>
                <td style="width: 70px;height:22px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtRegCode" runat="server" CssClass="ipt160px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 60px;height:22px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:22px;" class="tdBackColor">
                    <asp:TextBox ID="txtTaxCode" runat="server" CssClass="ipt160px"></asp:TextBox></td>
            </tr>
            <tr>
                ...
                <td style="width: 160px;height:21px;" class="tdBackColor">
                    <asp:TextBox ID="txtOfficeTel" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                ...
                <td style="width: 160px;height:21px;" class="tdBackColor">
                    <asp:TextBox ID="txtBankName" runat="server" CssClass="ipt160px"></asp:TextBox></td>
            </tr>
                        <tr>
                <td style="width: 60px;height:21px; text-align: right;" class="tdBackColor">
                    </td>
                ...
                <td style="width: 160px;height:21px;" class="tdBackColor">
                    <asp:TextBox ID="txtBankAcct" runat="server" CssClass="ipt160px"></asp:TextBox></td>
            </tr>
                        <tr>
                <td style="width: 60px;height:21px; text-align: right;" class="tdBackColor">
                ...
                <td style="width: 160px;height:21px;" class="tdBackColor">
                    <asp:TextBox ID="txtTel" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                <td style="width: 20px;height:21px;" class="tdBackColor">
                </td>
                <td style="width: 70px;height:21px; text-align: right;" class="tdBackColor">
                    </td>
            ...
            <tr>
                <td style="width:478px; height:42px; text-align:right;"  class="tdBackColor" valign="top">
                </td>
                <td style="width:10px; height:42px; text-align:right;"  class="tdBackColor" valign="top">

                </td>
                <td style="width:190px; height:42px; text-align:left;"  class="tdBackColor" valign="top">
                    <asp:Button ID="btnSave" runat="server" CssClass="buttonSave" meta:resourcekey="btnSaveResource1"
                        OnClick="btnSave_Click" Text="<%$ Resources:BaseInfo,PotCustomer_butSave %>" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"/></td>
            </tr>
        </table>
            </ContentTemplate>
        </asp:UpdatePanel>
