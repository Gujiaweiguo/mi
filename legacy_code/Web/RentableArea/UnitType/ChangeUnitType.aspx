<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeUnitType.aspx.cs" Inherits="LeaseArea_UnitType_ChangUnitType" MasterPageFile="~/BaseInfo/User/MasterPage.master" %>
                                        ...
                                        <table align="center" style="width: 353px; height: 63px">
                                            <tr>
                                                <td style="width: 361px; height: 21px">
                                                    <asp:Label ID="lblUnitTypeCode" runat="server" CssClass="label" Text="<%$ Resources:BaseInfo,RentableArea_lblUnitTypeCode %>"
                                            ...
                                            <tr>
                                                <td style="width: 361px">
                                                    <asp:Label ID="lblUnitTypeName" runat="server" CssClass="label" Text="<%$ Resources:BaseInfo,RentableArea_lblUnitTypeName %>"></asp:Label></td>
                                                <td align="left" style="width: 492px">
                                                    <asp:TextBox ID="txtUnitTypeName" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td style="width: 361px">
                                                    <asp:Label ID="lblUnitTypeStatus" runat="server" CssClass="label" Text="<%$ Resources:BaseInfo,RentableArea_lblUnitTypeStatus %>"></asp:Label></td>
                                                <td align="left" style="width: 492px">
                                                    <asp:DropDownList ID="cmbUnitTypeStatus" runat="server" CssClass="cmb160px" Width="153px">
                                                    </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 492px">
                                                    ...
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="btnCancel" runat="server"
                                                        CssClass="btnOn50px" Text="取消" OnClick="btnCancel_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                        &nbsp;</td>
