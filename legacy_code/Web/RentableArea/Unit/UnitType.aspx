<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnitType.aspx.cs" Inherits="RentableArea_Unit_UnitType" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Menu_RegularUnitsTypeVindicate")%></title>    
    ...
    <script type="text/javascript">
     function Load()
    {
        addTabTool("<%=strBaseInfo %>,RentableArea/Unit/UnitType.aspx");
        loadTitle();
    }
    //text控件文本验证
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 370px">
                                        <tr>
                                            <td class="tdTopBackColor" style="vertical-align: middle; height: 25px;
                                                ...
                                                <asp:Label ID="labCustomer" runat="server" Text="<%$ Resources:BaseInfo,Menu_RegularUnitsTypeVindicate %>" Width="376px"></asp:Label></td>
                                                ...
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tdBackColor" style="width: 232px; height: 30px; text-align: left">
                                                            <asp:TextBox ID="txtCustTypeCode" runat="server" CssClass="ipt160px" MaxLength="32"></asp:TextBox></td>
                                                        ...
                                                        <td class="tdBackColor" style="width: 127px; height: 30px; text-align: left">
                                                            <asp:TextBox ID="txtSourceTypeName" runat="server" CssClass="ipt160px" MaxLength="32"></asp:TextBox></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="8" style="height: 192px;padding-left:10px; padding-right:10px" valign="top">
                                                            &nbsp;<asp:GridView ID="GrdVewSourceType" runat="server" AutoGenerateColumns="False"
                                                                BackColor="White" BorderColor="#E1E0B2" OnSelectedIndexChanged="GrdVewCustType_SelectedIndexChanged"
                                                                PageSize="9" Width="100%" OnRowDataBound="GrdVewCustType_RowDataBound" AllowPaging="True" OnPageIndexChanging="GrdVewSourceType_PageIndexChanging">
                                                                <Columns>
                                                                    <asp:BoundField DataField="UnitTypeID">
                                                                        <ItemStyle CssClass="hidden" />
                                                                        <HeaderStyle CssClass="hidden" />
                                                                        <FooterStyle CssClass="hidden" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="UnitTypeCode" HeaderText="<%$ Resources:BaseInfo,CustType_lblCustTypeCode %>" >
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                        <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="UnitTypeName" HeaderText="<%$ Resources:BaseInfo,CustType_lblCustTypeName %>" >
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                        <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="UnitTypeStatus" HeaderText="<%$ Resources:BaseInfo,WrkFlw_lblBizGrpStatus %>" >
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                        <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                                    </asp:BoundField>
