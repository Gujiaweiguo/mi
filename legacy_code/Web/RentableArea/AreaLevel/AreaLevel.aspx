<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaLevel.aspx.cs" Inherits="RentableArea_AreaLevel_AreaLevel" %>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 553px; height: 370px">
                                    <tr>
                                        <td class="tdTopBackColor" style="vertical-align: middle; width: 290px; height: 25px;
                                            ...
                                            <asp:Label ID="labCustomer" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,RentableArea_lblAreaLevel %>"></asp:Label></td>
                                            ...
                                            <table style="width: 552px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tdBackColor" style="width: 127px; height: 30px; text-align: left">
                                                        <asp:TextBox ID="txtAreaName" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tdBackColor" style="width: 127px; height: 30px; text-align: left">
                                                        <asp:DropDownList ID="cmbAreaStatus" runat="server" CssClass="cmb160px" Width="164px">
                                                        </asp:DropDownList></td>
                                                    <td class="tdBackColor" style="width: 100px; height: 30px">
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="8" style="height: 192px" valign="top">
                                                        &nbsp;<asp:GridView ID="GrdVewCustType" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                <asp:BoundField DataField="AreaLevelID">
                                                                    <ItemStyle CssClass="hidden" />
                                                                    <HeaderStyle CssClass="hidden" />
                                                                    <FooterStyle CssClass="hidden" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="AreaLevelCode" HeaderText="<%$ Resources:BaseInfo,RentableArea_lblAreaLeveCode %>">
                                                                    <ItemStyle BorderColor="#E1E0B2" />
                                                                    <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="AreaLevelDesc" HeaderText="<%$ Resources:BaseInfo,RentableArea_lblAreaLeveName %>">
                                                                    <ItemStyle BorderColor="#E1E0B2" />
                                                                    <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="AreaLevelStatusName" HeaderText="<%$ Resources:BaseInfo,RentableArea_lblAreaLeveStatus %>">
                                                                    <ItemStyle BorderColor="#E1E0B2" />
                                                                    <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                </asp:BoundField>
