<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeLocation.aspx.cs" Inherits="LeaseArea_Location_ChangLocation" MasterPageFile="~/BaseInfo/User/MasterPage.master" %>
                            ...
                            <table align="center" style="width: 353px; position: relative; height: 63px">
                                <tr>
                                    <td style="width: 290px; height: 21px">
                                        <asp:Label ID="lblLocationCode" runat="server" Text="<%$ Resources:BaseInfo,RentableArea_lblLocationCode %>" CssClass="label"></asp:Label></td>
                                ...
                                <tr>
                                    <td style="width: 290px">
                                        <asp:Label ID="lblLocationName" runat="server" Text="<%$ Resources:BaseInfo,RentableArea_lblLocationName %>" CssClass="label"></asp:Label></td>
                                    <td style="width: 492px" align="left">
                                        <asp:TextBox ID="txtLocationName" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="width: 290px">
                                        <asp:Label ID="lblLocationStatus" runat="server" Text="<%$ Resources:BaseInfo,RentableArea_lblLocationStatus %>" CssClass="label"></asp:Label></td>
                                    <td style="width: 492px" align="left">
                                        <asp:DropDownList ID="cmbLocationStatus" runat="server" Width="153px" CssClass="cmb160px">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
