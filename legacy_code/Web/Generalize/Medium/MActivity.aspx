<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MActivity.aspx.cs" Inherits="Generalize_Medium_MActivity" %>
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 27px; width: 100%;">
                            <tr>
                                ...
                                <td class="tdTopRightBackColor" style=" height: 27px; text-align:left;">
                                    <asp:Label
                                        ID="Label1" runat="server" Text='<%$ Resources:BaseInfo,Activity_lblMIntrenet %>' Height="12pt" Width="218px"></asp:Label></td>
                                     ...
                                     <table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
                                         <tr>
                                             <td height="326" valign="top" width="29%">
                                                 ...
                                                 <asp:GridView ID="gvMActivity" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                     BorderStyle="Inset" BorderWidth="1px" CellPadding="3" PageSize="11" Width="240px" OnSelectedIndexChanged="gvMActivity_SelectedIndexChanged">
                                                     <Columns>
                                                         <asp:BoundField DataField="MActivityID">
                                                             <FooterStyle CssClass="hidden" />
                                                             <HeaderStyle CssClass="hidden" />
                                                             <ItemStyle CssClass="hidden" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="ActivityNm" HeaderText="<%$ Resources:BaseInfo,Master_lblAnPNm %>">
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="Intention" HeaderText="<%$ Resources:BaseInfo,Activity_lblintention %>">
                                                             <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" CssClass="gridviewtitle" />
                                                             <ItemStyle BorderColor="#E1E0B2" />
                                                         </asp:BoundField>
                                             ...
                                             <td style="vertical-align: top; text-align: center; width: 71%;" valign="top">
                                                 <table border="0" cellpadding="0" cellspacing="0" width="90%">
                                                     ...
                                                     <tr>
                                                         <td align="right" style="width: 96px; height: 28px;">
                                                                         <asp:Label ID="lblAnPNm" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Master_lblAnPNm %>" Width="74px"></asp:Label></td>
                                                         <td colspan="4" style="text-align: left; height: 28px;">
                                                             <asp:TextBox ID="txtAnPNm" runat="server" CssClass="ipt160px" MaxLength="32" Width="295px"></asp:TextBox></td>
                                                         
                                                     </tr>
                                                     <tr>
                                                         <td align="right" style="width: 96px">
                                                                         <asp:Label ID="lblContentsNm" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Activity_lblContentsNm %>"></asp:Label>&nbsp;</td>
                                                         <td colspan="4" style="text-align: left">
                                                             <asp:TextBox ID="txtContentsNm" runat="server" CssClass="ipt160px" MaxLength="32" Width="295px"></asp:TextBox></td>
                                                     </tr>
                                                     <tr>
                                                         <td align="right" style="width: 96px">
                                                                         <asp:Label ID="lblsitus" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Activity_lblsitus %>"></asp:Label>&nbsp;</td>
                                                         <td height="25" style="width: 101px; text-align: left">
                                                                         <asp:TextBox ID="txtSitus" runat="server" CssClass="ipt160px" MaxLength="32"
                                                                              Width="100px"></asp:TextBox></td>
                                                       <td style="width: 2px">
                                                     </td>
                                                     <td style="width: 88px; text-align: right;">
                                                         <asp:Label ID="lblintention" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Activity_lblintention %>" Width="65px"></asp:Label>&nbsp;
                                                     </td>
                                                     <td style="text-align: left">
                                                         <asp:TextBox ID="txtIntention" runat="server" CssClass="ipt160px" MaxLength="32" Width="100px"></asp:TextBox></td>
                                                     </tr>
                                                         <tr>
                                                         <td align="right" style="width: 96px">
                                                                         <asp:Label ID="lblBound" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Activity_lblBound %>"></asp:Label>&nbsp;&nbsp;</td>
                                                         <td height="25" style="width: 101px; text-align: left">
                                                                         <asp:TextBox ID="txtBound" runat="server" CssClass="ipt160px" MaxLength="32"
                                                                              Width="100px"></asp:TextBox></td>
                                                       <td style="width: 2px">
                                                     </td>
                                                     <td style="width: 88px; text-align: right;">
                                                         <asp:Label ID="lblMcompany" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Activity_lblMcompany %>" Width="65px"></asp:Label>&nbsp;</td>
                                                     <td style="text-align: left">
                                                         <asp:TextBox ID="txtMcompany" runat="server" CssClass="ipt160px" MaxLength="32" Width="100px"></asp:TextBox></td>
                                                     </tr>
                                                         <tr>
                                                         <td align="right" style="width: 96px">
                                                                         <asp:Label ID="lblPcompany" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Activity_lblPcompany %>"></asp:Label>&nbsp;</td>
                                                         <td height="25" style="width: 101px; text-align: left">
                                                                         <asp:TextBox ID="txtPcompany" runat="server" CssClass="ipt160px" MaxLength="32"
                                                                              Width="100px"></asp:TextBox></td>
                                                       <td style="width: 2px">
                                                     </td>
                                                     <td style="width: 88px; text-align: right;">
                                                         <asp:Label ID="lblEstCosts" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Activity_lblEstCosts %>" Width="65px"></asp:Label>&nbsp;</td>
                                                     <td style="text-align: left">
                                                         <asp:TextBox ID="txtEstCosts" runat="server" CssClass="ipt160px" MaxLength="32" Width="100px"></asp:TextBox></td>
                                                     </tr>
                                                     <tr>
                                                     ...
                                                     <tr>
                                                         <td colspan="5" style="vertical-align: bottom; height: 25px">
