<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAnPMaster.aspx.cs" Inherits="Generalize_Medium_AddAnPMaster" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
      ...
      <!--	    
	     function Load()
        {
            addTabTool("<%=prints %>,Generalize/Medium/AddAnPMaster.aspx~<%=mtv %>,Generalize/Medium/MTV.aspx~<%=radio %>,Generalize/Medium/MRadio.aspx~<%=internet %>,Generalize/Medium/MInternet.aspx~<%=display %>,Generalize/Medium/MDisplay.aspx~<%=activity %>,Generalize/Medium/MActivity.aspx");
            loadTitle();
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 27px; width: 100%;">
                            <tr>
                                ...
                                <td class="tdTopRightBackColor" style=" height: 27px; text-align:left;">
                                    <asp:Label
                                        ID="Label1" runat="server" Text='<%$ Resources:BaseInfo,Prints_lblPrints %>' Height="12pt" Width="218px"></asp:Label></td>
                                     ...
                                     <table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
                                         <tr>
                                             <td height="326" valign="top" width="29%">
                                                 ...
                                                 <asp:GridView ID="gvMPrints" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                     BorderStyle="Inset" BorderWidth="1px" CellPadding="3" PageSize="11" Width="211px" OnSelectedIndexChanged="gvMPrints_SelectedIndexChanged">
                                                     <Columns>
                                                         <asp:BoundField DataField="MPrintsID">
                                                             <FooterStyle CssClass="hidden" />
                                                             <HeaderStyle CssClass="hidden" />
                                                             <ItemStyle CssClass="hidden" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="PrintsNm" HeaderText="<%$ Resources:BaseInfo,Prints_lblPrintsNm %>">
                                                 ...
                                                 <table border="0" cellpadding="0" cellspacing="0" width="90%">
                                                     ...
                                                     <tr>
                                                         <td align="right" style="width: 96px">
                                                                         <asp:Label ID="lblPrintsNm" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Prints_lblPrintsNm %>"></asp:Label>&nbsp;</td>
                                                         <td height="25" style="width: 172px">
                                                            
                                                            <asp:DropDownList ID="cmbPrintsNm" runat="server" Width="200px">
                                                                         </asp:DropDownList>
                                                         </td>
                                                     </tr>
                                                     <tr>
                                                         <td align="right" style="width: 96px">
                                                                         <asp:Label ID="lblPrintSizeNm" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Prints_lblPrintSizeNm %>"></asp:Label>&nbsp;</td>
                                                         <td height="25" style="width: 172px; text-align: left">
                                                                         <asp:DropDownList ID="cmbPrintSizeNm" runat="server" Width="200px">
                                                                         </asp:DropDownList></td>
                                                     </tr>
                                                     <tr>
                                                         <td align="right" style="width: 96px">
                                                             &nbsp;</td>
                                                         <td height="25" style="width: 172px; text-align: left">
                                                            <asp:RadioButton ID="rdoClour" runat="server" Text="<%$ Resources:BaseInfo,Print_soptColour %>" Checked="True" GroupName="clour" /><asp:RadioButton ID="rdoBnW" runat="server"  Text="<%$ Resources:BaseInfo,Print_soptBnW %>" GroupName="clour"/></td>
                                                     </tr>
                                                     <tr>
                                                         <td align="right" style="width: 96px; height: 25px">
                                                                         <asp:Label ID="lblContentsNm" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Radio_lblContentsNm %>"></asp:Label>&nbsp;</td>
                                                         <td style="width: 172px; height: 25px; text-align: left">
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td style="width: 172px; height: 28px; text-align: left">
