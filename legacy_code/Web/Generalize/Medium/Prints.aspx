<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Prints.aspx.cs" Inherits="Generalize_Medium_Prints" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Prints_lblPrints")%></title>
    ...
    <style type="text/css">
      ...
      <!--	    
	     function Load()
        {
            addTabTool("<%=baseInfo %>,Generalize/Medium/Prints.aspx");
            loadTitle();
                                     ...
                                     <table style="width: 100%" >
                                         ...
                                         <tr>
                                             <td class="baseLable" style="height: 24px">
                                                 <asp:Label ID="lblPrintsNm" runat="server" Text="<%$ Resources:BaseInfo,Prints_lblPrintsNm %>" CssClass="labelStyle" Width="92px"></asp:Label></td>
                                             <td style="height: 24px">
                                                 <asp:TextBox ID="txtPrintsNm" runat="server" CssClass="ipt160px" MaxLength="32"
                                         ...
                                         <tr>
                                             <td colspan="4" style="text-align: center">
                                                 <asp:GridView ID="gvPrints" runat="server" AutoGenerateColumns="False"  BorderStyle="Inset" BorderWidth="1px" CellPadding="3"
                                                     Width="100%" BackColor="White" OnSelectedIndexChanged="gvPrints_SelectedIndexChanged" PageSize="7">
                                                     <Columns>
                                                        <asp:BoundField DataField="PrintsID">
