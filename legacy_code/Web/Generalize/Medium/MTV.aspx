<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MTV.aspx.cs" Inherits="Generalize_Medium_MTV" %>
                                     ...
                                     <table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
                                         <tr>
                                             <td height="326" valign="top" width="29%">
                                                 ...
                                                 <asp:GridView ID="gvMTV" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                     BorderStyle="Inset" BorderWidth="1px" CellPadding="3" PageSize="11" Width="211px" OnSelectedIndexChanged="gvMTV_SelectedIndexChanged">
                                                     <Columns>
                                                         <asp:BoundField DataField="MTVID">
                                                 ...
                                                 <table border="0" cellpadding="0" cellspacing="0" width="90%">
                                                     ...
                                                     <tr>
                                                         <td align="right" style="width: 96px">
                                                                         <asp:Label ID="lblPrintsNm" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,TV_lblTVNm %>"></asp:Label>&nbsp;</td>
                                                         <td height="25" style="width: 172px">
                                                            
                                                            <asp:DropDownList ID="cmbTVNm" runat="server" Width="200px">
                                                                         </asp:DropDownList>
                                                         </td>
                                                     </tr>
                                                     <tr>
