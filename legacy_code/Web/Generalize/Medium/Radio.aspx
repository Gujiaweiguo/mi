<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Radio.aspx.cs" Inherits="Generalize_Medium_Radio" %>
                                     ...
                                     <table style="width: 100%" >
                                         ...
                                         <tr>
                                             <td class="baseLable" style="height: 24px">
                                                 <asp:Label ID="lblPrintsNm" runat="server" Text="<%$ Resources:BaseInfo,Radio_lblRadioNm %>" CssClass="labelStyle" Width="92px"></asp:Label></td>
                                             <td style="height: 24px">
                                                 <asp:TextBox ID="txtRadioNm" runat="server" CssClass="ipt160px" MaxLength="32"
                                         ...
                                         <tr>
                                             <td colspan="4" style="text-align: center">
                                                 <asp:GridView ID="gvRadio" runat="server" AutoGenerateColumns="False"  BorderStyle="Inset" BorderWidth="1px" CellPadding="3"
                                                     Width="100%" BackColor="White" OnSelectedIndexChanged="gvRadio_SelectedIndexChanged" PageSize="7">
                                                     <Columns>
                                                        <asp:BoundField DataField="RadioID">
