<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MRadio.aspx.cs" Inherits="Generalize_Medium_MRadio" %>
                         ...
                         <table border="0" cellpadding="0" cellspacing="0" style="height: 27px; width: 100%;">
                            <tr>
                                ...
                                <td class="tdTopRightBackColor" style=" height: 27px; text-align:left;">
                                    <asp:Label
                                        ID="Label1" runat="server" Text='<%$ Resources:BaseInfo,Radio_lblRadio %>' Height="12pt" Width="218px"></asp:Label></td>
                                     ...
                                     <table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
                                         <tr>
                                             <td height="326" valign="top" width="29%">
                                                 ...
                                                 <asp:GridView ID="gvMRadio" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                     BorderStyle="Inset" BorderWidth="1px" CellPadding="3" PageSize="11" Width="211px" OnSelectedIndexChanged="gvMRadio_SelectedIndexChanged">
                                                     <Columns>
                                                         <asp:BoundField DataField="MRadioID">
                                                             <FooterStyle CssClass="hidden" />
                                                             <HeaderStyle CssClass="hidden" />
                                                             <ItemStyle CssClass="hidden" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="RadioNm" HeaderText="<%$ Resources:BaseInfo,Radio_lblRadioNm %>">
                                                 ...
                                                 <table border="0" cellpadding="0" cellspacing="0" width="90%">
                                                     ...
                                                     <tr>
                                                         <td align="right" style="width: 96px">
                                                                         <asp:Label ID="lblPrintsNm" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Radio_lblRadioNm %>" Width="63px"></asp:Label>&nbsp;</td>
                                                         <td height="25" style="width: 172px">
                                                            
                                                            <asp:DropDownList ID="cmbRadio" runat="server" Width="200px">
                                                                         </asp:DropDownList>
                                                         </td>
                                                     </tr>
                                                     <tr>
                                                             ...
                                                             <table border="0" cellpadding="0" cellspacing="0" style="width: 345px">
                                                                 ...
                                                                 <tr>
                                                                     <td width="100" style="text-align: right">
                                                                         <asp:Label ID="lblAirtime" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Radio_lblAirtime %>"
                                                                             Width="51px"></asp:Label>&nbsp;</td>
                                                                     <td height="25" style="text-align: left">
                                                                         <asp:TextBox ID="txtAirtime" runat="server" CssClass="ipt160px" MaxLength="32"
