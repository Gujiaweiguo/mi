<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Internet.aspx.cs" Inherits="Generalize_Medium_Internet" %>
                                     ...
                                     <table style="width: 100%" >
                                         ...
                                         <tr>
                                             <td class="baseLable" style="height: 24px">
                                                 <asp:Label ID="lblInternetNm" runat="server" Text="<%$ Resources:BaseInfo,Internet_lblInternetNm %>" CssClass="labelStyle" Width="92px"></asp:Label></td>
                                             <td style="height: 24px">
                                                 <asp:TextBox ID="txtInternetNm" runat="server" CssClass="ipt160px" MaxLength="32"
                                         ...
                                         <tr>
                                             <td colspan="4" style="text-align: center">
                                                 <asp:GridView ID="gvInternet" runat="server" AutoGenerateColumns="False"  BorderStyle="Inset" BorderWidth="1px" CellPadding="3"
                                                     Width="100%" BackColor="White" OnSelectedIndexChanged="gvInternet_SelectedIndexChanged" PageSize="7">
                                                     <Columns>
                                                        <asp:BoundField DataField="InternetID">
                                         ...
                                         <tr>
                                             ...
                                             <td style="text-align: right; height: 33px;" colspan="2">
