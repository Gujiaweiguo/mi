<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HandBonus.aspx.cs" Inherits="Associator_HandBonus" %>
...
<head id="Head1" runat="server">
 ...
 <style type="text/css">
	...
	<script type="text/javascript">
	    function Load()
	    {
	        addTabTool("<%=baseInfo %>,Associator/HandBonus.aspx");
	        loadTitle();
	    }
    ...
    <div>
        <table  border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
            <tr>
                ...
                <td class="tdTopRightBackColor" style="text-align:left;">
                    <asp:Label ID="Lable1" runat="server" Text="<%$ Resources:BaseInfo,Menu_lblHandBonus %>"></asp:Label>
                </td>
                <td class="tdTopRightBackColor" style="width: 5px">
        ...
        <table style="width:100%" class="tdBackColor">
            ...
            <tr class="bodyTbl">
             ...
             <tr class="bodyTbl">
                 <td class="lable" colspan="1" style="height: 42px" valign="top">
                     <asp:Label ID="Label4" runat="server" Text="<%$ Resources:BaseInfo,Associator_Itegral %>"></asp:Label></td>
             <td style="width: 73px; height: 42px;" class="lable" valign="top">
                 <asp:TextBox ID="txtBonus" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                <td class="style19">
                    </td>
                 <td class="lable" style="width: 68px; height: 42px;">
                 </td>
               
                <td class="lable" style="width: 174px; height: 42px">
                    </td>
                 <td class="lable" style="width: 73px; height: 42px;">
                 </td>
            </tr>
         
             <tr class="bodyTbl">
                 <td colspan="1" 
                     style="padding-right: 20px; padding-left: 30px; text-align: right" 
                     class="style15">
                 </td>
             <td style="width: 171px; height: 37px;" class="lable">
                ...
                <td class="style16">
                 ...
                 <td style="padding-right: 20px; padding-left: 30px; text-align: right" 
                     class="style15">
                 </td>
