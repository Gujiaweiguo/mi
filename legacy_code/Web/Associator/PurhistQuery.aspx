<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurhistQuery.aspx.cs" Inherits="Associator_PurhistQuery" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>会员消费记录查询</title>
    ...
    <script type="text/javascript">
	    function Load()
	    {
	        ...
	        addTabTool("<%= baseInfo %>,Associator/PurhistQuery.aspx");
	        loadTitle();
	    }
                        ...
                        <table id="TABLE0" border="0" cellpadding="0" cellspacing="0" style="height: 24px;
                            ...
                            <tr>
                                ...
                                <td class="tdTopBackColor">
                                    <asp:Label ID="Label2" runat="server" Text="会员消费记录查询"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <table style="width: 100%; height: 380px" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 20%; height: 22px;text-align: right;">
                                            <asp:Label ID="Label3" runat="server" Text="商铺号"></asp:Label></td>
                                        <td style="width: 20%; height: 22px" align="left">
                                            <asp:TextBox ID="txtShopCode" runat="server" CssClass="textstyle"></asp:TextBox></td>
                                                        ...
                                                        <td style="left: 7px; vertical-align: top; width: 100%; position: relative; text-align: center">
                                                            <asp:GridView ID="GrdCust" runat="server" BorderWidth="1px" BorderStyle="Inset" 
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="ShopCode" HeaderText="商铺号">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="TransDT" HeaderText="消费日期" DataFormatString="{0:d}" HtmlEncode="False">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="NetAmt" HeaderText="消费金额">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="BonusAmt" HeaderText="积分值">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                </Columns>
