...
public partial class Associator_HandBonusEnter : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            baseInfo = (String)GetGlobalResourceObject("BaseInfo", "Member_BonusEnter");
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        baseBo.WhereClause = " TransSku.ReceiptId = '" + txtRecepid.Text + "' AND TransSku.ShopID = '" + shopid + "'";
        DataSet ds2 = baseBo.QueryDataSet(new TransSku());
        string transid = null;
        try
        {
