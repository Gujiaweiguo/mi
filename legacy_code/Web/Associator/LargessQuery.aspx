<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LargessQuery.aspx.cs" Inherits="Associator_LargessQuery" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>会员赠品兑换查询</title>
    ...
    <script type="text/javascript">
	    function Load()
	    {
	        ...
	        addTabTool("<%= baseInfo %>,Associator/LargessQuery.aspx");
	        loadTitle();
	    }
    </script>
</head>
                        ...
                        <table id="TABLE0" border="0" cellpadding="0" cellspacing="0" style="height: 24px;
                            ...
                            <tr>
                                ...
                                <td class="tdTopBackColor">
                                    <asp:Label ID="Label2" runat="server" Text="会员赠品兑换查询"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <table style="width: 100%; height: 380px" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 20%; height: 22px; text-align: left;" align="right">
                                            <asp:TextBox ID="txtCard" runat="server" CssClass="textstyle"></asp:TextBox></td>
                                        <td style="width: 20%; height: 22px;text-align: right;">
                                            <asp:Label ID="Label3" runat="server" Text="移动电话"></asp:Label></td>
                                        <td style="width: 20%; height: 22px" align="left">
                                            <asp:TextBox ID="txtModil" runat="server" CssClass="textstyle"></asp:TextBox></td>
                                        <td style="width: 15%; height: 22px" align="left">
                                            </td>
                                        </tr>
                                            <tr>
                                                <td style="width: 20%; height: 22px; text-align: right;">
                                                    <asp:Label ID="Label4" runat="server" Text="开始日期"></asp:Label></td>
                                                <td align="right" style="width: 10%; height: 22px; text-align: left">
                                                    <asp:TextBox ID="txtStartDate" runat="server" CssClass="textstyle" onclick="calendar()"></asp:TextBox></td>
                                                <td style="width: 20%; height: 22px;text-align: right;">
                                                    <asp:Label ID="Label5" runat="server" Text="结束日期" ></asp:Label></td>
                                                ...
                                                <td align="left" style="width: 20%; height: 22px; padding-left:10px">
                                            <asp:Button ID="Button1" runat="server" CssClass="buttonQuery" OnClick="btnQuery_Click"
                                                    ...
                                                    <tr>
                                                        <td style="left: 7px; vertical-align: top; width: 100%; position: relative; text-align: center">
                                                            <asp:GridView ID="GrdCust" runat="server" BorderWidth="1px" BorderStyle="Inset" 
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField DataField="GiftDesc" HeaderText="赠品名称">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="GiftTypeName" HeaderText="兑换类型">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="ActDate" HeaderText="兑换日期" DataFormatString="{0:d}" HtmlEncode="False">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="GiftQty" HeaderText="兑换数量">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="RedeemAmt" HeaderText="兑换积分">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                </Columns>
...
<PagerSettings Mode="NextPreviousFirstLast"  />
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 22px; width: 272px;" class="tdBackColor">
                                        </td>
                                        <td style="vertical-align: top; width: 270px; height: 44px; text-align: left;" class="tdBackColor"
                                            colspan="4">
                                            <table style="width: 180px" cellspacing="0" cellpadding="0" border="0">
                                                <tbody>
                                                    <tr>
