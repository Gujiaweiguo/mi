<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GiftStockQuery.aspx.cs" Inherits="Associator_GiftStockQuery" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
	    function Load()
	    {
	        ...
	        addTabTool("<%= baseInfo %>,Associator/GiftStockQuery.aspx");
	        loadTitle();
	    }
    </script>
</head>
                        ...
                        <table id="TABLE0" border="0" cellpadding="0" cellspacing="0" style="height: 24px;
                            ...
                            <tr>
                                ...
                                <td class="tdTopBackColor">
                                    <asp:Label ID="Label2" runat="server" Text="赠品库存信息"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
                                                    ...
                                                    <tr>
                                                        <td style="left: 7px; vertical-align: top; width: 100%; position: relative; text-align: center">
                                                            <asp:GridView ID="GrdCust" runat="server" BorderWidth="1px" BorderStyle="Inset" 
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField DataField="StockID">
                                                                    ...
                                                                    <asp:BoundField DataField="CounterDesc" HeaderText="服务台">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="StockCnt" HeaderText="数量">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="RefPrice" HeaderText="价格">
                                                                        <HeaderStyle CssClass="gridviewtitle" BackColor="#E1E0B2" BorderColor="#E1E0B2" />
                                                                        <ItemStyle BorderColor="#E1E0B2" />
                                                                    </asp:BoundField>
...
<PagerSettings Mode="NextPreviousFirstLast"  />
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 137px; height: 12px" class="tdBackColor" align="center">
                                        <asp:Label
                                                    ID="lblTotalNum" runat="server"></asp:Label><asp:Label ID="lblCurrent" runat="server" ForeColor="Red">1</asp:Label>
                                            </td>
