<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopAttrOperate.aspx.cs" Inherits="VisualAnalysis_ShopAttrOperate" %>
...
<head id="Head1" runat="server">
   ...
   var tabbar;
    ...
    function ShowTitle()
    {
        ...
        addTabTool("<%=baseinfo %>,VisualAnalysis/ShopAttrOperate.aspx");
        loadTitle();
    }
    function NumberTest()
    {
                          ...
                          <td style="vertical-align:top; height: 22px; width: 100%;" >          
                                 <table border="0" cellpadding="0" cellspacing="0" style="height: 22px; width:100%;   ">              
                                    <tr>
                                        ...
                                        <asp:Label ID="labUserTree" runat="server" CssClass="lblTitle" Text='<%$ Resources:BaseInfo,ShopXml_ShopAttrVindicate%>'></asp:Label></td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="height: 450px; width:98%; vertical-align:top; " >
                        ...
                        <tr>
                            <td style=" width:200px;  background-color: #e1e0b2; height: 12px; text-align: right;" align="right">                           
                                <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ShopXml_NoX %>"></asp:Label>&nbsp;</td>
                            <td style="width: 145px; height: 12px; background-color: #e1e0b2; text-align: left">
                                <asp:TextBox ID="txtNoX"  runat="server"  CssClass="ipt160px" Width="120px" MaxLength="64" OnKeyPress="NumberTest()"></asp:TextBox></td>
                            <td style="height: 12px; background-color: #e1e0b2; text-align: right">
                                <asp:Label ID="Label2" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ShopXml_NoY %>"></asp:Label>&nbsp;</td>
                            <td style="width:145px;  background-color: #e1e0b2; text-align: left; height: 12px;"> 
                                <asp:TextBox ID="txtNoY" runat="server" CssClass="ipt160px" Width="120px" OnKeyPress="NumberTest()"></asp:TextBox></td>
                        ...
                        <tr >
                            <td align="right" style="vertical-align:middle width: 197px; background-color: #e1e0b2; width: 200px; height: 36px; text-align: right;">
                                <asp:Label ID="Label1" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ShopXml_NameX %>"
                                    Width="80px"></asp:Label>&nbsp;</td>
                            <td style="height: 36px; background-color: #e1e0b2; text-align: left">
                                <asp:TextBox ID="txtNameX" runat="server" CssClass="ipt160px" Width="120px" MaxLength="64" OnKeyPress="NumberTest()"></asp:TextBox></td>
                            <td style="width: 200px; height: 36px; background-color: #e1e0b2; text-align: right">
                                <asp:Label ID="Label5" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ShopXml_NameY %>"
                                    Width="80px"></asp:Label>&nbsp;</td>
                            <td style="vertical-align:middle width: 145px; background-color: #e1e0b2; text-align: left; height: 36px;">
                                <asp:TextBox ID="txtNameY" runat="server" CssClass="ipt160px" Width="120px" MaxLength="64" OnKeyPress="NumberTest()"></asp:TextBox></td>
                        </tr>
                        <tr >
