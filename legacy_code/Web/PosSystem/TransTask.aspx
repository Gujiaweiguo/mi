<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransTask.aspx.cs" Inherits="PosSystem_TransTask" %>
...
function Load()
	   {
	        addTabTool("<%=baseInfo %>,PosSystem/TransTask.aspx~<%=source %>,PosSystem/TransTaskResource.aspx~<%=planTask %>,PosSystem/TransTaskPlan.aspx");
	        loadTitle();
	   }

    //text控件文本验证
    function textBoxEmCheck()
    {
        if(isEmpty(document.all.txtTaskName.value))  
        {
            parent.document.all.txtWroMessage.value="任务名称不能为空!";
            document.all.txtTaskName.focus();
            return false;					
        }
    }
    function BtnUp( p )
                                ...
                                <tr>
                                    <td class="tdTopBackColor" valign="top">
                                        <img alt="" class="imageLeftBack" /><asp:Label
                                                ID="labAreaTitle" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,Store_TaskManage %>"></asp:Label><a
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" 
                                            ...
                                            <tr>
                                                <td style="text-align: right" class="style3">
                                                    <asp:Label ID="labTaskType" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Store_TaskType %>"
                                                        Width="90px"></asp:Label></td>
                                                <td style="height: 24px; width: 5px;">
                                                    &nbsp;</td>
                                                <td style="width: 194px; height: 28px; text-align: left">
                                                    <asp:DropDownList ID="ddlTaskType" runat="server" CssClass="cmb150px">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr style="height: 6px;">
                                            ...
                                            <tr>
                                                <td style="text-align: right" class="style3">
                                                    <asp:Label ID="lblProcessClass" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Store_ProcessClass %>"
                                                        Width="90px"></asp:Label></td>
                                                <td style="height: 24px; width: 5px;">
                                                    &nbsp;</td>
                                                <td style="width: 194px; height: 28px; text-align: left">
                                                    <asp:DropDownList ID="ddlProcessClass" runat="server" CssClass="cmb150px"></asp:DropDownList></td>
                                            </tr>
                                            <tr style="height: 6px;">
                                            ...
                                            <tr>
                                                <td style="text-align: right" class="style3">
                                                    <asp:Label ID="lblRetry" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Store_RetryMark %>"
                                                        Width="90px"></asp:Label></td>
                                                <td style="height: 24px; width: 5px;">
                                                   </td>
                                                <td style="width: 194px; text-align: left" rowspan="1">
                                                    <asp:RadioButton ID="rbtRetryYes" runat="server" 
                                                        Text="<%$ Resources:BaseInfo,Associator_rdoYes %>" 
                                                        GroupName="retry"/>
                                                    <asp:RadioButton ID="rbtRetryNo" runat="server" 
                                                        Text="<%$ Resources:BaseInfo,Associator_rdoNo %>" 
                                                        GroupName="retry" Checked="True"/>
                                                </td>
                                            </tr>
                                            <tr style="height: 6px;">
                                            ...
                                            <tr>
                                                <td style="text-align: right" class="style3">
                                                    <asp:Label ID="lblTaskStatus" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,User_lblUserStatusStr %>"
                                                        Width="90px"></asp:Label></td>
                                                <td style="width: 5px; height: 24px">
                                                </td>
                                                <td rowspan="1" style="width: 194px; text-align: left">
                                                    <asp:DropDownList ID="ddlTaskStatus" runat="server" CssClass="cmb150px">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr style="height: 6px;">
                                            ...
                                            <tr>
                                                <td style="text-align: right" class="style3">
                                                    <asp:Label ID="lblPriority" runat="server" 
                                                        Text="<%$ Resources:BaseInfo,Store_Priority %>" CssClass="labelStyle"></asp:Label>
                                                </td>
                                                <td style="width: 5px; height: 24px">
                                                </td>
                                                <td rowspan="1" style="width: 194px; text-align: left">
                                                    <asp:DropDownList ID="ddlPriority" runat="server" CssClass="cmb150px">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr style="height: 6px;">
                                            ...
                                            <tr>
                                                <td style="text-align: right" class="style3">
                                                    <asp:Label ID="lblNote" runat="server" CssClass="labelStyle" 
                                                        Text="<%$ Resources:BaseInfo,AreaSize_lblNote %>" Width="90px"></asp:Label>
                                                </td>
                                                <td style="width: 5px; height: 24px">
                                                </td>
                                                <td rowspan="1" style="width: 194px; text-align: left">
