...
function getStepHTML(stepType,z_index,id,text,textColor,strokeColor,shadowColor,isShadow,width,height,X,Y,strokeWeight,textWeight,color1,color2,is3D,step3DDepth){
   ...
   var stepHTML = '';
   var styleHTML = 'id='+id+' title="'+id+'" style="z-index:'+z_index+';position:absolute;width:'+width+';height:'+height+';left:'+X+';top:'+Y+';onmouseover=\'this.style.cursor="hand";\' onmousedown=\'cleancontextMenu();objFocusedOn(this.id,"'+stepType+'");moveStep(this);\' oncontextmenu=\'objFocusedOn(this.id,"'+stepType+'");stepContextMenu("'+id+'","'+stepType+'");return false;\'';
   var textStyleHTML = 'style="text-align:center; color:'+textColor+'; font-size:11pt;"';
   ...
   if(stepType=='BeginStep' ){
  
	   stepHTML = '<v:image id="'+id+'" title="'+id+'" src="../App_Themes/JS/Start.gif" style="z-index:'+z_index+';position:relative;left:'+X+';top:'+Y+';width:70px;height:100px" onmouseover=\'this.style.cursor="hand";\' onmousedown=\'cleancontextMenu();objFocusedOn(this.id,"'+stepType+'");moveStep(this);\' oncontextmenu=\'objFocusedOn(this.id,"'+stepType+'");stepContextMenu("'+id+'","'+stepType+'");return false;\'/>';
   }else if(stepType=='EndStep')
   {
   stepHTML = '<v:image id="'+id+ '" title="'+id+'" src="../App_Themes/JS/End.gif" style="z-index:'+z_index+';position:relative;left:'+X+';top:'+Y+';width:70px;height:100px" onmouseover=\'this.style.cursor="hand";\' onmousedown=\'cleancontextMenu();objFocusedOn(this.id,"'+stepType+'");moveStep(this);\' oncontextmenu=\'objFocusedOn(this.id,"'+stepType+'");stepContextMenu("'+id+'","'+stepType+'");return false;\'/>';
   }
   else{
        stepHTML='<v:image id="'+id+ '" title="'+id+'" src="../App_Themes/JS/Node.png" style="z-index:'+z_index+';position:relative;left:'+X+';top:'+Y+';width:170px;height:100px" onmouseover=\'this.style.cursor="hand";\' onmousedown=\'cleancontextMenu();objFocusedOn(this.id,"'+stepType+'");moveStep(this);\' oncontextmenu=\'objFocusedOn(this.id,"'+stepType+'");stepContextMenu("'+id+'","'+stepType+'");return false;\'><v:TextBox inset="2pt,5pt,2pt,5pt" '+textStyleHTML+'>'+text+'</v:TextBox></v:image>';
