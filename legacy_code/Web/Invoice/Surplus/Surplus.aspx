<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Surplus.aspx.cs" Inherits="Invoice_Surplus_Surplus" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Invoice_lblSurBal")%></title>
    ...
    <style type="text/css">
      ...
      <!--
            function GetSurBalAmt()
            {
                if((document.getElementById("txtSurAmtL").value != "undefined")&&(document.getElementById("txtSurAmtL").value != "")&&(document.getElementById("txtPayOutAmtSum").value != "undefined")&&(document.getElementById("txtPayOutAmtSum").value != ""))
                {
                    document.getElementById("txtSurBalAmtL").value = document.getElementById("txtSurAmtL").value - document.getElementById("txtPayOutAmtSum").value
                }
            }
        ...
        {   
	     ...
	     function Load()
        {
            addTabTool("<%=baseInfo %>,Invoice/Surplus/Surplus.aspx");
            loadTitle();
        }
        -->
      </script>
            ...
            <ContentTemplate>
                <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Invoice_lblSurBal %>" Height="12pt" Width="218px"></asp:Label>
                        </td>
                            ...
                            <table style="width:100%"  border="0" cellpadding="0" cellspacing="0" class="payPutOut">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" rowspan="4" valign="top" style="text-align: right; padding-right:15px">
                                        <asp:GridView ID="gdvwSurplus" runat="server" AutoGenerateColumns="False" BackColor="White"
                                            BorderColor="#E1E0B2" Width="310px" PageSize="4" OnSelectedIndexChanged="gdvwSurplus_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="gvShopBrand_OnPageIndexChanging">
                                            <Columns>
                                                <asp:BoundField DataField="SurID" HeaderText="SurID">
                                                    <ItemStyle CssClass="hidden" />
                                                    <HeaderStyle CssClass="hidden" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="BillID" HeaderText="<%$ Resources:BaseInfo,Invoice_lblSurBalInvID %>">
                                                ...
                                                <asp:BoundField DataField="SurAmt" HeaderText="<%$ Resources:BaseInfo,Invoice_lblSurAmt %>">
                                                    <ItemStyle BorderColor="#E1E0B2" HorizontalAlign="Center" CssClass="gridviewtitle" />
                                                    <HeaderStyle BackColor="#E1E0B2" BorderColor="#E1E0B2" HorizontalAlign="Center" CssClass="gridviewtitle" />
                                                </asp:BoundField>
...
<PagerSettings Mode="NextPreviousFirstLast"  />
                                ...
                                <tr class="rowHeight">
                                    <td style="width: 142px" class="baseLable">
                                        <asp:Label ID="Label7" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Invoice_lblSurBalInvID %>"></asp:Label></td>
                                    <td style="width: 114px">
                                        <asp:TextBox ID="txtBillID" runat="server" CssClass="ipt160px" BackColor="#F5F5F4" Enabled="False"></asp:TextBox></td>
                                    <td style="width: 69px">
                                    </td>
                                </tr>
                                <tr class="rowHeight">
                                    <td style="width: 142px; height: 39px;" class="baseLable">
                                        <asp:Label ID="Label8" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Invoice_lblSurAmt %>"></asp:Label></td>
                                    <td style="width: 114px; height: 39px">
                                        <asp:TextBox ID="txtSurAmtL" runat="server" CssClass="ipt160px" BackColor="#F5F5F4" ReadOnly="True"></asp:TextBox></td>
                                    <td style="width: 69px; height: 39px">
                                    </td>
                                </tr>
                                <tr class="rowHeight">
                                    <td style="width: 142px; height: 28px;" class="baseLable">
                                        <asp:Label ID="Label9" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_InvDate %>"></asp:Label></td>
                                    <td style="width: 114px; height: 28px;">
                                        <asp:TextBox ID="txtSurDate" runat="server" CssClass="ipt160px" BackColor="#F5F5F4" Enabled="False"></asp:TextBox></td>
                                    <td style="width: 69px; height: 28px;">
                                    </td>
                                    <td style="text-align: right; padding-right:15px" colspan="2" rowspan="4" valign="top">
                                        <asp:GridView ID="gdvwInvHeader" runat="server" AutoGenerateColumns="False" BackColor="White"
                                            BorderColor="#E1E0B2" Width="312px" PageSize="4" AllowPaging="True" OnPageIndexChanging="gvShopBrand_OnPageIndexChanging">
                                            <Columns>
                                ...
                                <tr>
                                    <td style="width: 142px" class="baseLable">
                                        <asp:Label ID="Label10" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Invoice_lblTotalSurBalAmt %>"></asp:Label></td>
                                    <td style="width: 114px">
                                        <asp:TextBox ID="txtPayOutAmtSum" runat="server" CssClass="ipt160px" BackColor="#F5F5F4" ReadOnly="True"></asp:TextBox></td>
                                    <td style="width: 69px">
                                    </td>
                                </tr>
                                <tr class="rowHeight">
                                    ...
                                    <td style="width: 114px"><asp:DropDownList ID="dropSurBalType" runat="server" Width="167px">
                                    </asp:DropDownList></td>
                                    <td style="width: 69px">
                                    </td>
                                </tr>
                                <tr class="rowHeight">
                                    ...
                                    <td style="width: 114px">
                                        <asp:TextBox ID="txtSurBalAmtL" runat="server" CssClass="ipt160px" style="ime-mode:disabled;"></asp:TextBox></td>
                                    <td style="width: 69px">
                                    </td>
                                </tr>
