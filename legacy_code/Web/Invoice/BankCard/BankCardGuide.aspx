<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BankCardGuide.aspx.cs" Inherits="Invoice_BankCard_BankCardGuide" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "BankCard_Transmit")%></title>
    ...
    function Load()
    {
        addTabTool("<%=baseInfo %>,Invoice/BankCard/BankCardGuide.aspx");
        loadTitle();
    }
    </script>
</head>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="height: 401px; width: 100%;">
                                    <tr>
                                        <td align="left" class="tdTopRightBackColor" style="width: 356px; height: 22px; text-align: left; vertical-align: top;">
                                            ...
                                            <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,BankCard_Transmit %>" Width="295px"></asp:Label></td>
