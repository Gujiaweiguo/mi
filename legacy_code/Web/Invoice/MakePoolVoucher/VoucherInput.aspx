<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoucherInput.aspx.cs" Inherits="Invoice_MakePoolVoucher_VoucherInput" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "MakePoolVoucher_VoucherInput")%></title>
    ...
    function Load()
    {
        addTabTool("<%=strFresh %>,Invoice/MakePoolVoucher/VoucherInput.aspx");
        loadTitle();
    }
    </script>
</head>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="height: 401px; width: 100%;">
                                    <tr>
                                        <td align="left" class="tdTopRightBackColor" style="width: 356px; height: 22px; text-align: left; vertical-align: top;">
                                            ...
                                            <asp:Label ID="Label31" runat="server" Text="<%$ Resources:BaseInfo,MakePoolVoucher_VoucherInput %>" Width="295px"></asp:Label></td>
                                        ...
                                        <td class="tdBackColor" colspan="3" style="width: 655px; height: 339px" valign="top">
                                            <table border="0" cellpadding="0" cellspacing="0" style="height: 129px;">
                                              ...
                                              <td valign="top" style="width: 10%; height: 26px; text-align: right; vertical-align: middle;">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:BaseInfo,VoucherInput＿lblFType %>" CssClass="labelStyle"></asp:Label>
                                                        &nbsp;
                                              </td>
                                                <td style="vertical-align: top; height: 26px;"　width="50%">
                                                        <asp:DropDownList ID="cmbFinancialType" runat="server" Width="165px">
                                                        </asp:DropDownList>
                                                                </td>
                                                </tr>
                                                <tr>
