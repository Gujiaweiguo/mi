<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptADContractInfo.aspx.cs" Inherits="ReportM_RptBase_RptADContractInfo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("刷新,ReportM/RptBase/RptADContractInfo.aspx");
	        loadTitle();
	    }
	    </script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_ADContractInfo %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label11" runat="server" CssClass="labelStyle" 
                                                            Text="<%$ Resources:BaseInfo,Contract_ManageCompany %>"></asp:Label>
                                                    </td>
                                                    <td style="width: 218px">
                                                        <asp:DropDownList ID="ddlSubsID" runat="server" Width="165px" >
                                                        </asp:DropDownList></td>
