<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptContractSumInfo.aspx.cs" Inherits="RptBaseMenu_RptContractSumInfo" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript" src="../../JavaScript/TabTools.js"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=fresh %>,ReportM/RptBase/RptContractSumInfo.aspx");
	        loadTitle();
	    }
        </script>
</head>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left; height: 28px;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_ContractInformationSummary %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px; height: 28px;" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px"><asp:DropDownList ID="ddlBizproject" runat="server" Width="165px" >
                                                    </asp:DropDownList></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td style="width: 252px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px; height: 28px; text-align: right;">
                                                        <asp:Label ID="Label12" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_lblHireType %>" Visible="False"></asp:Label></td>
                                                    <td style="width: 218px; height: 28px;">
                                                        &nbsp;<asp:RadioButton ID="RBRent" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,AdContract_rbtnFastness %>" CssClass="labelStyle" Visible="False"/><asp:RadioButton ID="RBJoin" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,Rpt_rdoFormula %>" CssClass="labelStyle" Visible="False"/><asp:RadioButton ID="RBAll" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,Rpt_rdoAll %>" Checked="True" CssClass="labelStyle" Visible="False"/></td>
                                                    <td style="width: 44px; height: 28px;">
                                                        <br />
                                                        <br />
                                                        <br />
