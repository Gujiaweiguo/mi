<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptUnitInfo.aspx.cs" Inherits="RptBaseMenu_RptUnitInfo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "Rpt_Title_lblUnitInfo")%></title>
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=strFresh %>,ReportM/RptBase/RptUnitInfo.aspx");
	        loadTitle();
	    }
	</script>
</head>
            ...
            <ContentTemplate>
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px"><asp:RadioButton ID="rdoLeaseOut" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,RentableArea_LeaseOut %>" CssClass="labelStyle" Checked="True"/></td>
                                                    <td style="width: 44px">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtUnitCode" runat="server" CssClass="ipt160px" MaxLength="16"></asp:TextBox></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:DropDownList ID="ddlBizproject" runat="server" AutoPostBack="True" Width="165px" OnSelectedIndexChanged="ddlBizproject_SelectedIndexChanged">
                                                        </asp:DropDownList></td>
                                                    <td align="right" class="lable" style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:DropDownList ID="ddlFloorName" runat="server" Width="165px" OnSelectedIndexChanged="ddlFloorName_SelectedIndexChanged">
                                                        </asp:DropDownList></td>
                                                    <td align="right" class="lable" style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:Button ID="btnQuery" runat="server" CssClass="buttonQuery" OnClick="btnOK_Click"
                                                            onmouseout="BtnUp(this.id);" onmouseover="BtnOver(this.id);" 
                                                            onmouseup="BtnUp(this.id);" Text="<%$ Resources:BaseInfo,User_lblQuery %> " />
                                                        <asp:Button ID="BtnCancel" runat="server" CssClass="buttonCancel" OnClick="BtnCancel_Click"
                                                            onmouseout="BtnUp(this.id);" onmouseover="BtnOver(this.id);" 
                                                            onmouseup="BtnUp(this.id);" Text="<%$ Resources:BaseInfo,User_btnCancel %> " />
                                                    </td>
                                                    <td style="width: 44px">
                                                        <asp:Label ID="Label5" runat="server" CssClass="labelStyle" 
                                                            Text="<%$ Resources:BaseInfo,RentableArea_lblLocationName %>" Visible="False"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlLocationName" runat="server" Visible="False" 
                                                            Width="165px">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
