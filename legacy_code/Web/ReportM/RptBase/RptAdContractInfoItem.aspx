<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAdContractInfoItem.aspx.cs" Inherits="ReportM_RptBase_RptAdContractInfoItem" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("刷新,ReportM/RptBase/RptAdContractInfoItem.aspx");
	        loadTitle();
	    }
	    </script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_BillboardContractInformationList %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label12" runat="server" CssClass="labelStyle" 
                                                            Text="<%$ Resources:BaseInfo,Rpt_lblHireType %>"></asp:Label>
                                                    </td>
                                                    <td style="width: 218px">
                                                        <asp:RadioButton ID="RBRent" runat="server" CssClass="labelStyle" GroupName="a" 
                                                            Text="<%$ Resources:BaseInfo,AdContract_rbtnFastness %>" />
                                                        <asp:RadioButton ID="RBJoin" runat="server" CssClass="labelStyle" GroupName="a" 
                                                            Text="<%$ Resources:BaseInfo,Rpt_rdoFormula %>" />
                                                        <asp:RadioButton ID="RBAll" runat="server" Checked="True" CssClass="labelStyle" 
