<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAreaContractInfoItem.aspx.cs" Inherits="RptBaseMenu_RptAreaContractInfoItem" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
     <script language="javascript" type="text/javascript" src="../../JavaScript/TabTools.js"></script>
        ...
        function Load()
	    {
	        addTabTool("刷新,ReportM/RptBase/RptAreaContractInfoItem.aspx");
	        loadTitle();
	    }
	</script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo, Rpt_Title_lblAreaContractInfoItem %>" style="position: static"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:BaseInfo,Rpt_AreaAdContractCode %>" CssClass="labelStyle"></asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        ...
                                                        <asp:Button ID="BtnCel" runat="server" CssClass="buttonCancel" 
                                                            Text="<%$ Resources:BaseInfo,User_btnCancel %> " Width="61px" />
                                                        </td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl"><td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label4" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LeaseholdContract_labContractStatus %>" Visible="False"></asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label10" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_SignDate %>" Visible="False"></asp:Label></td>
                                                    <td style="width: 218px">
                                                        &nbsp;
                                                        <asp:TextBox ID="txtSignDate" runat="server" CssClass="ipt160px" onclick="calendar()" Visible="False"></asp:TextBox></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
                                                        </td>
