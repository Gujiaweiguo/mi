<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractRptQuery.aspx.cs" Inherits="ReportM_ContractRptQuery" %>
                                    ...
                                    <tr style="height: 28px">
                                        <td valign="top">
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_Title_lblContractInfo %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label10" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Dept_rbtnAllVocation %>"></asp:Label></td>
                                                    <td style="width: 218px">
                                                        <asp:DropDownList ID="ddl" runat="server" Width="165px">
                                                        </asp:DropDownList></td>
                                                    <td align="right" class="lable" style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label11" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LeaseholdContract_labTradeID %>"></asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtConStartDate" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:RadioButton ID="RadioButton1" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,AdContract_rbtnFastness %>"/>
                                                        <asp:RadioButton ID="RadioButton3" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,Rpt_rdoFormula %>"/>
                                                        <asp:RadioButton ID="RadioButton2" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,Rpt_rdoAll %>"/></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
