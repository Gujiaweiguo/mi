...
public partial class ReportM_RptGroup_RptStoreIncomeZLSum : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            pageTitle = (String)GetGlobalResourceObject("BaseInfo", "Menu_StoreIncomeZLSum");
        }
    }
    ...
    private void BindData()
    {
        ...
        discreteValue[0].Value = (String)GetGlobalResourceObject("BaseInfo", "Menu_StoreIncomeZLSum");
        ...
        {
            where += " and invperiod <='" + txtPeriod.Text.Trim() + "' ";
        }
