<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptCompanyBudgetIncomeSum.aspx.cs" Inherits="ReportM_RptInv_RptCompanyBudgetIncomeSum" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Common.js"></script>
     <script language="javascript" type="text/javascript" src="../../JavaScript/TabTools.js"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptGroup/RptCompanyBudgetIncomeSum.aspx");
	        loadTitle();
	    }
	</script>
</head>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_CompanyBudgetIncomeSum %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:DropDownList ID="ddlMonth" runat="server" Width="165px">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td style="width: 44px">
