<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptStoreIncomeZLAnalyse.aspx.cs" Inherits="ReportM_RptGroup_RptStoreIncomeZLAnalyse" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/setPeriod.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptGroup/RptStoreIncomeZLAnalyse.aspx");
	        loadTitle();
	    }
	</script>
</head>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_StoreIncomeZLAnalyse %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:RadioButton ID="rbtSum" runat="server" Text="<%$ Resources:BaseInfo,Rpt_StoreRentInfoDetail %>" AutoPostBack="True" Checked="True" GroupName="aa" OnCheckedChanged="rbtSum_CheckedChanged"/>
                                                        <asp:RadioButton ID="rbtDetail" runat="server" Text="<%$ Resources:BaseInfo,Rpt_DetailReport %>" AutoPostBack="True" GroupName="aa" OnCheckedChanged="rbtDetail_CheckedChanged"/></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
                                                    </td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label4" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Contract_ManageCompany %>">
                                            </asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LeaseAreaType_CustCode %>"></asp:Label></td>
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtCustCode" runat="server" CssClass="ipt160px" Width="160px" MaxLength="32"></asp:TextBox></td>
                                                    <td style="width: 44px">
                                                        </td>
                                                    <td>
                                                        </td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label5" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Account_lblChargeType %>" Visible="False"></asp:Label></td>
                                                    <td style="width: 218px">
                                                        <asp:DropDownList ID="ddlChargeType" runat="server" Width="165px" Visible="False">
                                                        </asp:DropDownList></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
