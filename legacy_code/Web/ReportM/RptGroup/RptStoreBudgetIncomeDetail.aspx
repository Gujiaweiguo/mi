<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptStoreBudgetIncomeDetail.aspx.cs" Inherits="ReportM_RptInv_RptStoreBudgetIncomeDetail" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Common.js"></script>
     <script language="javascript" type="text/javascript" src="../../JavaScript/TabTools.js"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptGroup/RptStoreBudgetIncomeDetail.aspx");
	        loadTitle();
	    }
	</script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_StoreBudgetIncomeDetail %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
