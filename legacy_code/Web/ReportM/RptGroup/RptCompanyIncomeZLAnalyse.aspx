<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptCompanyIncomeZLAnalyse.aspx.cs" Inherits="ReportM_RptGroup_RptCompanyIncomeZLAnalyse" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/setPeriod.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptGroup/RptCompanyIncomeZLAnalyse.aspx");
	        loadTitle();
	    }
	</script>
</head>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_CompanyIncomeZLAnalyse %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:RadioButton ID="rbtSum" runat="server" 
                                                            Text="<%$ Resources:BaseInfo,Rpt_StoreRentInfoDetail %>" AutoPostBack="True" 
                                                            Checked="True" GroupName="aa" OnCheckedChanged="rbtSum_CheckedChanged" 
                                                            Font-Size="Small"/>
                                                        <asp:RadioButton ID="rbtDetail" runat="server" 
                                                            Text="<%$ Resources:BaseInfo,Rpt_DetailReport %>" AutoPostBack="True" 
                                                            GroupName="aa" OnCheckedChanged="rbtDetail_CheckedChanged" Font-Size="Small"/></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
                                                    </td>
