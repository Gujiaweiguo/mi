<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceAreaPara.aspx.cs" Inherits="ReportM_InvoicePara_InvoiceAreaPara" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "InvoiceAreaPara_Title")%></title>
	...
	<script type="text/javascript">
      <!--	    
	     function Load()
        {
            addTabTool("<%=baseInfo %>,ReportM/InvoicePara/InvoiceAreaPara.aspx");
            loadTitle();
           ...
           <table border="0" cellpadding="0" cellspacing="0" style="height: 301px; width: 100%;" width="500">
            <tr>
                <td class="tdTopBackColor" style="width: 478px; height: 25px" valign="top">
                    ...
                    <asp:Label ID="labBuildingTitle" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,InvoiceAreaPara_Title %>"></asp:Label></td>
      ...
      <tr>
        <td rowspan="10" align="right" style="width: 22%; vertical-align: top;">
            ...
            <asp:GridView ID="gvInvoicePara" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="InvoiceAreaParaID">
