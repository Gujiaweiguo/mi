<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceJVPara.aspx.cs" Inherits="ReportM_InvoicePara_InvoiceJVPara" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title><%= (String)GetGlobalResourceObject("BaseInfo", "InvoicePara_TitleUnion")%></title>
...
<body topmargin=0 leftmargin=0 onload='Load()'>
           ...
           <table border="0" cellpadding="0" cellspacing="0" style="height: 301px; width: 100%;" width="500">
            <tr>
                <td class="tdTopBackColor" style="width: 478px; height: 25px" valign="top">
                    ...
                    <asp:Label ID="labBuildingTitle" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,InvoicePara_TitleUnion %>"></asp:Label></td>
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td rowspan="10" style="width: 30%; left: 12px; position: relative;">            
            <asp:GridView ID="gvInvoicePara" runat="server" AutoGenerateColumns="False"
                ...
                Width="100%" OnRowDataBound="gvInvoicePara_RowDataBound" AllowPaging="True">
                <Columns>
                    <asp:BoundField DataField="InvoiceJVParaID">
        ...
        <td height="30" align="center" style="width: 470px; text-align: left;">
            <asp:TextBox ID="txtInvHeader" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
      </tr>
      <tr>
        <td align="right"><span class="STYLE1">
        ...
        <td height="30" align="center" style="width: 470px; text-align: left;">
            <asp:TextBox ID="txtInvSubhead" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
      </tr>
      <tr>
        ...
        <td align="center" style="width: 470px; vertical-align: top; text-align: left;" rowspan="5"><table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="30" align="center" style="width: 460px; text-align: left">
                    <asp:TextBox ID="txtInvH1" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
                <td height="30" align="center" style="width: 460px; text-align: left">
                    <asp:TextBox ID="txtInvH2" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
                <td align="center" style="width: 460px; text-align: left">
                    <asp:TextBox ID="txtInvH3" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
                <td height="30" align="center" style="width: 460px; text-align: left">
                    <asp:TextBox ID="txtInvH4" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
                <td align="left" style="width: 460px; height: 30px">
                    <asp:TextBox ID="txtInvH5" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
        </table>
        </td>
      </tr>
        ...
        <td height="30" style="width: 470px; text-align: left;"><table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
              <td height="30" align="left">
                  <asp:TextBox ID="txtInvF1" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
                <td height="30" align="left">
                    <asp:TextBox ID="txtInvF2" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
                <td align="left" style="height: 30px">
                    <asp:TextBox ID="txtInvF3" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
                <td height="30" align="left">
                    <asp:TextBox ID="txtInvF4" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
                <td height="30" align="left">
                    <asp:TextBox ID="txtInvF5" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
              <td height="30" align="left">
                  <asp:TextBox ID="txtInvF6" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
            <tr>
              <td align="left" style="height: 30px">
                  <asp:TextBox ID="txtInvF7" runat="server" CssClass="ipt160px" Width="440px" MaxLength="64"></asp:TextBox></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td height="30" align="left" style="width: 470px">
            <asp:TextBox ID="txtInvoiceParaDesc" runat="server" CssClass="ipt160px" Width="440px" MaxLength="32"></asp:TextBox></td>
      </tr>
      <tr>
  ...
  <tr>
    <td style="height: 23px"><hr />
        &nbsp;</td>
            ...
            <tr>
                <td style="width:478px; height:43px; text-align:right;"  class="tdBackColor" valign="top">
                </td>
                <td style="width:10px; height:43px; text-align:right;"  class="tdBackColor" valign="top">
                    </td>
                <td style="width:300px; height:43px; text-align:center;"  class="tdBackColor" valign="top">
                    &nbsp;&nbsp;
