<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptShopSalesVSMemberSales.aspx.cs" Inherits="ReportM_RptMember_RptShopSalesVSMemberSales" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptMember/RptShopSalesVSMemberSales.aspx");
	        loadTitle();
	    }
	</script>
</head>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_ShopSalesVSMemberSales %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:DropDownList ID="ddlFloorName" runat="server" Width="60px">
                                                    </asp:DropDownList><asp:DropDownList ID="DropDownList1" runat="server" Width="85px">
                                                        </asp:DropDownList></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px; height: 28px;"></td>
                                                    <td style="width: 44px; height: 28px;" class="lable" align="right">
                                                        </td>
