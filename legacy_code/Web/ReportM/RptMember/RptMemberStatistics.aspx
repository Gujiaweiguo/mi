<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptMemberStatistics.aspx.cs" Inherits="ReportM_RptMember_RptMemberStatistics" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptMember/RptMemberStatistics.aspx");
	        loadTitle();
	    }
	</script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_MemberStatistics %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:BaseInfo,Associator_lblQueryCondition %>" CssClass="labelStyle"></asp:Label></td>
                                                    <td style="width: 218px"><asp:RadioButton ID="rdoLeaseOut" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,Mem_ByYear %>" CssClass="labelStyle"/></td>
                                                    <td style="width: 44px">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px"><asp:RadioButton ID="rdoNoLeaseOut" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,Mem_ByMonth %>" CssClass="labelStyle" /></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px"><asp:RadioButton ID="rdoBlankOut" runat="server" GroupName="a" Text="<%$ Resources:BaseInfo,RentableArea_BlankOut %>" CssClass="labelStyle" Visible="False"/></td>
                                                    <td style="width: 44px">
                                                        </td>
                                                    <td>
