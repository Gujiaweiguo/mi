<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptMemberExTrans.aspx.cs" Inherits="ReportM_RptMember_RptMemberExTrans" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript" src="../../JavaScript/TabTools.js"></script>
        ...
        function Load()
	    {
	        addTabTool("小票换礼品查询,ReportM/RptMember/RptMemberExTrans.aspx");
	        loadTitle();
	    }
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="小票换礼品查询"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
