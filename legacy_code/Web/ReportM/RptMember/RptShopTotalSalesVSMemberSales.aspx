<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptShopTotalSalesVSMemberSales.aspx.cs" Inherits="ReportM_RptMember_RptShopTotalSalesVSMemberSales" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptMember/RptShopTotalSalesVSMemberSales.aspx");
	        loadTitle();
	    }
	</script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_ShopTotalSalesVSMemberSales %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:BaseInfo,RentableArea_lblBuildingCode %>" CssClass="labelStyle"></asp:Label></td>
                                                    <td style="width: 218px"><asp:DropDownList ID="ddlLocationName" runat="server" Width="165px">
                                                    </asp:DropDownList></td>
                                                    <td style="width: 44px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblFloorCode %>"></asp:Label></td>
                                                    <td style="width: 218px"><asp:DropDownList ID="DropDownList1" runat="server" Width="165px">
                                                    </asp:DropDownList></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label4" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblLocationCode %>"></asp:Label></td>
                                                    <td style="width: 218px"><asp:DropDownList ID="DropDownList2" runat="server" Width="165px">
                                                    </asp:DropDownList></td>
                                                    <td style="width: 44px">
                                                        </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label7" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblAreaCode %>"></asp:Label></td>
                                                    <td style="width: 218px"><asp:DropDownList ID="DropDownList3" runat="server" Width="165px">
                                                    </asp:DropDownList></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label9" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblTradeRelation %>"></asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label5" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_EDate %>"></asp:Label></td>
                                                    <td style="width: 218px">
