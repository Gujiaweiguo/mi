<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptMemberBonusComparison.aspx.cs" Inherits="ReportM_RptMember_RptMemberBonusComparison" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptMember/RptMemberBonusComparison.aspx");
	        loadTitle();
	    }
	</script>
</head>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_MemberBonusComparison %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtStartDateF" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                                    <td style="width: 44px">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtEndDateF" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                                    <td style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label5" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblLocationName %>"></asp:Label></td>
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtStartDateS" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                                    <td style="width: 44px">
                                                        </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblLocationName %>"></asp:Label></td>
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtEndDateS" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtBonusS" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtBonusE" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                                    <td align="right" class="lable" style="width: 44px">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtShopId" runat="server" CssClass="ipt160px"></asp:TextBox></td>
                                                    <td align="right" class="lable" style="width: 44px">
                                                    </td>
                                                    <td>
