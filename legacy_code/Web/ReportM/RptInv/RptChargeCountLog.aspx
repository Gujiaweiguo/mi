<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptChargeCountLog.aspx.cs" Inherits="ReportM_RptInv_RptChargeCountLog" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript" src="../../JavaScript/TabTools.js"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptInv/RptChargeCountLog.aspx");
	        loadTitle();
	    }
	</script>
</head>
