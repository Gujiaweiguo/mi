<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptOweDetail.aspx.cs" Inherits="ReportM_RptInv_RptOweDetail" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/setPeriod.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptInv/RptOweDetail.aspx");
	        loadTitle();
	    }
	</script>
</head>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_lblCustBalanceDetail %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 56px">
                                                        <asp:Label ID="Label2" runat="server" Text="报表类型" CssClass="labelStyle"></asp:Label></td>
                                                    <td>
                                                        <asp:RadioButton ID="RadioButton1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_StoreRentInfoDetail %>" AutoPostBack="True" Checked="True" GroupName="aa" OnCheckedChanged="RadioButton1_CheckedChanged" CssClass="labelStyle" /></td>
                                                </tr>
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        &nbsp;<asp:Label ID="Label13" runat="server" CssClass="labelStyle" 
                                                            Text="<%$ Resources:BaseInfo,AdBoard_lblContractID %>" Width="50px"></asp:Label></td>
                                                    <td style="width: 218px">
                                                    ...
                                                    <td>
                                                        <asp:RadioButton ID="RadioButton2" runat="server" Text="<%$ Resources:BaseInfo,Rpt_StoreRentInfo %>" AutoPostBack="True" GroupName="aa" OnCheckedChanged="RadioButton2_CheckedChanged" CssClass="labelStyle" /></td>
                                                </tr>
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label12" runat="server" CssClass="labelStyle" 
                                                            Text="<%$ Resources:BaseInfo,Rpt_OwnTotallblPeriod %>"></asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label14" runat="server" CssClass="labelStyle" 
                                                            Text="<%$ Resources:BaseInfo,Account_lblChargeType %>" Width="50px" Visible="False"></asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 56px; height: 21px;" class="lable" align="right">
                                                        </td>
                                                    <td style="height: 21px">
                                                        </td>
                                                </tr>
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td align="right" class="lable" style="width: 56px; height: 22px;">
                                                    </td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td align="right" class="lable" style="width: 56px">
                                                    </td>
                                                    <td>
                                                        </td>
                                                </tr>
