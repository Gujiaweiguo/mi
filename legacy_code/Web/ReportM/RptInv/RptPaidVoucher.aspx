<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptPaidVoucher.aspx.cs" Inherits="ReportM_RptInv_RptPaidVoucher" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript" src="../../JavaScript/TabTools.js"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=strFresh %>,ReportM/RptInv/RptPaidVoucher.aspx");
	        loadTitle();
	    }
	</script>
</head>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_InvPaidPrint %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label2" runat="server" CssClass="labelStyle" 
                                                            Text="<%$ Resources:BaseInfo,LeaseholdContract_labContractCode %>"></asp:Label>
                                                    </td>
                                                    <td style="width: 218px">
                                                        <asp:TextBox ID="txtContractCode" runat="server" CssClass="ipt160px" 
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label10" runat="server" 
                                                            Text="<%$ Resources:BaseInfo,LeaseAreaType_CustCode %>" CssClass="labelStyle"></asp:Label>
                                                    </td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:BaseInfo,PotCustomer_lblCustName %>" CssClass="labelStyle"></asp:Label>
                                                    </td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label4" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_PaidStartDate %>"></asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label9" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_PaidEndDate %>"></asp:Label></td>
                                                    <td style="width: 218px">
