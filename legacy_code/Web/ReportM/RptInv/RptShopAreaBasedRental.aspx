<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptShopAreaBasedRental.aspx.cs" Inherits="RptBaseMenu_RptShopAreaBasedRental" ResponseEncoding="utf-16" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptInv/RptShopAreaBasedRental.aspx");
	        loadTitle();
	    }
	</script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_lblShopAreaBasedRental %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px; height: 28px;">
                                                        <asp:DropDownList ID="ddlBuildingName" runat="server" Width="165px" OnSelectedIndexChanged="ddlBuildingName_SelectedIndexChanged" AutoPostBack="True" >
                                                        </asp:DropDownList></td>
