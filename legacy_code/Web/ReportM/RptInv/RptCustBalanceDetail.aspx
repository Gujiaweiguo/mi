<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptCustBalanceDetail.aspx.cs" Inherits="RptBaseMenu_RptCustBalanceDetail" ResponseEncoding="utf-16" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript" src="../../JavaScript/TabTools.js"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptInv/RptCustBalanceDetail.aspx");
	        loadTitle();
	    }
	</script>
</head>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label8" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,LeaseholdContract_labContractStatus %>"></asp:Label></td>
                                                    <td style="width: 218px">
