                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label15" runat="server" CssClass="labelStyle" 
                                                            Text="<%$ Resources:BaseInfo,Account_lblAccountMon %>"></asp:Label>
                                                    </td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        &nbsp;</td>
                                                    <td style="width: 218px">
                                                        <asp:Button ID="btnQuery0" runat="server" CssClass="buttonQuery" 
                                                        ...
                                                        <asp:Button ID="btnCancel0" runat="server" CssClass="buttonCancel" 
