<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptShopMonthSalesCompareInfo.aspx.cs" Inherits="ReportM_RptSale_RptShopMonthSalesCompareInfo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/setPeriod.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptSale/RptShopMonthSalesCompareInfo.aspx");
	        loadTitle();
	    }
	</script>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_ShopMonthSalesCompareInfo %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px; height: 10px;" Visible="False">
                                                        &nbsp;</td>
