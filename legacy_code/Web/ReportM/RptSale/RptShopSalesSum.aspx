<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptShopSalesSum.aspx.cs" Inherits="RptBaseMenu_RptShopSalesSum" ResponseEncoding="utf-16" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=strFresh %>,ReportM/RptSale/RptShopSalesSum.aspx");
	        loadTitle();
	    }
	</script>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_ShopSellStatistics %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
