<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptGroupStoreMRentalRate.aspx.cs" Inherits="ReportM_RptSale_RptGroupStoreMRentalRate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function Load()
	    {
	        addTabTool("刷新,ReportM/RptSale/RptGroupStoreMRentalRate.aspx");
	        loadTitle();
	    }
	</script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_GroupItemLettingRate %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px" class="lable">
                                                        <asp:Label ID="Label2" runat="server" CssClass="labelStyle" Text="区域"></asp:Label>
                                                    </td>
                                                    <td style="width: 218px">
                                                    ...
                                                    <td>
                                                        <asp:RadioButton ID="RB2" runat="server" CssClass="labelStyle" Checked="True" GroupName="a" 
                                                            Text="<%$ Resources:BaseInfo,Rpt_List %>" />
                                                    </td>
                                                </tr>
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label3" runat="server"  CssClass="labelStyle" Text="城市"></asp:Label>
                                                    </td>
                                                    <td style="width: 218px">
                                                    ...
                                                    <td>
                                                        <asp:RadioButton ID="RB1" runat="server"  CssClass="labelStyle" 
