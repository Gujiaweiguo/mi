<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptStoreShopTypeRentalThan.aspx.cs" Inherits="ReportM_RptSale_RptStoreShopTypeRentalThan" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml"  >
<head id="Head1" runat="server">
    <title><%=(String)GetGlobalResourceObject("BaseInfo", "Rpt_StoreShopTypeRentalThan")%></title>
    ...
    <script type="text/javascript" src="../../JavaScript/setPeriod.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=strBaseInfo %>,ReportM/RptSale/RptStoreShopTypeRentalThan.aspx");
	        loadTitle();
	    }
	</script>
</head>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_StoreShopTypeRentalThan %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px">
                                                        <asp:DropDownList ID="ddlShopType" runat="server" BackColor="White" Width="165px">
                                                        </asp:DropDownList></td>
                                                    <td style="width: 14px">
                                                        </td>
                                                    <td style="width: 1055px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label12" runat="server" Text="<%$ Resources:BaseInfo,InvAdj_KeepAccountsMth %>" CssClass="labelStyle"></asp:Label></td>
                                                    <td style="width: 218px">
