<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptStoreTradeSalesAnalysis.aspx.cs" Inherits="ReportM_RptSale_RptStoreTradeSalesAnalysis" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml"  >
<head id="Head1" runat="server">
    <title><%=(String)GetGlobalResourceObject("BaseInfo", "Rpt_StoreTradeSalesAnalysis")%></title>
    ...
    <script type="text/javascript" src="../../JavaScript/setPeriod.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptSale/RptStoreTradeSalesAnalysis.aspx");
	        loadTitle();
	    }
	</script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_StoreTradeSalesAnalysis %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px; height: 22px;" class="lable">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:BaseInfo,RentableArea_lblTradeRelation %>" CssClass="labelStyle"></asp:Label></td>
                                                    <td style="width: 218px; height: 22px;">
                                                        <asp:DropDownList ID="ddlTrade" runat="server" Width="165px">
                                                        </asp:DropDownList>
                                                    </td>
