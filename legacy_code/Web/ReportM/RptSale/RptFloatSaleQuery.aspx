<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptFloatSaleQuery.aspx.cs" Inherits="RptBaseMenu_RptFloatSaleQuery" ResponseEncoding="utf-16" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
     <script language="javascript" type="text/javascript" src="../../JavaScript/TabTools.js"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=Fresh %>,ReportM/RptSale/RptFloatSaleQuery.aspx");
	        loadTitle();
	    }
	</script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:ReportInfo,RptFloatSaleQuery_Title %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
