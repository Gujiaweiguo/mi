<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptStoreSaleMth.aspx.cs" Inherits="ReportM_RptSale_RptStoreSaleMth" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=strFresh %>,ReportM/RptSale/RptStoreSaleMth.aspx");
	        loadTitle();
	    }
	</script>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_StoreSaleMth %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px; height: 17px;">
                                                        <asp:Label ID="Label14" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Qty_lblYear %>"></asp:Label></td>
                                                    <td style="width: 218px; height: 17px;"><asp:DropDownList ID="DdlYear" runat="server" AutoPostBack="true"
                                                            Width="165px">
                                                    </asp:DropDownList></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px; height: 16px">
                                                        <asp:Label ID="Label2" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Qty_lblMonth %>"></asp:Label></td>
                                                    <td style="width: 218px; height: 16px"><asp:DropDownList ID="DdlMonth" runat="server" AutoPostBack="true"
                                                            Width="165px">
                                                    </asp:DropDownList></td>
