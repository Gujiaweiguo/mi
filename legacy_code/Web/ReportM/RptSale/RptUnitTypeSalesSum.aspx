<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptUnitTypeSalesSum.aspx.cs" Inherits="ReportM_RptSale_RptStoreMSalesSum" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Common.js"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=strBaseInfo %>,ReportM/RptSale/RptUnitTypeSalesSum.aspx");
	        loadTitle();
	    }
	</script>
</head>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_UnitTypeSalesSum %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label2" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotShop_lblShopType %>"></asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        <asp:Label ID="Label12" runat="server" Text="<%$ Resources:BaseInfo,Qty_lblYear %>" CssClass="labelStyle"></asp:Label></td>
                                                    <td style="width: 218px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:BaseInfo,Qty_lblMonth %>" CssClass="labelStyle"></asp:Label>
                                                        </td>
                                                    <td style="width: 218px">
