<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptShopSalesRank.aspx.cs" Inherits="RptBaseMenu_RptShopSalesRank" ResponseEncoding="utf-16" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=Fresh %>,ReportM/RptSale/RptShopSalesRank.aspx");
	        loadTitle();
	    }
	</script>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_lblShopSalesRank %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px; height: 22px;" class="lable">
                                                        <asp:Label ID="Label14" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,PotCustomer_BusinessItem %>">
                                            </asp:Label></td>
                                                    <td style="width: 218px; height: 22px;">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px; height: 15px;" class="lable">
                                                        <asp:Label ID="Label9" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,RentableArea_lblLocationName %>"></asp:Label></td>
                                                    <td style="width: 218px; height: 15px;">
                                                        <asp:DropDownList ID="ddlLocationName" runat="server" Width="165px" AutoPostBack="True" OnSelectedIndexChanged="ddlLocationName_SelectedIndexChanged" >
                                                        </asp:DropDownList></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px; height: 12px;">
                                                        <asp:Label ID="Label10" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,AreaVindicate_labAreaName %>"></asp:Label></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px; height: 16px;" class="lable">
                                                        <asp:Label ID="Label6" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_NumberRank %>"></asp:Label></td>
                                                    <td style="width: 218px; height: 16px;">
                                                        <asp:TextBox ID="txtCount" runat="server" CssClass="ipt160px" Height="17px" MaxLength="8" ></asp:TextBox></td>
                                                    <td style="width: 44px; height: 16px;">
                                                    </td>
                                                    <td style="height: 16px">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px; height: 4px;">
                                                        <asp:Label ID="Label11" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Dept_rbtnAllVocation %>" Visible="False"></asp:Label></td>
                                                    <td style="width: 218px; height: 4px;"><table style="width:100%" class="tdBackColor">
                                                        <tr>
                                                            <td style="width: 218px; height: 16px;"><asp:DropDownList ID="ddlTrade2Name" runat="server" Width="165px" Visible="False" >
                                                    </asp:DropDownList></td>
                                                    <td style="width: 44px; height: 16px;">
                                                        </td>
                                                        </tr>
