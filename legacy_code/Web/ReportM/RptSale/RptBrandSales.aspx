<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptBrandSales.aspx.cs" Inherits="RptBaseMenu_RptBrandSales" ResponseEncoding="utf-16" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=strFresh %>,ReportM/RptSale/RptBrandSales.aspx");
	        loadTitle();
	    }
	</script>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_BrandSales %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px; height: 17px;">
                                                        <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ShopBrand_lblBrandLevel %>"></asp:Label></td>
                                                    <td style="width: 218px; height: 17px;">
                                                        <asp:DropDownList ID="ddlBrandLevel" runat="server" Width="165px" 
                                                            AutoPostBack="True" 
                                                            OnSelectedIndexChanged="ddlBrandLevel_SelectedIndexChanged" 
                                                            style="height: 22px" >
                                                    </asp:DropDownList></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px; height: 16px">
                                                        <asp:Label ID="Label4" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,ShopBrand_lblBrandName %>"></asp:Label></td>
                                                    <td style="width: 218px; height: 16px">
                                                        <asp:DropDownList ID="ddlBrandName" runat="server" Width="165px" AutoPostBack="True" OnSelectedIndexChanged="ddlBrandName_SelectedIndexChanged" >
                                                        </asp:DropDownList></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px; height: 15px;">
                                                        <asp:TextBox ID="txtStartBizTime" runat="server" CssClass="ipt160px" 
                                                            Height="17px" onclick="calendar()" ></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px; height: 15px;">
                                                        <asp:TextBox ID="txtEndBizTime" runat="server" CssClass="ipt160px" 
                                                            Height="18px" onclick="calendar()"></asp:TextBox>
                                                    </td>
