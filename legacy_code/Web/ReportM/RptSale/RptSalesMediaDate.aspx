<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptSalesMediaDate.aspx.cs" Inherits="ReportM_RptSale_RptSalesMediaDate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/Calendar.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=baseInfo %>,ReportM/RptSale/RptSalesMediaDate.aspx");
	        loadTitle();
	    }
	</script>
                                            ...
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Rpt_lblSalesMediaSum %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px; height: 22px;" class="lable">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:BaseInfo,PotCustomer_lblCustCode %>" CssClass="labelStyle" Visible="False"></asp:Label></td>
                                                    <td style="width: 218px; height: 22px;">
                                                        <asp:TextBox ID="txtCustCode" runat="server" CssClass="ipt160px" Height="18px" Width="164px" Visible="False"></asp:TextBox></td>
                                                    <td style="width: 44px; height: 22px;">
                                                        <asp:Label ID="Label13" runat="server" Text="排序顺序" Width="73px" Visible="False" Height="17px"></asp:Label></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    <td style="width: 89px; height: 16px;" class="lable">
                                                        <asp:Label ID="Label3" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,Rpt_MediaMDesc %>"></asp:Label></td>
                                                    <td style="width: 218px; height: 16px;"><asp:DropDownList ID="ddlMediaMDesc" runat="server" Width="165px">
                                                    </asp:DropDownList></td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 218px; height: 16px;">
                                                        ...
                                                        <asp:Button ID="BtnCel" runat="server" CssClass="buttonCancel" Text="<%$ Resources:BaseInfo,User_btnCancel %> "/></td>
                                                    <td style="width: 44px; height: 16px;">
                                                    </td>
                                                    <td style="height: 16px">
