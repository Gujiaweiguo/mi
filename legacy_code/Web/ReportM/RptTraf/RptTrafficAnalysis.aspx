<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptTrafficAnalysis.aspx.cs" Inherits="ReportM_RptTraf_RptTrafficAnalysis" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../JavaScript/setPeriod.js" charset="gb2312"></script>
        ...
        function Load()
	    {
	        addTabTool("<%=strFresh %>,ReportM/RptTraf/RptTrafficAnalysis.aspx");
	        loadTitle();
	    }
	</script>
</head>
            ...
            <ContentTemplate>
                                            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="tdTopRightBackColor" style="text-align:left;">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:BaseInfo,Menu_TrafficAnalysis %>"></asp:Label>
                                                    </td>
                                                    <td style="width:5px" class="tdTopRightBackColor">
                                            ...
                                            <table style="width:100%" class="tdBackColor">
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 74px">
                                                        <asp:Label ID="Label2" runat="server" Text="报表类型:" Font-Size="Small"></asp:Label></td>
                                                    <td>
                                                        <asp:RadioButton ID="rbtDetail" runat="server" Checked="True" GroupName="b" 
                                                            Text="<%$ Resources:BaseInfo,Rpt_DetailReport %>" Font-Size="Small"/></td>
                                                </tr>
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td>
                                                        <asp:RadioButton ID="rbtTotal" runat="server" GroupName="b" 
                                                            Text="<%$ Resources:BaseInfo,Rpt_StoreRentInfoDetail %>" Font-Size="Small"/></td>
                                                </tr>
                                                <tr class="bodyTbl">
                                                    <td class="lable" style="width: 89px">
                                                        &nbsp;</td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td style="width: 74px; height: 21px;" class="lable" align="right">
                                                        </td>
                                                    <td style="height: 21px">
                                                        </td>
                                                </tr>
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td align="right" class="lable" style="width: 74px; height: 22px;">
                                                    </td>
                                                ...
                                                <tr class="bodyTbl">
                                                    ...
                                                    <td align="right" class="lable" style="width: 74px">
                                                    </td>
                                                    <td>
                                                        </td>
                                                </tr>
