<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WrkFlw.aspx.cs" Inherits="WorkFlow_Default" ValidateRequest="false" %>
...
<head id="Head1" runat="server">
  ...
  function hidAdd()
 {
    ...
    function wrkFlwLock()
    {
        ...
        document.form1.btnSave.disabled="";
    }
...
function getFlowXML(){
  ...
  isStepShadow = 'T';
  actionStrokeColor = '#003366';//节点连线颜色设置
  actionTextColor = '';
  ...
  xml+= '</FlowConfig>';
	  ...
	  addTabTool("<%=baseInfo %>,WorkFlow/WrkFlw.aspx");
      loadTitle();
}
...
/*末节点的连线*/
function endNodeGetActionXML(){

    debugger;
  id =document.getElementById("txtNodeNodeName").value + document.getElementById("txtNodeWrkStep").value + 1;//节点线ID
  text =document.getElementById("txtNodeNodeName").value;// 节点线名称
  actionType = 'PolyLine';
    startArrow = '';
  endArrow ='Classic';
...
{      
    ...
    var mail = document.getElementById("cmbMail").value;
    ...
    if(flowStep!='')
    {
	  ...
	  //自动添加开始步骤
	   xml+= '<Step><BaseProperties nodeID="'+nodeid+'" nodeNodeName="'+nodeNodeName+'" nodeWrkStep="'+nodeWrkStep+'" nodeFuncID="'+ nodeFuncID +'" nodeRoleID="'+nodeRoleID+'" nodeSmtToMgr="'+nodeSmtToMgr+'" nodeValidAfterConfirm="'+nodeValidAfterConfirm+'" nodePrintAfterConfirm="'+nodePrintAfterConfirm+'" nodeLongestDelay="'+nodeLongestDelay+'" nodeTimeoutHandler="'+nodeTimeoutHandler+'" mail="'+mail+'" nodeProcessClass="'+nodeProcessClass+'"/></Step>';
          ...
          document.getElementById("cmbNodeValidAfterConfirm").value= Step.getElementsByTagName("BaseProperties").item(0).getAttribute("nodeValidAfterConfirm");
           document.getElementById("cmbNodePrintAfterConfirm").value = Step.getElementsByTagName("BaseProperties").item(0).getAttribute("nodePrintAfterConfirm");
            document.getElementById("txtNodeLongestDelay").value = Step.getElementsByTagName("BaseProperties").item(0).getAttribute("nodeLongestDelay");
             ...
             document.getElementById("cmbMail").value= Step.getElementsByTagName("BaseProperties").item(0).getAttribute("mail");
...
<body onload='getFlowXML();' topmargin=0 leftmargin=0>
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 413px" id="TABLE2">
                        <tr>
                            <td class="tdTopBackColor" style="width: 685px; height: 22px" valign="top">
                                <img alt="" class="imageLeftBack" style="width: 5px; text-align: left; height: 22px;" />
                                <asp:Label ID="lblCreateUserTitle" runat="server" CssClass="lblTitle" Text="<%$ Resources:BaseInfo,WrkFlw_lblWorkFlow %>"></asp:Label></td>
                            <td class="tdTopRightBackColor" style="width: 40px; height: 22px; text-align: right; vertical-align: top;" valign="top">
                        ...
                        <tr>
                            <td class="tdBackColor" colspan="2" style="width: 40px; height: 281px; text-align: left"
                                valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 723px; height: 320px" id="TABLE3">
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="tdBackColor" colspan="12" style="vertical-align: top; width: 723px; height: 2px;
                                            text-align: center">
                                                        <table cellpadding="0" cellspacing="0" class="panel_style" style="width: 717px; height: 133px; " id="TABLE1">
                    <tr>
                        <td align="left" colspan="2" onclick="cleancontextMenu();return false;" oncontextmenu="stepContextMenu();return false;"
                            style="height: 133px; width: 795px;" valign="top">
                            <?xml namespace="" ns="urn:schemas-microsoft-com:vml"
                                        prefix="v" ?><?xml namespace="" ns="urn:schemas-microsoft-com:vml" prefix="v" ?><?xml namespace="" ns="urn:schemas-microsoft-com:vml" prefix="v" ?><?xml namespace="" ns="urn:schemas-microsoft-com:vml" prefix="v" ?><?xml namespace="" ns="urn:schemas-microsoft-com:vml" prefix="v" ?><?xml namespace="" ns="urn:schemas-microsoft-com:vml" prefix="v" ?><?xml namespace="" ns="urn:schemas-microsoft-com:vml" prefix="v" ?>
                            <v:group id="FlowVML" coordsize="1500,450" style="width: 700px; position: absolute;
                                height: 130px; left: 34px; top: 43px;"></v:group>
                        </td>
                    </tr>
                </table>
                                        </td>
                                                                        ...
                                                                        <tr>
                                    <td style="height:10px; width: 723px; vertical-align: middle;" colspan="12">
                                        <table border="0" cellpadding="0" cellspacing="0" style="left: 12px; width: 95%;
                                            position: relative">
                                            <tbody>
                                                <tr>
                                    ...
                                    <tr>
                                        <td class="tdBackColor" style="width: 99px; height: 23px; text-align: right;">
                                            <asp:Label ID="lblBizGrpID" runat="server" ForeColor="Black" Text="<%$ Resources:BaseInfo,WrkFlw_lblBizGrpID %>"
                                                Width="56px" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 4px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 139px; height: 23px">
                                            <asp:DropDownList ID="cmbBizGrpID" runat="server" BackColor="White" CssClass="cmb120px">
                                            </asp:DropDownList></td>
                                                                                <td class="tdBackColor" style="width: 86px; height: 23px; text-align: right;">
                                            <asp:Label ID="lblWrkFlwName" runat="server" ForeColor="Black" Text="<%$ Resources:BaseInfo,WrkFlw_lblWrkFlwName %>" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 140px; height: 23px;">
                                            <asp:TextBox ID="txtWrkFlwName" runat="server" CssClass="textstyle"
                                        ...
                                        <td class="tdBackColor" style="height: 23px">
                                            ...
                                            <asp:Label ID="lblVoucherTypeID" runat="server" ForeColor="Black" Text="<%$ Resources:BaseInfo,WrkFlw_lblVoucherTypeID %>"
                                                Width="72px" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 142px; height: 23px">
                                            <asp:DropDownList ID="cmbVoucherTypeID" runat="server" CssClass="cmb120px">
                                            </asp:DropDownList></td>
                                    ...
                                    <tr>
                                        <td class="tdBackColor" style="width: 99px; height: 23px; text-align: right;">
                                            <asp:Label ID="lblInitVoucher" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblInitVoucher %>" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 4px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 139px; height: 23px">
                                            <asp:DropDownList ID="cmbInitVoucher" runat="server" BackColor="White" CssClass="cmb120px">
                                            </asp:DropDownList></td>
                                                                                <td class="tdBackColor" style="width: 86px; height: 23px; text-align: right;">
                                            <asp:Label ID="lblEfficiency" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblEfficiency %>" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 140px; height: 23px;">
                                            <asp:TextBox ID="txtEfficiency" runat="server" CssClass="textstyle"
                                                MaxLength="18"></asp:TextBox></td>
                                        <td class="tdBackColor" style="height: 23px">
                                        </td>
                                                                                                                        <td class="tdBackColor" style="width: 84px; height: 23px; text-align: right">
                                            <asp:Label ID="lblTraceDays" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblTraceDays %>" CssClass="labelStyle" Width="87px"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 142px; height: 23px">
                                            <asp:TextBox ID="txtTraceDays" runat="server" CssClass="textstyle" MaxLength="18"></asp:TextBox></td>
                                        <td class="tdBackColor" style="width: 5px; height: 23px">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tdBackColor" style="width: 99px; height: 23px; text-align: right;">
                                            <asp:Label ID="lblWrkFlwStatus" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblWrkFlwStatus %>" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 4px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 139px; height: 23px">
                                            <asp:DropDownList ID="cmbWrkFlwStatus" runat="server" BackColor="White" CssClass="cmb120px">
                                            </asp:DropDownList></td>
                                                                                <td class="tdBackColor" style="width: 86px; height: 23px; text-align: right;">
                                            <asp:Label ID="lblTransit" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblTransit %>" CssClass="labelStyle" Width="82px"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 140px; height: 23px;">
                                            <asp:DropDownList ID="cmbTransit" runat="server" BackColor="White" CssClass="cmb120px">
                                            </asp:DropDownList></td>
                                        <td class="tdBackColor" style="height: 23px">
                                        </td>
                                                                                                                        <td class="tdBackColor" style="width: 84px; height: 23px; text-align: right">
                                            <asp:Label ID="lblWrkFlwProcessClass" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblWrkFlwProcessClass %>" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 142px; height: 23px">
                                            <asp:TextBox ID="txtWrkFlwProcessClass" runat="server" CssClass="textstyle"
                                    ...
                                    <tr>
                                        <td class="tdBackColor" style="width: 99px; height: 25px; text-align: right;">
                                            <asp:Label ID="lblNodeNodetName" runat="server" ForeColor="Black" Text="<%$ Resources:BaseInfo,WrkFlw_lblNodeNodetName %>"
                                                Width="69px" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 25px; width: 4px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 139px; height: 25px">
                                            <asp:TextBox ID="txtNodeNodeName" runat="server" CssClass="textstyle"
                                                MaxLength="32"></asp:TextBox></td>
                                            ...
                                            <asp:Label ID="lblNodeWrkStep" runat="server" ForeColor="Black" Text="<%$ Resources:BaseInfo,WrkFlw_lblNodeWrkStep %>"
                                                Width="73px" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 25px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 140px; height: 25px;">
                                            <asp:TextBox ID="txtNodeWrkStep" runat="server" CssClass="textstyle"
                                                MaxLength="18"></asp:TextBox></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdBackColor" style="width: 139px; height: 23px">
                                            ...
                                            <asp:Label ID="lblNodeSmtToMgr" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblNodeSmtToMgr %>"
                                                Width="86px" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 140px; height: 23px;">
                                        ...
                                        <td class="tdBackColor" style="height: 23px">
                                            ...
                                            <asp:Label ID="lblNodeValidAfterConfirm" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblNodeValidAfterConfirm %>"
                                                Width="85px" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 142px; height: 23px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdBackColor" style="width: 139px; height: 23px">
                                            ...
                                            <asp:Label ID="lblNodeLongestDelay" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblNodeLongestDelay %>"
                                                Width="87px" CssClass="labelStyle"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 23px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 140px; height: 23px;">
                                            <asp:TextBox ID="txtNodeLongestDelay" runat="server" CssClass="textstyle"
                                                MaxLength="18"></asp:TextBox></td>
                                        <td class="tdBackColor" style="height: 23px">
                                        </td>
                                                                                                                        <td class="tdBackColor" style="width: 84px; height: 23px; text-align: right">
                                    ...
                                    <tr>
                                        <td class="tdBackColor" style="width: 99px; height: 25px; text-align: right;">
                                        <asp:Label ID="lblNodeProcessClass" runat="server" Text="<%$ Resources:BaseInfo,WrkFlw_lblNodeProcessClass %>" CssClass="labelStyle" Width="64px"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 25px; width: 4px;">
                                        </td>
                                        <td class="tdBackColor" style="width: 139px; height: 25px;">
                                            <asp:TextBox ID="txtNodeProcessClass" runat="server" CssClass="textstyle"
                                                MaxLength="128"></asp:TextBox></td>
                                                                                <td class="tdBackColor" style="width: 86px; height: 25px;">
                                                                                    <asp:Label ID="Label1" runat="server" CssClass="labelStyle" Text="<%$ Resources:BaseInfo,WrkFlw_lblNodeSmtToMgr %>"
                                                                                        Width="86px"></asp:Label></td>
                                        <td class="tdBackColor" style="height: 25px; width: 5px;">
                                        </td>
                                        <td class="tdBackColor" style="height: 25px; vertical-align: middle;" colspan="5"><asp:DropDownList ID="cmbMail" runat="server" BackColor="White" CssClass="cmb120px">
                                        </asp:DropDownList></td>
                                        <td class="tdBackColor" style="width: 5px; height: 25px">
                                        </td>
                                    </tr>
                                                                        <tr>
                                                                            <td class="tdBackColor" colspan="15" style="left: 10px; vertical-align: bottom; height: 33px;
                                                                                text-align: left; position: relative; top: 5px;">
                                                                                <table style="width: 100%; height: 28px">
                                                                                <tr>
                                                                                <td colspan="2" style="vertical-align: top"><table border="0" cellpadding="0" cellspacing="0" style="width: 95%; top: 14px;">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="width: 160px; height: 1px; background-color: #738495">
                                                                                            </td>
                                                                                ...
                                                                                <td style="height: 40px; vertical-align: bottom;">
                                                                                    <input id="btnAddNode" type="button"  onclick="return btnAddNode_onclick()"  OnMouseOver="this.style.background='url(../App_Themes/CSS/BtnImage/over_Edit.gif) no-repeat left top';" OnMouseOut="this.style.background='url(../App_Themes/CSS/BtnImage/btn_Edit.gif) no-repeat left top';" class="buttonEdit" />
                                                                                    <input id="UpdateWrkFlwNode" type="button" onclick="return UpdateWrkFlwNode_onclick()" OnMouseOver="this.style.background='url(../App_Themes/CSS/BtnImage/over_Edit.gif) no-repeat left top';" OnMouseOut="this.style.background='url(../App_Themes/CSS/BtnImage/btn_Edit.gif) no-repeat left top';" class="buttonEdit" />
                                                                                    <input id="btnNodeCancel" type="button"  onclick="return btnNodeCancel_onclick()" OnMouseOver="this.style.background='url(../App_Themes/CSS/BtnImage/over_BlankOut.gif) no-repeat left top';" OnMouseOut="this.style.background='url(../App_Themes/CSS/BtnImage/btn_BlankOut.gif) no-repeat left top';" class="buttonClear" />
                                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="<%$ Resources:BaseInfo,PotCustomer_butSave %>" CssClass="buttonSave" Enabled="False" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"/>
                                                                                <asp:Button ID="btnCancel" runat="server" Text="<%$ Resources:BaseInfo,User_btnCancel %>" OnClick="btnCancel_Click" CssClass="buttonCancel" onmouseover="BtnOver(this.id);" onmouseout="BtnUp(this.id);" onmouseup="BtnUp(this.id);"/>
                                                                                </td>
                                                                                </tr>
                                                                                
                                                                                </table>
                            </td>
                                        <td class="tdBackColor" style="height: 33px; width: 5px;">
                                        </td>
                                                                            <td class="tdBackColor" colspan="5" style="vertical-align: text-bottom; position: relative; height: 33px; text-align: right">
                                                                                <asp:TextBox ID="TextBox2" runat="server" Width="7px" CssClass="hidden"></asp:TextBox>
                            <asp:TextBox ID="TextBox1" runat="server" Width="1px" CssClass="hidden"></asp:TextBox>
                                            <input  name="FlowXML" style="width: 13px" class="hidden" />
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                            </td>
        ...
        <asp:HiddenField ID="HiddenField1" runat="server" Value="<%$ Resources:BaseInfo,Hidden_hidAdd %>" />
