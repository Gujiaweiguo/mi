...
namespace Associator.Perform
{
    public class LCard:BasePO
    {
        ...
        {
            return "MembCardId,MemberId,CardClassId,DateIssued,CardTypeId,CardStatusId,CardOwner,PrLCustId,ExpDate,NewLCardId,ChangeReason,CreateUserID,CreateTime,ModifyUserID,ModifyTime,OprRoleID,OprDeptID";
        }

        public override string GetInsertColumnNames()
        {
            return "MembCardId,MemberId,CardClassId,DateIssued,CardTypeId,CardStatusId,CardOwner,PrLCustId,ExpDate,NewLCardId,ChangeReason,CreateUserID,CreateTime,OprRoleID,OprDeptID";
        }

        public override string GetUpdateColumnNames()
        {
            return "MembCardId,DateIssued,CardTypeId,CardStatusId,PrLCustId,ExpDate,ModifyUserID,ModifyTime,OprRoleID,OprDeptID";
        }
        ...
        public string NewLCardId
        {
            get { return newLCardId; }
            set { newLCardId = value; }
        }
