...
namespace Associator.Perform
{
    ...
    public class HandBonusPO
    {
        ...
        public static void UpdateOrInsertBouns(int flag, int membID, string cardID, decimal bonus, string transid, DateTime transDT, decimal netAmt, int userID,int shopID)
        {
            ...
            try
            {
                string str_sql1 = "INSERT INTO purhist Values ('" + cardID + "'," + membID + "," + shopID + "," + transid + ",'" + transDT +
                                    "', ''," + netAmt + "," + bonus + "," + transid + ",'" + transDT + "'," + userID + ")";
                if (flag == 1)
                {
                ...
                {
                    string str_sql2 = "INSERT INTO Bonus Values (" + membID + "," + bonus + "," + bonus + "," + bonus + "," + bonus + "," + 0 + "," + 0 + ",'" + transDT + "'," + transid + ",'" + transDT + "')";
