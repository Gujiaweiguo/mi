...
namespace WorkFlow.WrkFlw
{
    public class BizGrp : BasePO
    {
        ...
        {
            return "select BizGrpID,BizGrpCode,BizGrpName,BizGrpStatus, (case when BizGrpStatus=1 then '有效' when BizGrpStatus=0 then '无效' else '未知' end) as BizGrpStatusName,BizGrpStatus,Note from BizGrp";
        }
