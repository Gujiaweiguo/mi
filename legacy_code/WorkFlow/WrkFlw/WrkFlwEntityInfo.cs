...
{
    public class WrkFlwEntityInfo : BasePO
    {
        ...
        {
            return "WrkFlwID,NodeID,Sequence,StartTime,CompletedTime,UserID,VoucherID,VoucherHints,VoucherMemo,NodeStatus,PreSequence,ImageURL,FuncURL";
        }
        ...
        public override String GetQuerySql()
        {
            return "select a.WrkFlwID,a.NodeID,a.Sequence,a.StartTime,a.CompletedTime,a.UserID,a.VoucherID,"
                ...
                + " from WrkFlwentity a, WrkFlwNode b, Func c"
                + " where a.WrkFlwID=b.WrkFlwID and a.NodeID=b.NodeID and b.FuncID=c.FuncID";
        }
