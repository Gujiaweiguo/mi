    ...
    public class User : BasePO
    {
        ...
        public override String GetColumnNames()
        {
            return "UserID,CreateUserID,CreateTime,UserCode,UserName,"
                + " Password,IdentityNo,OfficeTel,Mobile1,UserStatus,Note,WorkNo";
        }

        //得到要修改的列名 
        public override string GetUpdateColumnNames()
        {
            return "CreateUserID,CreateTime,UserCode,UserName,Password,IdentityNo,WorkNo,Mobile1,OfficeTel,EMail,UserStatus,Note";
        }
