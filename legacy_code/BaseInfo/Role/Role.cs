...
namespace BaseInfo.Role
{
    public class Role:BasePO
    {
        ...
        */
        ...
        {
            return "RoleID,CreateUserID,CreateTime,ModifyUserID,ModifyTime,OprRoleID,OprDeptID,RoleCode,RoleName,RoleStatus,IsLeader";
        }
        ...
        public static string GetRoleStatusDesc(int status)
        {
            ...
            {
                return "IS_ROLESTATUS_NO";
            }
            if (status == IS_ROLESTATUS_YES)
            {
                return "IS_ROLESTATUS_YES";
            }
            return "未知";
        }
