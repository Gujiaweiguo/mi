...
- [x] 3.1 Validate the updated workflow behavior for at least one PR-triggered update and one intended non-PR trigger path, confirming duplicate `ci-ready` runs no longer appear for the PR case.
