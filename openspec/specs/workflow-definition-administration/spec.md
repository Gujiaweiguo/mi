...
Define the first-release workflow-definition administration capability for versioned workflow templates, typed assignee rules, publication lifecycle controls, and the non-graphical management surface.
